...
${this.value}</textarea
  ...
  `,r([s({type:String})],q.prototype,"text",2),r([s({type:String})],q.prototype,"icon",2),r([s({type:Boolean})],q.prototype,"selected",2),r([s({type:String})],q.prototype,"theme",2),q=r([m("nidoca-menu-item")],q);var It=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return o` <style>
        :host,
        *,
        ::slotted(*) {
          color: var(--app-color-text-${this.theme});
  ...
  `,r([s({type:u,converter:String})],dt.prototype,"theme",2),r([s({type:Boolean})],dt.prototype,"multiselect",2),r([g("#slotElement")],dt.prototype,"slotElement",2),dt=r([m("nidoca-list")],dt);var jt=class extends d{constructor(){super(...arguments);this.theme="plain";this.prominent=!1}render(){return o`
      <style>
        * {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
