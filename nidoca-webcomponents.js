"use strict";(()=>{var kr=Object.defineProperty;var wr=Object.getOwnPropertyDescriptor;var r=(a,e,t,o)=>{for(var s=o>1?void 0:o?wr(e,t):e,l=a.length-1,p;l>=0;l--)(p=a[l])&&(s=(o?p(e,t,s):p(s))||s);return o&&s&&kr(e,t,s),s};var we=globalThis,Ee=we.ShadowRoot&&(we.ShadyCSS===void 0||we.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Qe=Symbol(),tr=new WeakMap,Ft=class{constructor(e,t,o){if(this._$cssResult$=!0,o!==Qe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ee&&e===void 0){let o=t!==void 0&&t.length===1;o&&(e=tr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),o&&tr.set(t,e))}return e}toString(){return this.cssText}},er=a=>new Ft(typeof a=="string"?a:a+"",void 0,Qe),c=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((o,s,l)=>o+(p=>{if(p._$cssResult$===!0)return p.cssText;if(typeof p=="number")return p;throw Error("Value passed to 'css' function must be a 'css' function result: "+p+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+a[l+1],a[0]);return new Ft(t,a,Qe)},Ke=(a,e)=>{if(Ee)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let o=document.createElement("style"),s=we.litNonce;s!==void 0&&o.setAttribute("nonce",s),o.textContent=t.cssText,a.appendChild(o)}},Se=Ee?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let o of e.cssRules)t+=o.cssText;return er(t)})(a):a;var{is:Er,defineProperty:Sr,getOwnPropertyDescriptor:Tr,getOwnPropertyNames:Hr,getOwnPropertySymbols:Or,getPrototypeOf:Rr}=Object,Te=globalThis,rr=Te.trustedTypes,Ir=rr?rr.emptyScript:"",Pr=Te.reactiveElementPolyfillSupport,_t=(a,e)=>a,Nt={toAttribute(a,e){switch(e){case Boolean:a=a?Ir:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},He=(a,e)=>!Er(a,e),or={attribute:!0,type:String,converter:Nt,reflect:!1,hasChanged:He};Symbol.metadata??=Symbol("metadata"),Te.litPropertyMetadata??=new WeakMap;var tt=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=or){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){let o=Symbol(),s=this.getPropertyDescriptor(e,o,t);s!==void 0&&Sr(this.prototype,e,s)}}static getPropertyDescriptor(e,t,o){let{get:s,set:l}=Tr(this.prototype,e)??{get(){return this[t]},set(p){this[t]=p}};return{get(){return s?.call(this)},set(p){let f=s?.call(this);l.call(this,p),this.requestUpdate(e,f,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??or}static _$Ei(){if(this.hasOwnProperty(_t("elementProperties")))return;let e=Rr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(_t("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(_t("properties"))){let t=this.properties,o=[...Hr(t),...Or(t)];for(let s of o)this.createProperty(s,t[s])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[o,s]of t)this.elementProperties.set(o,s)}this._$Eh=new Map;for(let[t,o]of this.elementProperties){let s=this._$Eu(t,o);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let o=new Set(e.flat(1/0).reverse());for(let s of o)t.unshift(Se(s))}else e!==void 0&&t.push(Se(e));return t}static _$Eu(e,t){let o=t.attribute;return o===!1?void 0:typeof o=="string"?o:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let o of t.keys())this.hasOwnProperty(o)&&(e.set(o,this[o]),delete this[o]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ke(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,o){this._$AK(e,o)}_$EC(e,t){let o=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,o);if(s!==void 0&&o.reflect===!0){let l=(o.converter?.toAttribute!==void 0?o.converter:Nt).toAttribute(t,o.type);this._$Em=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this._$Em=null}}_$AK(e,t){let o=this.constructor,s=o._$Eh.get(e);if(s!==void 0&&this._$Em!==s){let l=o.getPropertyOptions(s),p=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:Nt;this._$Em=s,this[s]=p.fromAttribute(t,l.type),this._$Em=null}}requestUpdate(e,t,o){if(e!==void 0){if(o??=this.constructor.getPropertyOptions(e),!(o.hasChanged??He)(this[e],t))return;this.P(e,t,o)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,t,o){this._$AL.has(e)||this._$AL.set(e,t),o.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,l]of this._$Ep)this[s]=l;this._$Ep=void 0}let o=this.constructor.elementProperties;if(o.size>0)for(let[s,l]of o)l.wrapped!==!0||this._$AL.has(s)||this[s]===void 0||this.P(s,this[s],l)}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(t)):this._$EU()}catch(o){throw e=!1,this._$EU(),o}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(t=>this._$EC(t,this[t])),this._$EU()}updated(e){}firstUpdated(e){}};tt.elementStyles=[],tt.shadowRootOptions={mode:"open"},tt[_t("elementProperties")]=new Map,tt[_t("finalized")]=new Map,Pr?.({ReactiveElement:tt}),(Te.reactiveElementVersions??=[]).push("2.0.4");var Xe=globalThis,Oe=Xe.trustedTypes,nr=Oe?Oe.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ze="$lit$",et=`lit$${Math.random().toFixed(9).slice(2)}$`,Je="?"+et,zr=`<${Je}>`,bt=document,ee=()=>bt.createComment(""),re=a=>a===null||typeof a!="object"&&typeof a!="function",Fe=Array.isArray,cr=a=>Fe(a)||typeof a?.[Symbol.iterator]=="function",Ye=`[ 	
\f\r]`,te=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ir=/-->/g,sr=/>/g,yt=RegExp(`>|${Ye}(?:([^\\s"'>=/]+)(${Ye}*=${Ye}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ar=/'/g,lr=/"/g,pr=/^(?:script|style|textarea|title)$/i,_e=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),i=_e(1),Yr=_e(2),Xr=_e(3),V=Symbol.for("lit-noChange"),E=Symbol.for("lit-nothing"),mr=new WeakMap,xt=bt.createTreeWalker(bt,129);function dr(a,e){if(!Fe(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return nr!==void 0?nr.createHTML(e):e}var hr=(a,e)=>{let t=a.length-1,o=[],s,l=e===2?"<svg>":e===3?"<math>":"",p=te;for(let f=0;f<t;f++){let h=a[f],k,T,y=-1,w=0;for(;w<h.length&&(p.lastIndex=w,T=p.exec(h),T!==null);)w=p.lastIndex,p===te?T[1]==="!--"?p=ir:T[1]!==void 0?p=sr:T[2]!==void 0?(pr.test(T[2])&&(s=RegExp("</"+T[2],"g")),p=yt):T[3]!==void 0&&(p=yt):p===yt?T[0]===">"?(p=s??te,y=-1):T[1]===void 0?y=-2:(y=p.lastIndex-T[2].length,k=T[1],p=T[3]===void 0?yt:T[3]==='"'?lr:ar):p===lr||p===ar?p=yt:p===ir||p===sr?p=te:(p=yt,s=void 0);let x=p===yt&&a[f+1].startsWith("/>")?" ":"";l+=p===te?h+zr:y>=0?(o.push(k),h.slice(0,y)+Ze+h.slice(y)+et+x):h+et+(y===-2?f:x)}return[dr(a,l+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),o]},oe=class a{constructor({strings:e,_$litType$:t},o){let s;this.parts=[];let l=0,p=0,f=e.length-1,h=this.parts,[k,T]=hr(e,t);if(this.el=a.createElement(k,o),xt.currentNode=this.el.content,t===2||t===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(s=xt.nextNode())!==null&&h.length<f;){if(s.nodeType===1){if(s.hasAttributes())for(let y of s.getAttributeNames())if(y.endsWith(Ze)){let w=T[p++],x=s.getAttribute(y).split(et),O=/([.?@])?(.*)/.exec(w);h.push({type:1,index:l,name:O[2],strings:x,ctor:O[1]==="."?Ie:O[1]==="?"?Pe:O[1]==="@"?ze:vt}),s.removeAttribute(y)}else y.startsWith(et)&&(h.push({type:6,index:l}),s.removeAttribute(y));if(pr.test(s.tagName)){let y=s.textContent.split(et),w=y.length-1;if(w>0){s.textContent=Oe?Oe.emptyScript:"";for(let x=0;x<w;x++)s.append(y[x],ee()),xt.nextNode(),h.push({type:2,index:++l});s.append(y[w],ee())}}}else if(s.nodeType===8)if(s.data===Je)h.push({type:2,index:l});else{let y=-1;for(;(y=s.data.indexOf(et,y+1))!==-1;)h.push({type:7,index:l}),y+=et.length-1}l++}}static createElement(e,t){let o=bt.createElement("template");return o.innerHTML=e,o}};function At(a,e,t=a,o){if(e===V)return e;let s=o!==void 0?t._$Co?.[o]:t._$Cl,l=re(e)?void 0:e._$litDirective$;return s?.constructor!==l&&(s?._$AO?.(!1),l===void 0?s=void 0:(s=new l(a),s._$AT(a,t,o)),o!==void 0?(t._$Co??=[])[o]=s:t._$Cl=s),s!==void 0&&(e=At(a,s._$AS(a,e.values),s,o)),e}var Re=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:o}=this._$AD,s=(e?.creationScope??bt).importNode(t,!0);xt.currentNode=s;let l=xt.nextNode(),p=0,f=0,h=o[0];for(;h!==void 0;){if(p===h.index){let k;h.type===2?k=new Lt(l,l.nextSibling,this,e):h.type===1?k=new h.ctor(l,h.name,h.strings,this,e):h.type===6&&(k=new je(l,this,e)),this._$AV.push(k),h=o[++f]}p!==h?.index&&(l=xt.nextNode(),p++)}return xt.currentNode=bt,s}p(e){let t=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}},Lt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,s){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=At(this,e,t),re(e)?e===E||e==null||e===""?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==V&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):cr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&re(this._$AH)?this._$AA.nextSibling.data=e:this.T(bt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=oe.createElement(dr(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===s)this._$AH.p(t);else{let l=new Re(s,this),p=l.u(this.options);l.p(t),this.T(p),this._$AH=l}}_$AC(e){let t=mr.get(e.strings);return t===void 0&&mr.set(e.strings,t=new oe(e)),t}k(e){Fe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,o,s=0;for(let l of e)s===t.length?t.push(o=new a(this.O(ee()),this.O(ee()),this,this.options)):o=t[s],o._$AI(l),s++;s<t.length&&(this._$AR(o&&o._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let o=e.nextSibling;e.remove(),e=o}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},vt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,s,l){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=l,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=E}_$AI(e,t=this,o,s){let l=this.strings,p=!1;if(l===void 0)e=At(this,e,t,0),p=!re(e)||e!==this._$AH&&e!==V,p&&(this._$AH=e);else{let f=e,h,k;for(e=l[0],h=0;h<l.length-1;h++)k=At(this,f[o+h],t,h),k===V&&(k=this._$AH[h]),p||=!re(k)||k!==this._$AH[h],k===E?e=E:e!==E&&(e+=(k??"")+l[h+1]),this._$AH[h]=k}p&&!s&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ie=class extends vt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}},Pe=class extends vt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}},ze=class extends vt{constructor(e,t,o,s,l){super(e,t,o,s,l),this.type=5}_$AI(e,t=this){if((e=At(this,e,t,0)??E)===V)return;let o=this._$AH,s=e===E&&o!==E||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,l=e!==E&&(o===E||s);s&&this.element.removeEventListener(this.name,this,o),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},je=class{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){At(this,e)}},ur={M:Ze,P:et,A:Je,C:1,L:hr,R:Re,D:cr,V:At,I:Lt,H:vt,N:Pe,U:ze,B:Ie,F:je},jr=Xe.litHtmlPolyfillSupport;jr?.(oe,Lt),(Xe.litHtmlVersions??=[]).push("3.2.1");var fr=(a,e,t)=>{let o=t?.renderBefore??e,s=o._$litPart$;if(s===void 0){let l=t?.renderBefore??null;o._$litPart$=s=new Lt(e.insertBefore(ee(),l),l,void 0,t??{})}return s._$AI(a),s};var at=class extends tt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=fr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return V}};at._$litElement$=!0,at.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:at});var Br=globalThis.litElementPolyfillSupport;Br?.({LitElement:at});(globalThis.litElementVersions??=[]).push("4.1.1");var u=(s=>(s.primary="primary",s.secondary="secondary",s.surface="surface",s.plain="plain",s))(u||{}),b=class{static getStyle(e){return e?e=="plain"?i``:i` <style>
            :host,
            *,
            ::slotted(*) {
          ...
          </style>`:i``}static getOposite(e){return e=="plain"?"surface":e=="primary"||e=="primary"?"secondary":e=="secondary"?"primary":"plain"}getParentTheme(e){let t=e;for(;t!=null;){if(t.theme!=null)return t.theme;t=t.parentElement}}};var d=class extends at{};var m=a=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(a,e)}):customElements.define(a,e)};var Dr={attribute:!0,type:String,converter:Nt,reflect:!1,hasChanged:He},$r=(a=Dr,e,t)=>{let{kind:o,metadata:s}=t,l=globalThis.litPropertyMetadata.get(s);if(l===void 0&&globalThis.litPropertyMetadata.set(s,l=new Map),l.set(t.name,a),o==="accessor"){let{name:p}=t;return{set(f){let h=e.get.call(this);e.set.call(this,f),this.requestUpdate(p,h,a)},init(f){return f!==void 0&&this.P(p,void 0,a),f}}}if(o==="setter"){let{name:p}=t;return function(f){let h=this[p];e.call(this,f),this.requestUpdate(p,h,a)}}throw Error("Unsupported decorator location: "+o)};function n(a){return(e,t)=>typeof t=="object"?$r(a,e,t):((o,s,l)=>{let p=s.hasOwnProperty(l);return s.constructor.createProperty(l,p?{...o,wrapped:!0}:o),p?Object.getOwnPropertyDescriptor(s,l):void 0})(a,e,t)}function Be(a){return n({...a,state:!0,attribute:!1})}var kt=(a,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,t),t);function g(a,e){return(t,o,s)=>{let l=p=>p.renderRoot?.querySelector(a)??null;if(e){let{get:p,set:f}=typeof o=="object"?t:s??(()=>{let h=Symbol();return{get(){return this[h]},set(k){this[h]=k}}})();return kt(t,o,{get(){let h=p.call(this);return h===void 0&&(h=l(this),(h!==null||this.hasUpdated)&&f.call(this,h)),h}})}return kt(t,o,{get(){return l(this)}})}}var U=class extends d{constructor(){super(...arguments);this.theme="surface";this.header="";this.opened=!1}render(){return i`
      <div @click="${()=>this.toggle()}" class="header">
        <nidoca-text theme="${this.theme}" text="${this.header}"></nidoca-text>
        <nidoca-icon icon="${this.opened?"keyboard_arrow_down":"keyboard_arrow_up"}"></nidoca-icon>
      </div>
      ${this.opened?i` <slot></slot>`:i``}
    `}toggle(){console.log("accordion clicked, state="+this.opened),this.opened=!this.opened,console.log("accordion clicked, after state="+this.opened),this.dispatchEvent(new CustomEvent("nidoca-event-accordion-item-clicked",{detail:this,bubbles:!0,composed:!0}))}};U.styles=c`
    :host {
  ...
  `,r([n({type:u,converter:String})],U.prototype,"theme",2),r([n({type:String})],U.prototype,"header",2),r([n({type:Boolean})],U.prototype,"opened",2),U=r([m("nidoca-accordion-item")],U);var H=class extends d{constructor(){super(...arguments);this.theme="plain";this.overline="";this.title="";this.summary="";this.text=""}render(){return i`
  ...
  `,r([n({type:u,converter:String})],H.prototype,"theme",2),r([n({type:String})],H.prototype,"overline",2),r([n({type:String})],H.prototype,"title",2),r([n({type:String})],H.prototype,"summary",2),r([n({type:String})],H.prototype,"text",2),H=r([m("nidoca-article")],H);var gr=(t=>(t.single="single",t.multi="multi",t))(gr||{}),lt=class extends d{constructor(){super(...arguments);this.theme="plain";this.accordionType="single"}updated(t){super.updated(t),t.forEach((o,s)=>{if(s=="theme"&&this.accordionSlot!=null){let l=this.accordionSlot.assignedElements();for(let p=0;p<l.length;p++){let f=l[p];f instanceof U&&(f.theme=this.theme)}}})}render(){return i`
      ${b.getStyle(this.theme)}
      <slot
        @nidoca-event-accordion-item-clicked="${t=>this.accordionSwitched(t)}"
        id="accordionSlot"
      ></slot>
    `}accordionSwitched(t){let o=t.detail;switch(this.accordionType){case"single":if(this.accordionSlot!=null){let s=this.accordionSlot.assignedElements();for(let l=0;l<s.length;l++){let p=s[l];p instanceof U&&p!=o&&(p.opened=!1)}}break;case"multi":break}t.stopPropagation()}static example(t=""){return i`<nidoca-accordion slot="${t}" theme="plain">
  ...
  `,r([n({type:u,converter:String})],lt.prototype,"theme",2),r([n({type:gr,converter:String})],lt.prototype,"accordionType",2),r([g("#accordionSlot")],lt.prototype,"accordionSlot",2),lt=r([m("nidoca-accordion")],lt);var M=class extends d{constructor(){super(...arguments);this.theme="primary";this.endpoint="";this.primaryTextField="";this.secondaryTextField="";this.groupByField="";this.imgSrcField="";this.rightIcon="";this.data=[]}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){if(this.endpoint)try{let t=await fetch(this.endpoint);if(!t.ok)throw new Error(`Failed to fetch data: ${t.status}`);this.data=await t.json()}catch(t){console.error("Error fetching data:",t)}}render(){if(!this.data.length)return i`<p>Loading data...</p>`;if(this.groupByField){let t=this.data.reduce((o,s)=>{let l=s[this.groupByField]||"UNBEKANNT";return o[l]||(o[l]=[]),o[l].push(s),o},{});return i`
            ${Object.keys(t).map(o=>{let s=t[o];return i`
          ...
          `}itemClicked(t){this.dispatchEvent(new CustomEvent("nidoca-event-nidoca-api-list-item-clicked",{detail:t,bubbles:!0,composed:!0}))}static example(t=""){return i`
          <nidoca-api-list 
            theme="primary"
            slot="${t}"
        ...
        `}};r([n({type:u,converter:String})],M.prototype,"theme",2),r([n({type:String})],M.prototype,"endpoint",2),r([n({type:String})],M.prototype,"primaryTextField",2),r([n({type:String})],M.prototype,"secondaryTextField",2),r([n({type:String})],M.prototype,"groupByField",2),r([n({type:String})],M.prototype,"imgSrcField",2),r([n({type:String})],M.prototype,"rightIcon",2),r([Be()],M.prototype,"data",2),M=r([m("nidoca-api-list")],M);var Q=class extends d{constructor(){super(...arguments);this.theme="primary";this.shadowType="shadow_1";this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return i`
      <style>
        .iconExtended {
  ...
  `,r([n({type:String})],Q.prototype,"theme",2),r([n({type:Object})],Q.prototype,"shadowType",2),r([n({type:String})],Q.prototype,"icon",2),r([n({type:Boolean})],Q.prototype,"clickable",2),r([n({type:Boolean})],Q.prototype,"deactivated",2),r([n({type:String})],Q.prototype,"title",2),Q=r([m("nidoca-icon-extended")],Q);var q=class extends d{constructor(){super(...arguments);this.icon="";this.primaryText="";this.isLast=!1;this.first=!1}render(){return i`
      <div
  ...
  `,r([n({type:String})],q.prototype,"icon",2),r([n({type:String})],q.prototype,"primaryText",2),r([n({type:Number})],q.prototype,"state",2),r([n({type:Boolean})],q.prototype,"isLast",2),q=r([m("nidoca-wizard-step")],q);var Vt=class extends d{render(){return i`
      <div
    ...
    `}slotChanged(e){let t=e.target;if(t==null)return;let o=t.assignedElements(),s=0;for(let l=0;l<o.length;l++){let p=o[l];p instanceof q&&(p.index=l,p.state==0&&(s=l),p.index==o.length-1&&(p.isLast=!0))}this.changeState(s)}stepClicked(e){let t=e.detail;console.debug("wizard step clicked, selectedStepIndex: %s",t),this.changeState(t)}changeState(e){if(this.wizardSlot){let t=this.wizardSlot.assignedElements();for(let o=0;o<t.length;o++){let s=t[o];s instanceof q&&s.index!==void 0&&(s.index<e?s.state=1:s.index==e?s.state=0:s.state=2)}}}};Vt.styles=c``,r([g("#wizardSlot")],Vt.prototype,"wizardSlot",2),Vt=r([m("nidoca-wizard")],Vt);var mt=class extends d{constructor(){super(...arguments);this.clickable=!0;this.theme="surface";this.text=""}render(){return i`
      <style>
        .chip:hover {
    ...
    `}static example(t=""){return i`<nidoca-chip slot="${t}" clickable text="Mein Chip"></nidoca-chip>`}};mt.styles=c`
    .chip {
      display: inline-block;
      padding: var(--space-2);
      border-radius: 1rem;
  ...
  `,r([n({type:Boolean})],mt.prototype,"clickable",2),r([n({type:u,converter:String})],mt.prototype,"theme",2),r([n({type:String})],mt.prototype,"text",2),mt=r([m("nidoca-chip")],mt);var wt=class extends d{constructor(){super(...arguments);this.code="";this.theme="plain"}render(){return i`
      <style>
        code {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
    ...
    `}static example(t=""){return i`<nidoca-code slot="${t}" theme="surface"> my code </nidoca-code>`}};wt.styles=c`
    :host {
      display: block;
    }
    pre {
  ...
  `,r([n({type:String})],wt.prototype,"code",2),r([n({type:String})],wt.prototype,"theme",2),wt=r([m("nidoca-code")],wt);var Et=class extends d{constructor(){super();this.show=!1;addEventListener("click",t=>{let o=this.associatedElement?.getBoundingClientRect();o&&(o.top>t.clientY||o.right<t.clientX||o.left>t.clientX||o.bottom<t.clientY)&&this.dispatchEvent(new CustomEvent("nidoca-elevation-event-closeme",{detail:this,bubbles:!0,composed:!0}))})}render(){return this.show?i`
          <div class="container" style="${this.calculatePositionStyle(this.associatedElement)}">
            <nidoca-border>
              <slot id="slot"></slot>
            </nidoca-border>
          </div>
        `:i``}calculatePositionStyle(t){let o="";if(t){let s=t.getBoundingClientRect();s.right>window.innerWidth/2?o+=`right:${window.innerWidth-s.right}px;`:o+=`left:${s.left}px;`,s.top>window.innerHeight/2?o+=`bottom:${s.height+window.innerHeight-s.top}px;`:o+=`top:${s.bottom}px;`}return o}};Et.styles=c`
    .container {
      position: fixed;
      z-index: 999;
    }
  `,r([n({type:Boolean})],Et.prototype,"show",2),r([n({type:Object})],Et.prototype,"associatedElement",2),Et=r([m("nidoca-elevation")],Et);var De=class{static{this.PROGRESS="PROGRESS"}static{this.PROGRESS_CIRCULAR="PROGRESS_CIRCULAR"}},St=class extends d{constructor(){super(...arguments);this.progressType=De.PROGRESS}render(){return i` <style>
        :host {
          width: 100%;
          display: block;
        }
      ...
      <progress class="${this.progressType}"></progress>`}};St.styles=c``,r([n({type:u,converter:String})],St.prototype,"theme",2),r([n({type:De,converter:String})],St.prototype,"progressType",2),St=r([m("nidoca-progress")],St);var $e=(o=>(o.contained="contained",o.outlined="outlined",o.text="text",o))($e||{}),rt=class extends d{constructor(){super(...arguments);this.theme="primary";this.buttonType="contained";this.icon="";this.text=""}render(){return i`
      <style>
        .outlined {
          color: var(--app-color-${this.theme}-background);
    ...
    `}clicked(){this.dispatchEvent(new CustomEvent("nidoca-event-button-clicked",{detail:this,bubbles:!0,composed:!0}))}static example(t=""){return i`<nidoca-button slot="${t}" text="Start" icon="home"></nidoca-button>`}};rt.styles=c`
    :host,
    .fullWidth {
      display: block;
      width: 100%;
  ...
  `,r([n({type:Boolean})],Tt.prototype,"autocomplete",2),r([g("#slotElement")],Tt.prototype,"slotElement",2),Tt=r([m("nidoca-form")],Tt);var yr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ce=a=>(...e)=>({_$litDirective$:a,values:e}),Mt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:Cr}=ur;var xr=()=>document.createComment(""),qt=(a,e,t)=>{let o=a._$AA.parentNode,s=e===void 0?a._$AB:e._$AA;if(t===void 0){let l=o.insertBefore(xr(),s),p=o.insertBefore(xr(),s);t=new Cr(l,p,a,a.options)}else{let l=t._$AB.nextSibling,p=t._$AM,f=p!==a;if(f){let h;t._$AQ?.(a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==p._$AU&&t._$AP(h)}if(l!==s||f){let h=t._$AA;for(;h!==l;){let k=h.nextSibling;o.insertBefore(h,s),h=k}}}return t},ct=(a,e,t=a)=>(a._$AI(e,t),a),Lr={},br=(a,e=Lr)=>a._$AH=e,Ar=a=>a._$AH,Le=a=>{a._$AP?.(!1,!0);let e=a._$AA,t=a._$AB.nextSibling;for(;e!==t;){let o=e.nextSibling;e.remove(),e=o}};var vr=(a,e,t)=>{let o=new Map;for(let s=e;s<=t;s++)o.set(a[s],s);return o},Gt=Ce(class extends Mt{constructor(a){if(super(a),a.type!==yr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let o;t===void 0?t=e:e!==void 0&&(o=e);let s=[],l=[],p=0;for(let f of a)s[p]=o?o(f,p):p,l[p]=t(f,p),p++;return{values:l,keys:s}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,o]){let s=Ar(a),{values:l,keys:p}=this.dt(e,t,o);if(!Array.isArray(s))return this.ut=p,l;let f=this.ut??=[],h=[],k,T,y=0,w=s.length-1,x=0,O=l.length-1;for(;y<=w&&x<=O;)if(s[y]===null)y++;else if(s[w]===null)w--;else if(f[y]===p[x])h[x]=ct(s[y],l[x]),y++,x++;else if(f[w]===p[O])h[O]=ct(s[w],l[O]),w--,O--;else if(f[y]===p[O])h[O]=ct(s[y],l[O]),qt(a,h[O+1],s[y]),y++,O--;else if(f[w]===p[x])h[x]=ct(s[w],l[x]),qt(a,s[y],s[w]),w--,x++;else if(k===void 0&&(k=vr(p,x,O),T=vr(f,y,w)),k.has(f[y]))if(k.has(f[w])){let N=T.get(p[x]),Ue=N!==void 0?s[N]:null;if(Ue===null){let Ne=qt(a,s[y]);ct(Ne,l[x]),h[x]=Ne}else h[x]=ct(Ue,l[x]),qt(a,s[y],Ue),s[N]=null;x++}else Le(s[w]),w--;else Le(s[y]),y++;for(;x<=O;){let N=qt(a,h[O+1]);ct(N,l[x]),h[x++]=N}for(;y<=w;){let N=s[y++];N!==null&&Le(N)}return this.ut=p,br(a,h),V}});var Vr={},ne=Ce(class extends Mt{constructor(){super(...arguments),this.ot=Vr}render(a,e){return e()}update(a,[e,t]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((o,s)=>o===this.ot[s]))return V}else if(this.ot===e)return V;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,t)}});var R=class extends B{constructor(){super(...arguments);this.theme="surface";this.trailingIcon="";this.label="";this.errorText="";this.infoText="";this.warningText="";this.value="";this.options=[];this.name="";this.required=!0;this.multiple=!1;this.size=1}render(){return i` <style>
        .parentContainer,
      ...
      <div class="parentContainer">
        ...
        <div class="container">
          ...
          >
            ${ne([this.value,this.options],()=>i`
                ${Gt(this.options,t=>t==null?i` <option></option>`:this.isSelectedOption(t)?i` <option value="${t.key}" selected>${t.value}</option> `:i` <option value="${t.key}">${t.value}</option> `)}
              `)}
          </select>
        </div>
      </div>
  ...
  `,r([n({type:u,converter:String})],R.prototype,"theme",2),r([n({type:String})],R.prototype,"trailingIcon",2),r([n({type:String})],R.prototype,"label",2),r([n({type:String})],R.prototype,"errorText",2),r([n({type:String})],R.prototype,"infoText",2),r([n({type:String})],R.prototype,"warningText",2),r([n()],R.prototype,"value",2),r([n({type:Array})],R.prototype,"options",2),r([n({type:String})],R.prototype,"name",2),r([n({type:Boolean})],R.prototype,"required",2),r([n({type:Boolean})],R.prototype,"multiple",2),r([n({type:Number})],R.prototype,"size",2),r([g("#selectElement")],R.prototype,"selectElement",2),R=r([m("nidoca-form-combobox")],R);var S=a=>a??E;var ot=(x=>(x.color="color",x.email="email",x.hidden="hidden",x.number="number",x.password="password",x.tel="tel",x.text="text",x.search="search",x.url="url",x.date="date",x.month="month",x.time="time",x.week="week",x))(ot||{}),v=class extends B{constructor(){super(...arguments);this.type="text";this.label="";this.placeholder="";this.trailingIcon="";this.errorText="";this.infoText="";this.warningText="";this.name="";this.value="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="surface"}render(){return this.type=="hidden"?i`<input id="inputElement" name="${this.name}" type="${this.type}" value="${this.value}" />`:i` <style>
            .parentContainer,
            ::slotted(.parentContainer) {
              color: var(--app-color-text-${this.theme});
              background-color: var(--app-color-${this.theme}-background);
          ...
          ${this.infoText||this.warningText||this.errorText?i`
              ...
              `:i``}`}getOutputData(){let t=this.inputElement?.value;return{key:this.name,value:t?.trim()}}validate(){return this.errorText="",this.inputElement!=null&&!this.inputElement.validity.valid&&this.inputElement.validationMessage!=this.errorText&&(this.errorText=this.inputElement.validationMessage,this.inputElement.validity.patternMismatch&&this.pattern&&(this.errorText=this.errorText.concat(" Format: ").concat(this.pattern))),this.errorText==""}};v.styles=c`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([n({type:ot,converter:String})],v.prototype,"type",2),r([n({type:String})],v.prototype,"label",2),r([n({type:String})],v.prototype,"placeholder",2),r([n({type:String})],v.prototype,"trailingIcon",2),r([n({type:String})],v.prototype,"errorText",2),r([n({type:String})],v.prototype,"infoText",2),r([n({type:String})],v.prototype,"warningText",2),r([n({type:String})],v.prototype,"name",2),r([n()],v.prototype,"value",2),r([n({type:Boolean})],v.prototype,"required",2),r([n({type:Boolean})],v.prototype,"disabled",2),r([n({type:Boolean})],v.prototype,"checked",2),r([n({type:Number})],v.prototype,"maxlength",2),r([n({type:Number})],v.prototype,"minlength",2),r([n({type:Number})],v.prototype,"min",2),r([n({type:Number})],v.prototype,"max",2),r([n({type:String})],v.prototype,"step",2),r([n({type:Number})],v.prototype,"size",2),r([n({type:String})],v.prototype,"pattern",2),r([g("#inputElement")],v.prototype,"inputElement",2),r([n({type:u,converter:String})],v.prototype,"theme",2),v=r([m("nidoca-form-text")],v);var Ve=class extends v{constructor(){super(),this.type="date"}};Ve=r([m("nidoca-form-date")],Ve);var I=class extends B{constructor(){super(...arguments);this.theme="surface";this.infoText="";this.warningText="";this.errorText="";this.name="";this.value="";this.label="";this.required=!1;this.placeholder="";this.disabled=!1;this.rows=5}render(){return i` <style>
        .parentContainer,
        ::slotted(.parentContainer) {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
...
${this.value}</textarea
      ...
      ${this.infoText||this.warningText||this.errorText?i`
          ...
          `:i``}`}getOutputData(){let t=this.inputElement?.value;return{key:this.name,value:t}}validate(){return this.errorText="",this.inputElement!=null&&!this.inputElement.validity.valid&&this.inputElement.validationMessage!=this.errorText&&(this.errorText=this.inputElement.validationMessage),this.errorText==""}};I.styles=c`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([n({type:u,converter:String})],I.prototype,"theme",2),r([n({type:String})],I.prototype,"infoText",2),r([n({type:String})],I.prototype,"warningText",2),r([n({type:String})],I.prototype,"errorText",2),r([n({type:String})],I.prototype,"name",2),r([n()],I.prototype,"value",2),r([n({type:String})],I.prototype,"label",2),r([n({type:Boolean})],I.prototype,"required",2),r([n({type:String})],I.prototype,"placeholder",2),r([n({type:Boolean})],I.prototype,"disabled",2),r([n({type:Number})],I.prototype,"rows",2),r([g("#inputElement")],I.prototype,"inputElement",2),I=r([m("nidoca-form-textarea")],I);var Ht=class extends B{constructor(){super(...arguments);this.theme="primary"}validate(){throw new Error("Method not implemented.")}getOutputData(){throw new Error("Method not implemented.")}render(){return i`
  ...
  `,r([n({type:u,converter:String})],Ht.prototype,"theme",2),r([g("#inputElement")],Ht.prototype,"inputElement",2),Ht=r([m("nidoca-form-upload")],Ht);var j=class extends B{constructor(){super();this.name="";this.label="";this.infoText="";this.errorText="";this.warningText="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="primary";this.theme=b.prototype.getParentTheme(this)||"plain"}render(){return i`
      <style>
        .slider {
    ...
    `}getOutputData(){return{key:this.name,value:this.checked}}validate(){return this.errorText="",this.inputElement!=null&&!this.inputElement.validity.valid&&this.inputElement.validationMessage!=this.errorText&&(this.errorText=this.inputElement.validationMessage),this.errorText==""}};j.styles=c`
    :host {
      display: flex;
      flex-direction: column;
      width: 100%;
  ...
  `,r([n({type:String})],j.prototype,"name",2),r([n({type:String})],j.prototype,"label",2),r([n({type:String})],j.prototype,"infoText",2),r([n({type:String})],j.prototype,"errorText",2),r([n({type:String})],j.prototype,"warningText",2),r([n({type:Boolean})],j.prototype,"required",2),r([n({type:Boolean})],j.prototype,"disabled",2),r([n({type:Boolean})],j.prototype,"checked",2),r([n({type:String})],j.prototype,"theme",2),r([g("#inputElement")],j.prototype,"inputElement",2),j=r([m("nidoca-form-switch")],j);var Z=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Newsletter";this.emailLabel="Deine Emailadresse";this.buttonLabel="Registrieren"}render(){return i`
      <nidoca-box theme="${S(this.theme)}">
        <nidoca-form id="form">
  ...
  `,r([n({type:u,converter:String})],Z.prototype,"theme",2),r([n({type:String,converter:String})],Z.prototype,"label",2),r([n({type:String,converter:String})],Z.prototype,"emailLabel",2),r([n({type:String,converter:String})],Z.prototype,"buttonLabel",2),r([g("#form")],Z.prototype,"formComponent",2),Z=r([m("nidoca-form-newsletter")],Z);var J=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Passwort zur\xFCcksetzen";this.emailLabel="Deine Emailadresse";this.buttonLabel="Zur\xFCcksetzen"}render(){return i`
  ...
  `,r([n({type:u,converter:String})],P.prototype,"theme",2),r([n({type:String,converter:String})],P.prototype,"label",2),r([n({type:String,converter:String})],P.prototype,"oldPasswordLabel",2),r([n({type:String,converter:String})],P.prototype,"newPasswordLabel",2),r([n({type:String,converter:String})],P.prototype,"repeatNewPasswordLabel",2),r([n({type:String,converter:String})],P.prototype,"buttonLabel",2),r([g("#form")],P.prototype,"formComponent",2),r([g("#oldPassword")],P.prototype,"oldPasswordInputField",2),r([g("#newPassword")],P.prototype,"newPasswordInputField",2),r([g("#repeatNewPassword")],P.prototype,"repeatNewPasswordInputField",2),r([n()],P.prototype,"errorMessageSamePasswordLabel",2),r([n()],P.prototype,"errorMessagePasswordDiffLabel",2),P=r([m("nidoca-form-change-password")],P);var K=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Registrieren";this.emailLabel="Email";this.passwordLabel="Passwort";this.buttonLabel="Registrieren"}render(){return i`
      <nidoca-box theme="${S(this.theme)}">
        <nidoca-form id="form">
          <nidoca-text-h2 class="paddingBottom">${this.label}</nidoca-text-h2>
  ...
  `,r([n({type:u,converter:String})],K.prototype,"theme",2),r([n({type:String,converter:String})],K.prototype,"label",2),r([n({type:String,converter:String})],K.prototype,"emailLabel",2),r([n({type:String,converter:String})],K.prototype,"passwordLabel",2),r([n({type:String,converter:String})],K.prototype,"buttonLabel",2),r([g("#form")],K.prototype,"formComponent",2),K=r([m("nidoca-form-register")],K);var Wt=class extends d{constructor(){super(...arguments);this.code=""}render(){return i``}};Wt.styles=c``,r([n({type:String})],Wt.prototype,"code",2),Wt=r([m("nidoca-upload")],Wt);var Ot=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return i`
      <style>
        .hr {
          border-color: var(--app-color-${this.theme}-border);
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([n({type:u,converter:String})],Ot.prototype,"theme",2),r([n({type:String,converter:String})],Ot.prototype,"text",2),Ot=r([m("nidoca-hr")],Ot);var Rt=class extends d{constructor(){super(...arguments);this.text="";this.icon=""}render(){return i`
      <div class="container">
        ${this.icon?i` <nidoca-icon
              slot="graphic"
              icon="${this.icon}"
    ...
    `}static example(t=""){return i`<nidoca-menu-area slot="${t}" icon="gavel" text="Rechtliches"></nidoca-menu-area>`}};Rt.styles=c`
    .container {
      display: flex;
      padding-left: var(--space-2);
      padding-right: var(--space-2);
  ...
  `,r([n({type:String})],Rt.prototype,"text",2),r([n({type:String})],Rt.prototype,"icon",2),Rt=r([m("nidoca-menu-area")],Rt);var G=class extends d{constructor(){super(...arguments);this.text="";this.icon="";this.selected=!1;this.theme="surface"}render(){return i`
      <style>
        .container:hover {
          background-color: var(--app-color-${this.theme}-hover);
        }
    ...
    `}clicked(){this.dispatchEvent(new CustomEvent("nidoca-event-menu-item-clicked",{detail:this,bubbles:!0,composed:!0}))}static example(t=""){return i`<nidoca-menu-item slot="${t}" text="Start" icon="home"></nidoca-menu-item>`}};G.styles=c`
    .container {
      display: flex;
      cursor: pointer;
      padding-left: var(--space-2);
  ...
  `,r([n({type:String})],G.prototype,"text",2),r([n({type:String})],G.prototype,"icon",2),r([n({type:Boolean})],G.prototype,"selected",2),r([n({type:String})],G.prototype,"theme",2),G=r([m("nidoca-menu-item")],G);var It=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return i` <style>
        :host,
        *,
        ::slotted(*) {
          color: var(--app-color-text-${this.theme});
      ...
      <slot id="slotElement"></slot>`}updated(t){super.updated(t),t.forEach((o,s)=>{if(s=="theme"&&this.slotElement!=null){let l=this.slotElement.assignedElements();for(let p=0;p<l.length;p++){let f=l[p];f instanceof G&&(f.theme=this.theme)}}})}firstUpdated(){this.addEventListener("click",t=>{if(this.slotElement!=null){let o=this.slotElement.assignedElements();for(let s=0;s<o.length;s++){let l=o[s];if(l instanceof G){let p=l.getBoundingClientRect();p.left<t.x&&p.right>t.x&&(p.top<t.y&&p.bottom>t.y?l.selected=!0:l.selected=!1)}}}})}static example(t=""){return i`
  ...
  `,r([n({type:String})],It.prototype,"theme",2),r([g("#slotElement")],It.prototype,"slotElement",2),It=r([m("nidoca-menu")],It);var Y=class extends d{constructor(){super(...arguments);this.height="auto";this.width="auto";this.left="auto";this.top="auto";this.right="auto";this.bottom="auto"}render(){return i`
      <slot
        class="floatingContainer"
        style="${this.toStyle(this.height,this.width,this.left,this.right,this.top,this.bottom)}"
      ></slot>
    `}toStyle(t,o,s,l,p,f){return"height:".concat(t).concat(";").concat("width:").concat(o).concat(";").concat("left:").concat(s).concat(";").concat("right:").concat(l).concat(";").concat("top:").concat(p).concat(";").concat("bottom:").concat(f).concat(";")}};Y.styles=c`
    .floatingContainer {
      position: fixed;
      display: inline;
      margin: auto;
  ...
  `,r([n({type:String})],Y.prototype,"height",2),r([n({type:String})],Y.prototype,"width",2),r([n({type:String})],Y.prototype,"left",2),r([n({type:String})],Y.prototype,"top",2),r([n({type:String})],Y.prototype,"right",2),r([n({type:String})],Y.prototype,"bottom",2),Y=r([m("nidoca-layout-floating")],Y);var Ut=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return i`
      ${b.getStyle(this.theme)}
      <slot></slot>
    `}};Ut.styles=c`
    :host {
  ...
  `,r([n({type:String})],Ut.prototype,"theme",2),Ut=r([m("nidoca-container")],Ut);var Pt=class extends d{constructor(){super();this.hideSidebox=!0;this.theme=b.prototype.getParentTheme(this)||"plain"}render(){return i` <style>
        .listbox,
        .sidebox {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
      ...
      ${this.hideSidebox?i``:i` <slot class="sidebox" name="sidebox"></slot>`}`}};Pt.styles=c`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: nowrap;
  ...
  `,r([n({type:u,converter:String})],Pt.prototype,"theme",2),r([n({type:Boolean,converter:String})],Pt.prototype,"hideSidebox",2),Pt=r([m("nidoca-split-screen")],Pt);var W=class extends d{constructor(){super(...arguments);this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return i`
      <i
  ...
  `,r([n({type:String})],W.prototype,"icon",2),r([n({type:Boolean})],W.prototype,"clickable",2),r([n({type:Boolean})],W.prototype,"deactivated",2),r([n({type:String})],W.prototype,"title",2),W=r([m("nidoca-icon")],W);var Qt=class extends d{render(){return i`
  ...
  `,r([n({type:String})],D.prototype,"src",2),r([n({type:String})],D.prototype,"width",2),r([n({type:String})],D.prototype,"height",2),r([n({type:Boolean})],D.prototype,"zoom",2),D=r([m("nidoca-img")],D);var zt=class extends D{static example(e=""){return i`<nidoca-img-round width="64px" width="64px" slot="${e}" src="face.jpg"></nidoca-img-round>`}};zt.styles=c`
    :host {
      font-size: 0;
      display: inline-block;
      box-sizing: border-box;
  ...
  `,zt=r([m("nidoca-img-round")],zt);var jt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return i`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
    ...
    `}slotChanged(t){let o=t.target;if(o==null)return;let s=o.assignedElements();for(let l=0;l<s.length;l++){let p=s[l];if(p instanceof D){this.selected==null&&l==0&&(this.selected=p.cloneNode(!0)),p.addEventListener("click",h=>{h.target&&(this.selected=h.target.cloneNode(!0))}),p.width="148px";let f=p.classList;f.contains("img")||f.add("img")}}}};jt.styles=c`
    :host,
    ::slotted(:host) {
      display: flex;
      flex-direction: column;
  ...
  `,r([n({type:u,converter:String})],jt.prototype,"theme",2),r([Be()],jt.prototype,"selected",2),jt=r([m("nidoca-img-slider")],jt);var Kt=class extends d{constructor(){super(...arguments);this.src=""}render(){return i`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
        ...
        ></iframe
      ></span>
    `}};Kt.styles=c``,r([n({type:String})],Kt.prototype,"src",2),Kt=r([m("nidoca-movie")],Kt);var $=class extends d{constructor(){super(...arguments);this.label="";this.placeholder="";this.name="";this.min=1;this.max=10;this.errorText="";this.numberOne=1;this.numberTwo=1}render(){return i`
      <nidoca-form-text
        theme="${S(this.theme)}"
        id="inputfield"
        placeholder="${this.placeholder}"
        ...
        value=""
      ></nidoca-form-text>
    `}updated(t){(t.has("min")||t.has("max"))&&this.generateNewNumber(),super.updated(t)}generateNewNumber(){this.numberOne=Math.round(this.getRandomNumber(this.min,this.max)),this.numberTwo=Math.round(this.getRandomNumber(this.min,this.max)),this.requestUpdate()}getRandomNumber(t,o){return Math.random()*(o-t)+t}isValid(){return this.inputfield!=null?this.numberOne+this.numberTwo==Number(this.inputfield.getOutputData().value):!1}validate(){let t=this.isValid();return t&&this.inputfield!=null?this.inputfield.errorText="":this.inputfield!=null&&(this.inputfield.errorText=this.errorText),t}};$.styles=c`
    :host {
      display: block;
      width: 100%;
    }
  `,r([n({type:u,converter:String})],$.prototype,"theme",2),r([n({type:String})],$.prototype,"label",2),r([n({type:String})],$.prototype,"placeholder",2),r([n({type:String})],$.prototype,"name",2),r([n({type:Number})],$.prototype,"min",2),r([n({type:Number})],$.prototype,"max",2),r([n({type:String})],$.prototype,"errorText",2),r([g("#inputfield")],$.prototype,"inputfield",2),$=r([m("nidoca-form-captcha")],$);var pt=class extends d{constructor(){super(...arguments);this.text="";this.href="";this.targetType="_self"}render(){return i`<a href="${this.href}" .target="${this.targetType}">
  ...
  `,r([n({type:String})],pt.prototype,"text",2),r([n({type:String})],pt.prototype,"href",2),r([n({type:String})],pt.prototype,"targetType",2),pt=r([m("nidoca-link")],pt);var z=class extends d{constructor(){super(...arguments);this.theme="surface";this.primaryText="";this.secondaryText="";this.selected=!1}render(){return i`
      <style>
        .container {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([n({type:u,converter:String})],z.prototype,"theme",2),r([n({type:String})],z.prototype,"primaryText",2),r([n({type:String})],z.prototype,"secondaryText",2),r([n({type:Boolean})],z.prototype,"selected",2),z=r([m("nidoca-list-item")],z);var nt=class extends d{constructor(){super(...arguments);this.theme="surface";this.text=""}render(){return i`
      <style>
        :host {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background-dark);
  ...
  :host {
     ...
     width:100%;
     box-sizing:border-box;
  `,r([n({type:u,converter:String})],nt.prototype,"theme",2),r([n({type:String})],nt.prototype,"text",2),nt=r([m("nidoca-list-section")],nt);var dt=class extends d{constructor(){super(...arguments);this.theme="surface";this.multiselect=!1}updated(t){super.updated(t),t.forEach((o,s)=>{s=="theme"&&this.getItems().forEach(l=>{l.theme=this.theme})})}render(){return i`
      <slot
        @nidoca-event-list-item-clicked="${t=>{if(!this.multiselect){this.unselectAll();let o=t.target;o.selected=!0}}}"
        id="slotElement"
      ></slot>
    `}getItems(){let t=[];if(this.slotElement!=null){let o=this.slotElement.assignedElements();for(let s=0;s<o.length;s++){let l=o[s];l instanceof z&&t.push(l)}}return t}getSelectedItems(){let t=[];if(this.slotElement!=null){let o=this.slotElement.assignedElements();for(let s=0;s<o.length;s++){let l=o[s];l instanceof z&&l.selected&&t.push(l)}}return t}getSelectedIndexes(){let t=[];if(this.slotElement!=null){let o=this.slotElement.assignedElements(),s=0;for(let l=0;l<o.length;l++){let p=o[l];p instanceof z&&(p.selected&&t.push(s),s++)}}return t}selectAll(){this.getItems().forEach(t=>{t.selected=!0})}unselectAll(){this.getItems().forEach(t=>{t.selected=!1})}static example(){return i`<nidoca-list theme="primary">
      ${nt.example()} ${z.example()} ${z.example()} ${z.example()}
  ...
  `,r([n({type:u,converter:String})],dt.prototype,"theme",2),r([n({type:Boolean})],dt.prototype,"multiselect",2),r([g("#slotElement")],dt.prototype,"slotElement",2),dt=r([m("nidoca-list")],dt);var Bt=class extends d{constructor(){super(...arguments);this.theme="primary";this.prominent=!1}render(){return i`
      <style>
        * {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([n({type:String,converter:String})],Bt.prototype,"theme",2),r([n({type:Boolean})],Bt.prototype,"prominent",2),Bt=r([m("nidoca-top-app-bar")],Bt);var ht=class extends d{constructor(){super(...arguments);this.headers=["column 1","column 2"];this.rows=[["row 1",new W],["row 2",new W]];this.theme="plain"}render(){return i`
      <style>
        td,
        th {
      ...
      <div>
        <table>
          <thead>
            ${ne([this.headers],()=>i` ${Gt(this.headers,t=>i` <th colspan="1" rowspan="1">${t}</th> `)} `)}
          </thead>
          <tbody>
            ${ne([this.rows],()=>i`
                  ${Gt(this.rows,t=>i`
                        <tr>
                          ${Gt(t,o=>i` <td colspan="1" rowspan="1">${o}</td> `)}
                        </tr>
                      `)}
                `)}
          </tbody>
  ...
  `,r([n({type:Array})],ht.prototype,"headers",2),r([n({type:Array})],ht.prototype,"rows",2),r([n({type:u,converter:String})],ht.prototype,"theme",2),ht=r([m("nidoca-table")],ht);var ut=class extends d{constructor(){super(...arguments);this.selected=!1}render(){return this.selected?i` <slot></slot>`:i``}};ut.styles=c`
    :host,
    slot {
      display: block;
    }
  `,r([n({type:Boolean})],ut.prototype,"selected",2),ut=r([m("nidoca-tab-content")],ut);var X=class extends d{constructor(){super(...arguments);this.selected=!1;this.text="";this.theme="surface"}render(){return i`
      <style>
        .container {
  ...
  `,r([n({type:Boolean})],X.prototype,"selected",2),r([n({type:String})],X.prototype,"text",2),r([n({type:String})],X.prototype,"theme",2),X=r([m("nidoca-tab")],X);var it=class extends d{constructor(){super(...arguments);this.theme="surface";this.tabIndex=0}render(){return i`
      <div class="container" @nidoca-event-tab-clicked="${t=>this.tabClicked(t)}">
        <slot id="tabSlot" name="tab"></slot>
        <slot id="tabContentSlot" name="tabContent"></slot>
      </div>
    `}firstUpdated(t){super.firstUpdated(t),this.tabIndexChanged()}update(t){super.update(t),t.get("tabIndex")!=null&&this.tabIndexChanged()}tabIndexChanged(){this.updateNidocaTabElements(),this.updateNidocaTabContentElemnts()}updateNidocaTabElements(){if(this.tabSlot!=null){let t=this.tabSlot.assignedElements(),s=100/t.length,l=t[this.tabIndex];for(let p=0;p<t.length;p++){let f=t[p];f instanceof X&&(f.theme=this.theme,f.style.width=String(s).concat("%"),f==l?(f.selected=!0,f.classList.add("SELECTED")):(f.selected=!1,f.classList.remove("SELECTED")))}}}updateNidocaTabContentElemnts(){let t=0;if(this.tabContentSlot!=null){let o=this.tabContentSlot.assignedElements();for(let s=0;s<o.length;s++){let l=o[s];l instanceof ut&&(this.tabIndex==t?l.selected=!0:l.selected=!1,t++)}}}tabClicked(t){let o=t.detail;this.changeTabIndex(o)}changeTabIndex(t){if(!t.selected&&this.tabSlot!=null){let o=this.tabSlot.assignedElements();for(let s=0;s<o.length;s++){let l=o[s];if(l instanceof X&&l==t){this.tabIndex=s;break}}}}static example(t=""){return i`
  ...
  `,r([n({type:u,converter:String})],A.prototype,"theme",2),r([n({type:String})],A.prototype,"text",2),A=r([m("nidoca-text")],A);var ie=class extends A{render(){return i` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};ie.styles=c`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ie=r([m("nidoca-text-body")],ie);var se=class extends A{render(){return i`${super.render()}`}};se.styles=c`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ae=r([m("nidoca-text-overline")],ae);var le=class extends A{render(){return i` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};le.styles=c`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,le=r([m("nidoca-text-subtitle")],le);var C=class extends A{render(){return i`<style>
        slot {
          color: var(--app-color-subtext-${this.theme});
        }
      </style>
      <slot>${this.text}</slot>`}};C.styles=c`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,C=r([m("nidoca-text-caption")],C);var Me=class extends C{render(){return i`<style>
        slot {
          color: var(--app-color-error-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Me=r([m("nidoca-text-error")],Me);var qe=class extends C{render(){return i`<style>
        slot {
          color: var(--app-color-success-background);
        }
      </style>
      <slot>${this.text}</slot>`}};qe=r([m("nidoca-text-success")],qe);var Ge=class extends C{render(){return i`<style>
        slot {
          color: var(--app-color-warning-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ge=r([m("nidoca-text-warning")],Ge);var We=class extends C{render(){return i`<style>
        slot {
  ...
  `,ue=r([m("nidoca-text-h6")],ue);var F=class extends d{constructor(){super(...arguments);this.value="";this.placeholder="";this.disabled=!1;this.theme="surface"}render(){return i`
      <style>
        .container,
        input {
          color: var(--app-color-text-${this.theme});
    ...
    `}clearValue(){this.value=""}async valueChanged(){let t="nidoca-search-bar-event-value-changed",o=new CustomEvent(t,{detail:this.inputElement?.value,bubbles:!0,composed:!0});console.debug("dispatch custom event type: %s, detail: %s",o.type,JSON.stringify(o.detail)),this.dispatchEvent(o)}static example(t=""){return i`<nidoca-search-bar slot="${t}" theme="primary" placeholder="Suche..."></nidoca-search-bar>`}};F.styles=c`
    :host {
      width: 100%;
      display: block;
    }
  ...
  `,r([n({type:String})],F.prototype,"value",2),r([n({type:String})],F.prototype,"placeholder",2),r([n({type:Boolean})],F.prototype,"disabled",2),r([g("#inputElement")],F.prototype,"inputElement",2),r([n({type:u,converter:String})],F.prototype,"theme",2),F=r([m("nidoca-search-bar")],F);var fe=class{static{this.CENTER="CENTER"}static{this.LEFT="LEFT"}static{this.RIGHT="RIGHT"}static{this.TOP="TOP"}static{this.BOTTOM="BOTTOM"}static{this.SLIDE_CENTER="SLIDE_CENTER"}static{this.SLIDE_LEFT="SLIDE_LEFT"}static{this.SLIDE_RIGHT="SLIDE_RIGHT"}static{this.SLIDE_TOP="SLIDE_TOP"}static{this.SLIDE_BOTTOM="SLIDE_BOTTOM"}},$t=class extends d{constructor(){super(...arguments);this.transitionType=fe.CENTER;this.duration=.5}render(){return i` <div class="${S(this.transitionType)}"><slot></slot></div> `}};$t.styles=c`
  ...
  `,r([n({type:String})],$t.prototype,"transitionType",2),r([n({type:Number})],$t.prototype,"duration",2),$t=r([m("nidoca-transition")],$t);var Yt=class extends d{constructor(){super(...arguments);this.show=!1}render(){return this.show?i`
  ...
  `,r([n({type:Boolean})],Yt.prototype,"show",2),Yt=r([m("nidoca-dialog")],Yt);var _=class extends d{constructor(){super(...arguments);this.show=!1;this.title="Ja oder Nein ?";this.description="Entscheide dich";this.labelButtonYes="Ja";this.labelButtonNo="Nein"}render(){return i`<nidoca-dialog .show="${this.show}">
    ...
    </nidoca-dialog>`}};_.styles=c``,r([n({type:Boolean})],_.prototype,"show",2),r([n({type:String})],_.prototype,"title",2),r([n({type:String})],_.prototype,"description",2),r([n({type:String})],_.prototype,"labelButtonYes",2),r([n({type:String})],_.prototype,"labelButtonNo",2),_=r([m("nidoca-dialog-decision")],_);var Xt=class extends d{constructor(){super(...arguments);this.icon=""}render(){return i`
  ...
  `,r([n({type:String})],Xt.prototype,"icon",2),Xt=r([m("nidoca-infobox")],Xt);var st=class extends d{constructor(){super(...arguments);this.theme="surface";this.src="";this.title="";this.subtitle=""}render(){return i`
            <div
  ...
  `,r([n({type:u,converter:String})],st.prototype,"theme",2),r([n({type:String})],st.prototype,"src",2),r([n({type:String})],st.prototype,"title",2),r([n({type:String})],st.prototype,"subtitle",2),st=r([m("nidoca-avatar")],st);var Zt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return i`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background-light);
          border-color: var(--app-color-${this.theme}-border);
  ...
  `,r([n({type:u,converter:String})],Zt.prototype,"theme",2),Zt=r([m("nidoca-card")],Zt);var ge=class extends d{render(){return i`
      <nidoca-layout-spacer bottom="var(--space)" left="">
        <slot id="slotElement" @slotchange="${e=>this.slotChanged(e)}"></slot>
      </nidoca-layout-spacer>
    `}slotChanged(e){let t=e.target;if(t==null)return;let o=t.assignedElements();for(let s=0;s<o.length;s++){let p=o[s].classList;p.contains("flexItem")||p.add("flexItem"),p.contains("flexItemDevice")||p.add("flexItemDevice")}}};ge.styles=c`
    slot,
    ::slotted(slot) {
      display: flex;
      flex-direction: row;
  ...
  `,ge=r([m("nidoca-gallery")],ge);var ye=class extends d{render(){return i`<slot></slot>`}print(){let e=window.open("");e&&(e.document.write(this.innerHTML),e.print(),e.close())}};ye.styles=c`
    :host {
      display: none;
    }
  `,ye=r([m("nidoca-print")],ye);var xe=class extends d{render(){return i`
      <slot id="container" class="container" @slotchange="${e=>this.slotChanged(e)}"></slot>
    `}slotChanged(e){let o=e.target.assignedElements(),s=o.length;for(let l=0;l<s;l++){let f=o[l].classList,h="item_count_"+s;f.contains(h)||f.add(h)}}};xe.styles=c`
    :host {
      display: block;
      margin: auto;
      width: 100%;
  ...
  `,xe=r([m("nidoca-section")],xe);var be=class extends d{render(){return i` <slot></slot>`}};be.styles=c`
    :host {
      display: block;
    }
  ...
  `,be=r([m("nidoca-dashboard")],be);var Ae=class extends d{render(){return i` <slot></slot>`}};Ae.styles=c`
    :host {
      display: block;
      width: 25%;
    }
  ...
  `,Ae=r([m("nidoca-dashboard-box-25")],Ae);var ve=class extends d{render(){return i` <slot></slot>`}};ve.styles=c`
    :host {
      width: 50%;
      display: block;
    }
  ...
  `,ve=r([m("nidoca-dashboard-box-50")],ve);var ke=class extends d{render(){return i` <slot></slot>`}};ke.styles=c`
    :host {
      width: 100%;
      display: block;
    }
  `,ke=r([m("nidoca-dashboard-box-100")],ke);var Ct=class extends d{constructor(){super(...arguments);this.clickable=!0;this.title=""}render(){return i`
  ...
  `,r([n({type:Boolean})],Ct.prototype,"clickable",2),r([n({type:String})],Ct.prototype,"title",2),Ct=r([m("nidoca-dashboard-card")],Ct);var Jt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return i`
      ${b.getStyle(this.theme)}
      <slot></slot>
    `}};Jt.styles=c`
    :host {
  ...
  `,r([n({type:u,converter:String})],Jt.prototype,"theme",2),Jt=r([m("nidoca-box")],Jt);var L=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Deine Nachricht";this.nameLabel="Dein Name";this.emailLabel="Deine Email";this.titleLabel="Betreff";this.messageLabel="Deine Nachricht";this.buttonLabel="Senden"}render(){return i`
      <nidoca-box theme="${S(this.theme)}">
    ...
    `}sendMessage(){this.formComponent&&this.formComponent.validate()&&this.dispatchEvent(new CustomEvent("nidoca-form-contact-submit",{detail:this.formComponent.getOutputData(),bubbles:!0,composed:!0}))}};L.styles=c`
    :host {
      display: block;
      width: 100%;
    }
  ...
  `,r([n({type:u,converter:String})],L.prototype,"theme",2),r([n({type:String,converter:String})],L.prototype,"label",2),r([n({type:String,converter:String})],L.prototype,"nameLabel",2),r([n({type:String,converter:String})],L.prototype,"emailLabel",2),r([n({type:String,converter:String})],L.prototype,"titleLabel",2),r([n({type:String,converter:String})],L.prototype,"messageLabel",2),r([n({type:String,converter:String})],L.prototype,"buttonLabel",2),r([g("#authenitcate-form")],L.prototype,"formComponent",2),L=r([m("nidoca-form-contact")],L);})();
