...
${this.value}</textarea
  ...
  `,r([s({type:u,converter:String})],Bt.prototype,"theme",2),r([De()],Bt.prototype,"selected",2),Bt=r([m("nidoca-img-slider")],Bt);var Yt=class extends d{constructor(){super(...arguments);this.src=""}render(){return i`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
