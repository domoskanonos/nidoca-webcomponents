"use strict";(()=>{var $r=Object.defineProperty;var Cr=Object.getOwnPropertyDescriptor;var r=(a,e,t,n)=>{for(var o=n>1?void 0:n?Cr(e,t):e,l=a.length-1,m;l>=0;l--)(m=a[l])&&(o=(n?m(e,t,o):m(o))||o);return n&&o&&$r(e,t,o),o};var er=class a{constructor(){this.listeners=[];window.onpopstate=e=>{console.trace("onpopstate event: location: "+document.location+", state: "+JSON.stringify(e.state)),this.notifyListeners()},document.addEventListener("click",e=>{if(!this.shouldIgnoreEvent(e)){let t=this.getAnchor(e);t&&!this.shouldIgnoreAnchor(t)&&(e.preventDefault(),t.hash.length>0&&this.navigate(t.hash))}})}static getUniqueInstance(){return a.uniqueInstance||(a.uniqueInstance=new a),a.uniqueInstance}subscribe(e){console.trace("subscribe router listener"),this.listeners.push(e)}back(){history.back()}forward(){history.forward()}navigate(e,t=null){if(e.indexOf("#")==-1&&(e="#".concat(e)),console.trace("navigate to: %s",e),t!=null&&console.trace("state: %s",JSON.stringify(t)),document.location.hash===e){console.trace("you are already on page: "+e);return}history.pushState(t,"",e),this.notifyListeners()}getCurrentState(){return history.state}getStateProperty(e){let t=this.getCurrentState();return t!=null?t[e]:null}getCurrentPage(){return document.location.hash.replace("#","")}getHash(){return document.location.hash}notifyListeners(){let e=this.getCurrentPage();this.listeners.forEach(t=>t.routeChanged(e))}shouldIgnoreEvent(e){return e.defaultPrevented||e.button!==0||e.shiftKey||e.ctrlKey||e.altKey||e.metaKey}getAnchor(e){for(let n of e.composedPath?e.composedPath():[])if(this.isAnchor(n))return n;let t=e.target;for(;t&&!this.isAnchor(t);)t=t.parentNode;return t&&this.isAnchor(t)?t:null}isAnchor(e){return e.nodeName&&e.nodeName.toLowerCase()==="a"}shouldIgnoreAnchor(e){return!!(e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||(e.origin||this.getAnchorOrigin(e))!==window.location.origin)}getAnchorOrigin(e){let t=e.port,n=e.protocol,m=n==="http:"&&t==="80"||n==="https:"&&t==="443"?e.hostname:e.host;return`${n}//${m}`}};var rr=class a{static generateImageBase64(e,t,n){let o=document.createElement("canvas");o.width=128,o.height=128;let l=o.getContext("2d");if(!l)throw new Error("Canvas context is not available");l.fillStyle=n,l.fillRect(0,0,o.width,o.height),l.fillStyle=t;let m=document.body,h=getComputedStyle(m).getPropertyValue("--font-family")||"Arial";l.font=`bold 64px ${h}`,l.textAlign="center",l.textBaseline="alphabetic";let v=e.charAt(0).toUpperCase(),E=l.measureText(v),x=E.actualBoundingBoxAscent-E.actualBoundingBoxDescent;return l.fillText(v,o.width/2,o.height/2+x/2),o.toDataURL("image/png")}static renderImgText(e){return a.generateImageBase64(e,"#555555","#ffffff")}};var Qe=class a{constructor(e,t,n){this.db=null;this.dbName=e,this.storeName=t,this.keyField=n}static{this.DB_VERSION=2}async openDatabase(){this.db=await new Promise((e,t)=>{let n=indexedDB.open(this.dbName,a.DB_VERSION);n.onupgradeneeded=()=>{let o=n.result;console.log(`onupgradeneeded triggered. Aktuelle Version: ${o.version}`),o.objectStoreNames.contains(this.storeName)||(o.createObjectStore(this.storeName,{keyPath:this.keyField}),console.log(`Object Store '${this.storeName}' mit KeyPath '${String(this.keyField)}' erstellt.`))},n.onsuccess=()=>{console.log(`IndexedDB '${this.dbName}' ge\xF6ffnet.`),e(n.result)},n.onerror=()=>{console.error("Fehler beim \xD6ffnen der Datenbank:",n.error),t(new Error(n.error?.message||"Unknown error"))},n.onblocked=()=>{console.warn("Datenbank wird von einer anderen Verbindung blockiert."),t(new Error("Datenbank ist blockiert."))}})}async add(e){return new Promise((t,n)=>{if(this.db){console.log("add() called");let m=this.db.transaction(this.storeName,"readwrite").objectStore(this.storeName).add(e);m.onsuccess=()=>t(),m.onerror=()=>n(m.error)}})}async update(e){let t=await this.openDatabase();return new Promise((n,o)=>{if(this.db){let f=this.db.transaction(this.storeName,"readwrite").objectStore(this.storeName).put(e);f.onsuccess=()=>n(),f.onerror=()=>o(f.error)}})}async delete(e){return new Promise((t,n)=>{if(this.db){let m=this.db.transaction(this.storeName,"readwrite").objectStore(this.storeName).delete(e);m.onsuccess=()=>t(),m.onerror=()=>n(m.error)}})}async get(e){return new Promise((t,n)=>{if(this.db){let m=this.db.transaction(this.storeName,"readonly").objectStore(this.storeName).get(e);m.onsuccess=()=>t(m.result),m.onerror=()=>n(m.error)}})}async getAll(){return new Promise((e,t)=>{if(this.db){let l=this.db.transaction(this.storeName,"readonly").objectStore(this.storeName).getAll();l.onsuccess=()=>e(l.result),l.onerror=()=>t(l.error)}})}close(){this.db?.close()}},nr=class{constructor(){this.name="";this.email=null;this.phone=null;this.energy=0;this.image=null}},or=class{constructor(){this.id=null;this.myself=null;this.friends=[];this.goals=[]}},ir=class{constructor(){this.description="";this.time_min=0;this.time_max=0;this.energy=0;this.image=""}},sr=class{constructor(){this.name="";this.actions=[]}},ar=class{constructor(){this.title="";this.description="";this.image="";this.actions=[];this.routines=[]}};(async()=>{let a=new Qe("AppDatabase","Karmatica","id");await a.openDatabase();let e={id:1,myself:{name:"Dominik Bruhn",email:"dominikbruhn@googlemail.com",phone:"015205248862",energy:1,image:null},friends:[{name:"Nico Bruhn",email:null,phone:null,energy:1,image:null},{name:"Christoph Juretko",email:null,phone:null,energy:.6,image:null},{name:"Tim Poloczek",email:null,phone:null,energy:.5,image:null},{name:"Dennis Ratzer",email:null,phone:null,energy:.4,image:null},{name:"Nicole Eckert",email:null,phone:null,energy:.4,image:null},{name:"Stefan Harzke",email:null,phone:null,energy:.6,image:null},{name:"Denis Ergashbaev",email:null,phone:null,energy:.6,image:null},{name:"Bastian \xDCckermann",email:null,phone:null,energy:.2,image:null},{name:"Daniela Meyer zu Ummeln",email:null,phone:null,energy:0,image:null},{name:"Mark Enger",email:null,phone:null,energy:.3,image:null},{name:"Matthias Manasterni",email:null,phone:null,energy:.6,image:null},{name:"Dejan Guberinic",email:null,phone:null,energy:.5,image:null},{name:"Carina Bruhn",email:null,phone:null,energy:0,image:null}],goals:[{title:"Intellektuelle Steigerung",description:"Wachstum und Entwicklung der intellektuellen F\xE4higkeiten einer Person.",image:null,actions:[{description:"Neue Themen lernen",time_min:15,time_max:240,energy:.9,image:null},{description:"Ein Buch lesen",time_min:15,time_max:180,energy:.8,image:null},{description:"Objektive Nachrichten lesen",time_min:15,time_max:30,energy:0,image:null}],routines:[]},{title:"Fit und gesund",description:"Einen gesunden Lebensstil und k\xF6rperliche Fitness aufrechterhalten.",image:null,actions:[{description:"Gesund einkaufen und essen",time_min:30,time_max:null,energy:1,image:null},{description:"Vitamin-D-Tablette im Winter einnehmen",time_min:0,time_max:null,energy:.4,image:null},{description:"Schlafen",time_min:480,time_max:480,energy:1,image:null},{description:"Koffein, Alkohol und Rauchen vermeiden",time_min:0,time_max:null,energy:.8,image:null},{description:"Laufen",time_min:120,time_max:120,energy:1,image:null},{description:"Gym",time_min:120,time_max:120,energy:1,image:null},{description:"Fu\xDFball spielen",time_min:90,time_max:90,energy:1,image:null},{description:"Schwimmen gehen",time_min:120,time_max:240,energy:.5,image:null},{description:"Fitness-Workout",time_min:30,time_max:30,energy:.9,image:null},{description:"Regelm\xE4\xDFige Gesundheitschecks",time_min:60,time_max:60,energy:.8,image:null}],routines:[]},{title:"Guter Papa",description:"Ein unterst\xFCtzender und pr\xE4senter Papa sein.",image:null,actions:[{description:"Lego spielen",time_min:10,time_max:120,energy:.9,image:null},{description:"Gesellschaftsspiele spielen",time_min:30,time_max:180,energy:.8,image:null},{description:"Ins Kino gehen",time_min:120,time_max:180,energy:.7,image:null},{description:"Einen gem\xFCtlichen Filmabend machen",time_min:100,time_max:180,energy:.2,image:null}],routines:[]},{title:"Gl\xFCcklich sein",description:"Langfristiges Gl\xFCck und Zufriedenheit erreichen.",image:null,actions:[{description:"Einen gem\xFCtlichen Filmabend machen",time_min:100,time_max:180,energy:.2,image:null},{description:"Urlaub machen",time_min:1440,time_max:40320,energy:1,image:null},{description:"Flohmarkt besuchen",time_min:45,time_max:120,energy:.6,image:null},{description:"Spazieren gehen",time_min:30,time_max:180,energy:.4,image:null},{description:"Massage bekommen",time_min:80,time_max:200,energy:.9,image:null},{description:"Computerspiele spielen",time_min:20,time_max:180,energy:0,image:null},{description:"Ein Buch lesen",time_min:15,time_max:180,energy:.8,image:null},{description:"In die Sauna gehen zur Entspannung",time_min:60,time_max:120,energy:.9,image:null},{description:"Gute Musik h\xF6ren",time_min:0,time_max:null,energy:.8,image:null},{description:"Meditation",time_min:10,time_max:60,energy:.9,image:null},{description:"Boden wischen",time_min:45,time_max:45,energy:.7,image:null},{description:"Fitness-Workout",time_min:30,time_max:30,energy:.9,image:null},{description:"Kurzer Schlaf zur Wiederherstellung der Energie",time_min:10,time_max:30,energy:.8,image:null},{description:"\xDCber Dinge nachdenken, f\xFCr die man dankbar ist",time_min:5,time_max:20,energy:.9,image:null},{description:"Mit geliebten Menschen in Kontakt bleiben",time_min:10,time_max:120,energy:.8,image:null}],routines:[]},{title:"Resiliente Person",description:"Eine resiliente und entspannte Person sein.",image:null,actions:[{description:"Einen gem\xFCtlichen Filmabend machen",time_min:100,time_max:180,energy:.2,image:null},{description:"Spazieren gehen",time_min:30,time_max:180,energy:.4,image:null},{description:"Massage bekommen",time_min:80,time_max:200,energy:.9,image:null},{description:"In die Sauna gehen zur Entspannung",time_min:60,time_max:120,energy:.9,image:null},{description:"Gute Musik h\xF6ren",time_min:0,time_max:null,energy:.8,image:null},{description:"Meditation",time_min:10,time_max:60,energy:.9,image:null},{description:"Kurzer Schlaf zur Wiederherstellung der Energie",time_min:10,time_max:30,energy:.8,image:null},{description:"\xDCber Dinge nachdenken, f\xFCr die man dankbar ist",time_min:5,time_max:20,energy:.9,image:null},{description:"Regelm\xE4\xDFige Gesundheitschecks",time_min:60,time_max:60,energy:.8,image:null}],routines:[]},{title:"Sicherheit",description:"Ein gutes Gef\xFChl von Sicherheit haben.",image:null,actions:[{description:"Vorr\xE4te und Krisenwerkzeuge einrichten",time_min:0,time_max:120,energy:.6,image:null},{description:"Finanzen kontinuierlich optimieren",time_min:10,time_max:60,energy:.2,image:null},{description:"In Verm\xF6genswerte f\xFCr Wachstum investieren",time_min:10,time_max:60,energy:.2,image:null}],routines:[]},{title:"Finanzielle Freiheit",description:"Finanzielle Unabh\xE4ngigkeit erreichen.",image:null,actions:[{description:"Minimalistisch leben. Konsum minimieren.",time_min:0,time_max:null,energy:.7,image:null},{description:"Finanzen kontinuierlich optimieren",time_min:10,time_max:60,energy:.2,image:null},{description:"In Verm\xF6genswerte f\xFCr Wachstum investieren",time_min:10,time_max:60,energy:.2,image:null}],routines:[]},{title:"F\xFCr immer leben",description:"In der Lage sein, f\xFCr immer zu leben.",image:null,actions:[{description:"Gesund einkaufen und essen",time_min:30,time_max:null,energy:1,image:null},{description:"Schlafen",time_min:480,time_max:480,energy:1,image:null},{description:"Koffein, Alkohol und Rauchen vermeiden",time_min:0,time_max:null,energy:.8,image:null},{description:"In die Sauna gehen zur Entspannung",time_min:60,time_max:120,energy:.9,image:null},{description:"Meditation",time_min:10,time_max:60,energy:.9,image:null},{description:"Regelm\xE4\xDFige Gesundheitschecks",time_min:60,time_max:60,energy:.8,image:null}],routines:[]}]};a.add(e),a.close(),console.log("Karmatica erfolgreich in die IndexedDB eingef\xFCgt!")})();var lr=class{async getAll(e){if(!e)return[];try{let t=await fetch(e);if(!t.ok)throw new Error(`Failed to fetch data: ${t.status}`);return await t.json()}catch(t){return console.error("Error fetching data:",t),[]}}};var ke=class{static capitalizeFirstLetter(e){return e&&e.charAt(0).toUpperCase()+e.slice(1)}};var we=globalThis,Ee=we.ShadowRoot&&(we.ShadyCSS===void 0||we.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ke=Symbol(),mr=new WeakMap,_t=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Ke)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Ee&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=mr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&mr.set(t,e))}return e}toString(){return this.cssText}},cr=a=>new _t(typeof a=="string"?a:a+"",void 0,Ke),p=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,o,l)=>n+(m=>{if(m._$cssResult$===!0)return m.cssText;if(typeof m=="number")return m;throw Error("Value passed to 'css' function must be a 'css' function result: "+m+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[l+1],a[0]);return new _t(t,a,Ke)},Ye=(a,e)=>{if(Ee)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),o=we.litNonce;o!==void 0&&n.setAttribute("nonce",o),n.textContent=t.cssText,a.appendChild(n)}},Se=Ee?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return cr(t)})(a):a;var{is:Lr,defineProperty:Mr,getOwnPropertyDescriptor:Vr,getOwnPropertyNames:qr,getOwnPropertySymbols:Gr,getPrototypeOf:Wr}=Object,Te=globalThis,pr=Te.trustedTypes,Ur=pr?pr.emptyScript:"",Qr=Te.reactiveElementPolyfillSupport,Nt=(a,e)=>a,te={toAttribute(a,e){switch(e){case Boolean:a=a?Ur:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},He=(a,e)=>!Lr(a,e),dr={attribute:!0,type:String,converter:te,reflect:!1,hasChanged:He};Symbol.metadata??=Symbol("metadata"),Te.litPropertyMetadata??=new WeakMap;var tt=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=dr){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),o=this.getPropertyDescriptor(e,n,t);o!==void 0&&Mr(this.prototype,e,o)}}static getPropertyDescriptor(e,t,n){let{get:o,set:l}=Vr(this.prototype,e)??{get(){return this[t]},set(m){this[t]=m}};return{get(){return o?.call(this)},set(m){let f=o?.call(this);l.call(this,m),this.requestUpdate(e,f,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??dr}static _$Ei(){if(this.hasOwnProperty(Nt("elementProperties")))return;let e=Wr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Nt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Nt("properties"))){let t=this.properties,n=[...qr(t),...Gr(t)];for(let o of n)this.createProperty(o,t[o])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,o]of t)this.elementProperties.set(n,o)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let o=this._$Eu(t,n);o!==void 0&&this._$Eh.set(o,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let o of n)t.unshift(Se(o))}else e!==void 0&&t.push(Se(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ye(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$EC(e,t){let n=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,n);if(o!==void 0&&n.reflect===!0){let l=(n.converter?.toAttribute!==void 0?n.converter:te).toAttribute(t,n.type);this._$Em=e,l==null?this.removeAttribute(o):this.setAttribute(o,l),this._$Em=null}}_$AK(e,t){let n=this.constructor,o=n._$Eh.get(e);if(o!==void 0&&this._$Em!==o){let l=n.getPropertyOptions(o),m=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:te;this._$Em=o,this[o]=m.fromAttribute(t,l.type),this._$Em=null}}requestUpdate(e,t,n){if(e!==void 0){if(n??=this.constructor.getPropertyOptions(e),!(n.hasChanged??He)(this[e],t))return;this.P(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,t,n){this._$AL.has(e)||this._$AL.set(e,t),n.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[o,l]of this._$Ep)this[o]=l;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[o,l]of n)l.wrapped!==!0||this._$AL.has(o)||this[o]===void 0||this.P(o,this[o],l)}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EU()}catch(n){throw e=!1,this._$EU(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(t=>this._$EC(t,this[t])),this._$EU()}updated(e){}firstUpdated(e){}};tt.elementStyles=[],tt.shadowRootOptions={mode:"open"},tt[Nt("elementProperties")]=new Map,tt[Nt("finalized")]=new Map,Qr?.({ReactiveElement:tt}),(Te.reactiveElementVersions??=[]).push("2.0.4");var Ze=globalThis,Oe=Ze.trustedTypes,hr=Oe?Oe.createPolicy("lit-html",{createHTML:a=>a}):void 0,Je="$lit$",et=`lit$${Math.random().toFixed(9).slice(2)}$`,Fe="?"+et,Kr=`<${Fe}>`,vt=document,re=()=>vt.createComment(""),ne=a=>a===null||typeof a!="object"&&typeof a!="function",_e=Array.isArray,br=a=>_e(a)||typeof a?.[Symbol.iterator]=="function",Xe=`[ 	
\f\r]`,ee=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ur=/-->/g,fr=/>/g,yt=RegExp(`>|${Xe}(?:([^\\s"'>=/]+)(${Xe}*=${Xe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),gr=/'/g,xr=/"/g,vr=/^(?:script|style|textarea|title)$/i,Ne=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),s=Ne(1),pn=Ne(2),dn=Ne(3),M=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),yr=new WeakMap,bt=vt.createTreeWalker(vt,129);function Ar(a,e){if(!_e(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return hr!==void 0?hr.createHTML(e):e}var kr=(a,e)=>{let t=a.length-1,n=[],o,l=e===2?"<svg>":e===3?"<math>":"",m=ee;for(let f=0;f<t;f++){let h=a[f],v,E,x=-1,w=0;for(;w<h.length&&(m.lastIndex=w,E=m.exec(h),E!==null);)w=m.lastIndex,m===ee?E[1]==="!--"?m=ur:E[1]!==void 0?m=fr:E[2]!==void 0?(vr.test(E[2])&&(o=RegExp("</"+E[2],"g")),m=yt):E[3]!==void 0&&(m=yt):m===yt?E[0]===">"?(m=o??ee,x=-1):E[1]===void 0?x=-2:(x=m.lastIndex-E[2].length,v=E[1],m=E[3]===void 0?yt:E[3]==='"'?xr:gr):m===xr||m===gr?m=yt:m===ur||m===fr?m=ee:(m=yt,o=void 0);let y=m===yt&&a[f+1].startsWith("/>")?" ":"";l+=m===ee?h+Kr:x>=0?(n.push(v),h.slice(0,x)+Je+h.slice(x)+et+y):h+et+(x===-2?f:y)}return[Ar(a,l+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},oe=class a{constructor({strings:e,_$litType$:t},n){let o;this.parts=[];let l=0,m=0,f=e.length-1,h=this.parts,[v,E]=kr(e,t);if(this.el=a.createElement(v,n),bt.currentNode=this.el.content,t===2||t===3){let x=this.el.content.firstChild;x.replaceWith(...x.childNodes)}for(;(o=bt.nextNode())!==null&&h.length<f;){if(o.nodeType===1){if(o.hasAttributes())for(let x of o.getAttributeNames())if(x.endsWith(Je)){let w=E[m++],y=o.getAttribute(x).split(et),O=/([.?@])?(.*)/.exec(w);h.push({type:1,index:l,name:O[2],strings:y,ctor:O[1]==="."?Ie:O[1]==="?"?Pe:O[1]==="@"?ze:kt}),o.removeAttribute(x)}else x.startsWith(et)&&(h.push({type:6,index:l}),o.removeAttribute(x));if(vr.test(o.tagName)){let x=o.textContent.split(et),w=x.length-1;if(w>0){o.textContent=Oe?Oe.emptyScript:"";for(let y=0;y<w;y++)o.append(x[y],re()),bt.nextNode(),h.push({type:2,index:++l});o.append(x[w],re())}}}else if(o.nodeType===8)if(o.data===Fe)h.push({type:2,index:l});else{let x=-1;for(;(x=o.data.indexOf(et,x+1))!==-1;)h.push({type:7,index:l}),x+=et.length-1}l++}}static createElement(e,t){let n=vt.createElement("template");return n.innerHTML=e,n}};function At(a,e,t=a,n){if(e===M)return e;let o=n!==void 0?t._$Co?.[n]:t._$Cl,l=ne(e)?void 0:e._$litDirective$;return o?.constructor!==l&&(o?._$AO?.(!1),l===void 0?o=void 0:(o=new l(a),o._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=o:t._$Cl=o),o!==void 0&&(e=At(a,o._$AS(a,e.values),o,n)),e}var Re=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,o=(e?.creationScope??vt).importNode(t,!0);bt.currentNode=o;let l=bt.nextNode(),m=0,f=0,h=n[0];for(;h!==void 0;){if(m===h.index){let v;h.type===2?v=new Lt(l,l.nextSibling,this,e):h.type===1?v=new h.ctor(l,h.name,h.strings,this,e):h.type===6&&(v=new Be(l,this,e)),this._$AV.push(v),h=n[++f]}m!==h?.index&&(l=bt.nextNode(),m++)}return bt.currentNode=vt,o}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Lt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,o){this.type=2,this._$AH=S,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=At(this,e,t),ne(e)?e===S||e==null||e===""?(this._$AH!==S&&this._$AR(),this._$AH=S):e!==this._$AH&&e!==M&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):br(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==S&&ne(this._$AH)?this._$AA.nextSibling.data=e:this.T(vt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,o=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=oe.createElement(Ar(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===o)this._$AH.p(t);else{let l=new Re(o,this),m=l.u(this.options);l.p(t),this.T(m),this._$AH=l}}_$AC(e){let t=yr.get(e.strings);return t===void 0&&yr.set(e.strings,t=new oe(e)),t}k(e){_e(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,o=0;for(let l of e)o===t.length?t.push(n=new a(this.O(re()),this.O(re()),this,this.options)):n=t[o],n._$AI(l),o++;o<t.length&&(this._$AR(n&&n._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},kt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,o,l){this.type=1,this._$AH=S,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=l,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=S}_$AI(e,t=this,n,o){let l=this.strings,m=!1;if(l===void 0)e=At(this,e,t,0),m=!ne(e)||e!==this._$AH&&e!==M,m&&(this._$AH=e);else{let f=e,h,v;for(e=l[0],h=0;h<l.length-1;h++)v=At(this,f[n+h],t,h),v===M&&(v=this._$AH[h]),m||=!ne(v)||v!==this._$AH[h],v===S?e=S:e!==S&&(e+=(v??"")+l[h+1]),this._$AH[h]=v}m&&!o&&this.j(e)}j(e){e===S?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ie=class extends kt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===S?void 0:e}},Pe=class extends kt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==S)}},ze=class extends kt{constructor(e,t,n,o,l){super(e,t,n,o,l),this.type=5}_$AI(e,t=this){if((e=At(this,e,t,0)??S)===M)return;let n=this._$AH,o=e===S&&n!==S||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,l=e!==S&&(n===S||o);o&&this.element.removeEventListener(this.name,this,n),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Be=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){At(this,e)}},wr={M:Je,P:et,A:Fe,C:1,L:kr,R:Re,D:br,V:At,I:Lt,H:kt,N:Pe,U:ze,B:Ie,F:Be},Yr=Ze.litHtmlPolyfillSupport;Yr?.(oe,Lt),(Ze.litHtmlVersions??=[]).push("3.2.1");var Er=(a,e,t)=>{let n=t?.renderBefore??e,o=n._$litPart$;if(o===void 0){let l=t?.renderBefore??null;n._$litPart$=o=new Lt(e.insertBefore(re(),l),l,void 0,t??{})}return o._$AI(a),o};var W=class extends tt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Er(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};W._$litElement$=!0,W.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:W});var Xr=globalThis.litElementPolyfillSupport;Xr?.({LitElement:W});(globalThis.litElementVersions??=[]).push("4.1.1");var u=(o=>(o.primary="primary",o.secondary="secondary",o.surface="surface",o.plain="plain",o))(u||{}),b=class{static getStyle(e){return e?e=="plain"?s``:s` <style>
            :host,
            *,
            ::slotted(*) {
          ...
          </style>`:s``}static getOposite(e){return e=="plain"?"surface":e=="primary"||e=="primary"?"secondary":e=="secondary"?"primary":"plain"}getParentTheme(e){let t=e;for(;t!=null;){if(t.theme!=null)return t.theme;t=t.parentElement}}};var c=a=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(a,e)}):customElements.define(a,e)};var Zr={attribute:!0,type:String,converter:te,reflect:!1,hasChanged:He},Jr=(a=Zr,e,t)=>{let{kind:n,metadata:o}=t,l=globalThis.litPropertyMetadata.get(o);if(l===void 0&&globalThis.litPropertyMetadata.set(o,l=new Map),l.set(t.name,a),n==="accessor"){let{name:m}=t;return{set(f){let h=e.get.call(this);e.set.call(this,f),this.requestUpdate(m,h,a)},init(f){return f!==void 0&&this.P(m,void 0,a),f}}}if(n==="setter"){let{name:m}=t;return function(f){let h=this[m];e.call(this,f),this.requestUpdate(m,h,a)}}throw Error("Unsupported decorator location: "+n)};function i(a){return(e,t)=>typeof t=="object"?Jr(a,e,t):((n,o,l)=>{let m=o.hasOwnProperty(l);return o.constructor.createProperty(l,m?{...n,wrapped:!0}:n),m?Object.getOwnPropertyDescriptor(o,l):void 0})(a,e,t)}function De(a){return i({...a,state:!0,attribute:!1})}var wt=(a,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,t),t);function g(a,e){return(t,n,o)=>{let l=m=>m.renderRoot?.querySelector(a)??null;if(e){let{get:m,set:f}=typeof n=="object"?t:o??(()=>{let h=Symbol();return{get(){return this[h]},set(v){this[h]=v}}})();return wt(t,n,{get(){let h=m.call(this);return h===void 0&&(h=l(this),(h!==null||this.hasUpdated)&&f.call(this,h)),h}})}return wt(t,n,{get(){return l(this)}})}}var d=class extends W{constructor(){super(...arguments);this.theme="plain"}throwCustomEvent(t,n){this.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0,composed:!0}))}};r([i({type:u,converter:String})],d.prototype,"theme",2);var Sr=class{constructor(e,t,n=10240){this.key=e;this.minWidth=t;this.maxWidth=n}asMediaStyle(e){let t="@media ";return this.minWidth&&(t=t.concat("(min-width: ").concat(String(this.minWidth)).concat("px)"),this.maxWidth&&(t=t.concat(" and "))),this.maxWidth&&(t=t.concat("(max-width: ").concat(String(this.maxWidth)).concat("px)")),t=t.concat("{"),t=t.concat(e),t=t.concat("} "),t}};var lt=class extends d{constructor(){super(...arguments);this.key=null;this.item={};this.title=""}updated(t){t.has("item")&&(this.title=this.item.constructor.name)}render(){return s`
    ...
    `}renderFormFields(){let t=[];for(let[n,o]of Object.entries(this.item)){let l=ke.capitalizeFirstLetter(n),m;switch(typeof o){case"boolean":m=s`
            <nidoca-form-switch
          ...
          `;break;default:m=s`
            ...
            ></nidoca-form-text>
          `}t.push(m)}return s`${t}`}deleteItem(){this.formComponent!=null&&(console.log("item deleted."),this.item=this.formComponent.getOutputData().jsonObject,this.throwCustomEvent("nidoca-event-generic-edit-item-deleted",this.item))}updateItem(){this.formComponent!=null&&this.formComponent.validate()&&(this.item=this.formComponent.getOutputData().jsonObject,this.throwCustomEvent("nidoca-event-generic-edit-item-updated",this.item))}saveItem(){this.formComponent!=null&&this.formComponent.validate()&&(this.item=this.formComponent.getOutputData().jsonObject,this.throwCustomEvent("nidoca-event-generic-edit-item-saved",this.item))}cancel(){this.throwCustomEvent("nidoca-event-generic-edit-cancel",this.item)}};r([i({type:Object})],lt.prototype,"key",2),r([i({type:Object})],lt.prototype,"item",2),r([i({type:String})],lt.prototype,"title",2),r([g("#form")],lt.prototype,"formComponent",2),lt=r([c("nidoca-generic-edit")],lt);var ie=class extends d{constructor(){super(...arguments);this.data=[]}render(){return this.data==null||!this.data.length?s`<p>Loading data...</p>`:s`
            <nidoca-list theme="${this.theme}">
              ${this.data.map(t=>this.renderListItem(t))}
            </nidoca-list>
          `}};r([i({})],ie.prototype,"data",2);var se=class extends ie{render(){return s`
    <nidoca-search-bar @nidoca-search-bar-event-value-changed="${e=>this.internSearch(e.detail)}"></nidoca-search-bar>
    ${super.render()}
            `}internSearch(e){this.data=this.search(e)}search(e){}renderListItem(e){throw new Error("Method not implemented.")}itemClicked(e){throw new Error("Method not implemented.")}};se.styles=p`
    :host {
      display: block;
      max-width: 768px;
      margin: 0 auto;
  ...
  `,se=r([c("nidoca-generic-list-search")],se);var rt=class extends d{constructor(){super(...arguments);this.listView=!0;this.data=[];this.key=null;this.item={};this.title=""}updated(t){t.has("item")&&(console.log("Item changed crud:",this.item),this.title=this.item.constructor.name),t.has("key")}render(){return console.log("render generic crud"+JSON.stringify(this.data)),s`
        <nidoca-generic-edit .item="${this.item}" key="${this.key}" title="${this.title}"></nidoca-generic-edit>
        <nidoca-generic-list-search .data="${this.data}"></nidoca-generic-list-search>`}};r([De()],rt.prototype,"listView",2),r([i({})],rt.prototype,"data",2),r([i({type:Object})],rt.prototype,"key",2),r([i({type:Object})],rt.prototype,"item",2),r([i({type:String})],rt.prototype,"title",2),rt=r([c("nidoca-generic-crud")],rt);var U=class extends d{constructor(){super(...arguments);this.theme="surface";this.header="";this.opened=!1}render(){return s`
      <div @click="${()=>this.toggle()}" class="header">
        <nidoca-text theme="${this.theme}" text="${this.header}"></nidoca-text>
        <nidoca-icon icon="${this.opened?"keyboard_arrow_down":"keyboard_arrow_up"}"></nidoca-icon>
      </div>
      ${this.opened?s` <slot></slot>`:s``}
    `}toggle(){console.log("accordion clicked, state="+this.opened),this.opened=!this.opened,console.log("accordion clicked, after state="+this.opened),this.dispatchEvent(new CustomEvent("nidoca-event-accordion-item-clicked",{detail:this,bubbles:!0,composed:!0}))}};U.styles=p`
    :host {
  ...
  `,r([i({type:u,converter:String})],U.prototype,"theme",2),r([i({type:String})],U.prototype,"header",2),r([i({type:Boolean})],U.prototype,"opened",2),U=r([c("nidoca-accordion-item")],U);var H=class extends d{constructor(){super(...arguments);this.theme="plain";this.overline="";this.title="";this.summary="";this.text=""}render(){return s`
    ...
    `}static example(t="",n="plain"){return s`<nidoca-article
      theme="${n}"
      slot="${t}"
      style="padding:25px;"
  ...
  `,r([i({type:u,converter:String})],H.prototype,"theme",2),r([i({type:String})],H.prototype,"overline",2),r([i({type:String})],H.prototype,"title",2),r([i({type:String})],H.prototype,"summary",2),r([i({type:String})],H.prototype,"text",2),H=r([c("nidoca-article")],H);var Tr=(t=>(t.single="single",t.multi="multi",t))(Tr||{}),mt=class extends d{constructor(){super(...arguments);this.theme="plain";this.accordionType="single"}updated(t){super.updated(t),t.forEach((n,o)=>{if(o=="theme"&&this.accordionSlot!=null){let l=this.accordionSlot.assignedElements();for(let m=0;m<l.length;m++){let f=l[m];f instanceof U&&(f.theme=this.theme)}}})}render(){return s`
      ${b.getStyle(this.theme)}
      <slot
        @nidoca-event-accordion-item-clicked="${t=>this.accordionSwitched(t)}"
        id="accordionSlot"
      ></slot>
    `}accordionSwitched(t){let n=t.detail;switch(this.accordionType){case"single":if(this.accordionSlot!=null){let o=this.accordionSlot.assignedElements();for(let l=0;l<o.length;l++){let m=o[l];m instanceof U&&m!=n&&(m.opened=!1)}}break;case"multi":break}t.stopPropagation()}static example(t=""){return s`<nidoca-accordion slot="${t}" theme="plain">
  ...
  `,r([i({type:u,converter:String})],mt.prototype,"theme",2),r([i({type:Tr,converter:String})],mt.prototype,"accordionType",2),r([g("#accordionSlot")],mt.prototype,"accordionSlot",2),mt=r([c("nidoca-accordion")],mt);var Hr=(o=>(o.none="none",o.shadow_1="shadow_1",o.shadow_2="shadow_2",o.shadow_3="shadow_3",o))(Hr||{}),Q=class extends d{constructor(){super(...arguments);this.theme="primary";this.shadowType="shadow_1";this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return s`
      <style>
        .iconExtended {
  ...
  `,r([i({type:String})],Q.prototype,"theme",2),r([i({type:Object})],Q.prototype,"shadowType",2),r([i({type:String})],Q.prototype,"icon",2),r([i({type:Boolean})],Q.prototype,"clickable",2),r([i({type:Boolean})],Q.prototype,"deactivated",2),r([i({type:String})],Q.prototype,"title",2),Q=r([c("nidoca-icon-extended")],Q);var Or=(o=>(o[o.current=0]="current",o[o.completed=1]="completed",o[o.open=2]="open",o[o.finish=3]="finish",o))(Or||{}),V=class extends d{constructor(){super(...arguments);this.icon="";this.primaryText="";this.isLast=!1;this.first=!1}render(){return s`
      <div
  ...
  `,r([i({type:String})],V.prototype,"icon",2),r([i({type:String})],V.prototype,"primaryText",2),r([i({type:Number})],V.prototype,"state",2),r([i({type:Boolean})],V.prototype,"isLast",2),V=r([c("nidoca-wizard-step")],V);var Mt=class extends d{render(){return s`
      <div
    ...
    `}slotChanged(e){let t=e.target;if(t==null)return;let n=t.assignedElements(),o=0;for(let l=0;l<n.length;l++){let m=n[l];m instanceof V&&(m.index=l,m.state==0&&(o=l),m.index==n.length-1&&(m.isLast=!0))}this.changeState(o)}stepClicked(e){let t=e.detail;console.debug("wizard step clicked, selectedStepIndex: %s",t),this.changeState(t)}changeState(e){if(this.wizardSlot){let t=this.wizardSlot.assignedElements();for(let n=0;n<t.length;n++){let o=t[n];o instanceof V&&o.index!==void 0&&(o.index<e?o.state=1:o.index==e?o.state=0:o.state=2)}}}};Mt.styles=p``,r([g("#wizardSlot")],Mt.prototype,"wizardSlot",2),Mt=r([c("nidoca-wizard")],Mt);var ct=class extends d{constructor(){super(...arguments);this.clickable=!0;this.theme="surface";this.text=""}render(){return s`
      <style>
        .chip:hover {
    ...
    `}static example(t=""){return s`<nidoca-chip slot="${t}" clickable text="Mein Chip"></nidoca-chip>`}};ct.styles=p`
    .chip {
      display: inline-block;
      padding: var(--space-2);
      border-radius: 1rem;
  ...
  `,r([i({type:Boolean})],ct.prototype,"clickable",2),r([i({type:u,converter:String})],ct.prototype,"theme",2),r([i({type:String})],ct.prototype,"text",2),ct=r([c("nidoca-chip")],ct);var Et=class extends d{constructor(){super(...arguments);this.code="";this.theme="plain"}render(){return s`
      <style>
        code {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
    ...
    `}static example(t=""){return s`<nidoca-code slot="${t}" theme="surface"> my code </nidoca-code>`}};Et.styles=p`
    :host {
      display: block;
    }
    pre {
  ...
  `,r([i({type:String})],Et.prototype,"code",2),r([i({type:String})],Et.prototype,"theme",2),Et=r([c("nidoca-code")],Et);var je=class{static{this.PROGRESS="PROGRESS"}static{this.PROGRESS_CIRCULAR="PROGRESS_CIRCULAR"}},St=class extends d{constructor(){super(...arguments);this.progressType=je.PROGRESS}render(){return s` <style>
        :host {
          width: 100%;
          display: block;
        }
      ...
      <progress class="${this.progressType}"></progress>`}};St.styles=p``,r([i({type:u,converter:String})],St.prototype,"theme",2),r([i({type:je,converter:String})],St.prototype,"progressType",2),St=r([c("nidoca-progress")],St);var $e=(n=>(n.contained="contained",n.outlined="outlined",n.text="text",n))($e||{}),nt=class extends d{constructor(){super(...arguments);this.theme="primary";this.buttonType="contained";this.icon="";this.text=""}render(){return s`
      <style>
        .outlined {
          color: var(--app-color-${this.theme}-background);
    ...
    `}clicked(){this.dispatchEvent(new CustomEvent("nidoca-event-button-clicked",{detail:this,bubbles:!0,composed:!0}))}static example(t=""){return s`<nidoca-button slot="${t}" text="Start" icon="home"></nidoca-button>`}};nt.styles=p`
    :host,
    .fullWidth {
      display: block;
      width: 100%;
  ...
  `,r([i({type:u,converter:String})],nt.prototype,"theme",2),r([i({type:$e,converter:String})],nt.prototype,"buttonType",2),r([i({type:String})],nt.prototype,"icon",2),r([i({type:String})],nt.prototype,"text",2),nt=r([c("nidoca-button")],nt);var Rr=class{constructor(){this.key=""}},D=class extends d{};var Ir=class{constructor(){this.formData=FormData.prototype}},Tt=class extends d{constructor(){super(...arguments);this.autocomplete=!0}render(){return s`
      <form autocomplete="${this.autocomplete?"on":"off"}">
        <slot id="slotElement"></slot>
      </form>
    `}getOutputData(){let t=new FormData,n={};for(let l of this.getInputElements(this.slotElement)){let m=l.getOutputData();n[m.key]=m.value,t.append(m.key,m.value)}let o={};return o.jsonObject=n,o.formData=t,o}validate(){let t=!0;for(let n of this.getInputElements(this.slotElement))n.validate()||(t=!1);return t||this.dispatchEvent(new CustomEvent("nidoca-form-validation-failed",{detail:this.getOutputData(),bubbles:!0,composed:!0})),t}getInputElements(t){if(t==null)return[];let n=[],o=t.assignedElements({flatten:!0});for(let l=0;l<o.length;l++){let m=o[l];this.recursiveInputElementSearch(m,n)}return n}recursiveInputElementSearch(t,n){if(t instanceof D)n.push(t);else if(t.hasChildNodes()){let o=t.children;for(let l of[].slice.call(o))this.recursiveInputElementSearch(l,n)}}};Tt.styles=p`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([i({type:Boolean})],Tt.prototype,"autocomplete",2),r([g("#slotElement")],Tt.prototype,"slotElement",2),Tt=r([c("nidoca-form")],Tt);var Pr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ce=a=>(...e)=>({_$litDirective$:a,values:e}),Vt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:Fr}=wr;var zr=()=>document.createComment(""),qt=(a,e,t)=>{let n=a._$AA.parentNode,o=e===void 0?a._$AB:e._$AA;if(t===void 0){let l=n.insertBefore(zr(),o),m=n.insertBefore(zr(),o);t=new Fr(l,m,a,a.options)}else{let l=t._$AB.nextSibling,m=t._$AM,f=m!==a;if(f){let h;t._$AQ?.(a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==m._$AU&&t._$AP(h)}if(l!==o||f){let h=t._$AA;for(;h!==l;){let v=h.nextSibling;n.insertBefore(h,o),h=v}}}return t},pt=(a,e,t=a)=>(a._$AI(e,t),a),_r={},Br=(a,e=_r)=>a._$AH=e,Dr=a=>a._$AH,Le=a=>{a._$AP?.(!1,!0);let e=a._$AA,t=a._$AB.nextSibling;for(;e!==t;){let n=e.nextSibling;e.remove(),e=n}};var jr=(a,e,t)=>{let n=new Map;for(let o=e;o<=t;o++)n.set(a[o],o);return n},Gt=Ce(class extends Vt{constructor(a){if(super(a),a.type!==Pr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let n;t===void 0?t=e:e!==void 0&&(n=e);let o=[],l=[],m=0;for(let f of a)o[m]=n?n(f,m):m,l[m]=t(f,m),m++;return{values:l,keys:o}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,n]){let o=Dr(a),{values:l,keys:m}=this.dt(e,t,n);if(!Array.isArray(o))return this.ut=m,l;let f=this.ut??=[],h=[],v,E,x=0,w=o.length-1,y=0,O=l.length-1;for(;x<=w&&y<=O;)if(o[x]===null)x++;else if(o[w]===null)w--;else if(f[x]===m[y])h[y]=pt(o[x],l[y]),x++,y++;else if(f[w]===m[O])h[O]=pt(o[w],l[O]),w--,O--;else if(f[x]===m[O])h[O]=pt(o[x],l[O]),qt(a,h[O+1],o[x]),x++,O--;else if(f[w]===m[y])h[y]=pt(o[w],l[y]),qt(a,o[x],o[w]),w--,y++;else if(v===void 0&&(v=jr(m,y,O),E=jr(f,x,w)),v.has(f[x]))if(v.has(f[w])){let N=E.get(m[y]),Ue=N!==void 0?o[N]:null;if(Ue===null){let tr=qt(a,o[x]);pt(tr,l[y]),h[y]=tr}else h[y]=pt(Ue,l[y]),qt(a,o[x],Ue),o[N]=null;y++}else Le(o[w]),w--;else Le(o[x]),x++;for(;y<=O;){let N=qt(a,h[O+1]);pt(N,l[y]),h[y++]=N}for(;x<=w;){let N=o[x++];N!==null&&Le(N)}return this.ut=m,Br(a,h),M}});var Nr={},ae=Ce(class extends Vt{constructor(){super(...arguments),this.ot=Nr}render(a,e){return e()}update(a,[e,t]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((n,o)=>n===this.ot[o]))return M}else if(this.ot===e)return M;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,t)}});var R=class extends D{constructor(){super(...arguments);this.theme="surface";this.trailingIcon="";this.label="";this.errorText="";this.infoText="";this.warningText="";this.value="";this.options=[];this.name="";this.required=!0;this.multiple=!1;this.size=1}render(){return s` <style>
        .parentContainer,
      ...
      ${this.infoText||this.warningText||this.errorText?s`
          ...
          `:s``}`}getOutputData(){let t=this.value;if(this.selectElement!=null&&this.multiple){t=[];for(let n=0,o=this.selectElement.options.length;n<o;n++)this.selectElement.options[n].selected&&t.push(this.options[n].key)}else this.selectElement!=null&&(this.selectElement.value.length==0?t=null:t=this.selectElement.value);return{key:this.name,value:t}}validate(){return this.errorText="",this.selectElement!=null&&!this.selectElement.validity.valid&&this.selectElement.validationMessage!=this.errorText&&(this.errorText=this.selectElement.validationMessage),this.errorText.length==0}isSelectedOption(t){if(this.multiple){let n=!1;for(let o of this.value)if(n=t.key===o,n)return!0}return this.value===t.key}static enumToOptions(t,n=!0){let o=[];return n&&o.push({key:"",value:""}),Object.keys(t).forEach(l=>{o.push({key:l,value:t[l]})}),o}static stringArrayToOptions(t,n=!0){let o=[];return n&&o.push({key:"",value:""}),t.forEach(l=>{o.push({key:l,value:l})}),o}static toComboboxOptions(t=null,n=null){if(t==null)return[];let o=[];return Object.values(t).forEach(l=>{let m=String(Object.keys(t)[Object.values(t).indexOf(l)]);n&&(m=m.concat(n)),o.push({key:l,value:m})}),o}};R.styles=p`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([i({type:u,converter:String})],R.prototype,"theme",2),r([i({type:String})],R.prototype,"trailingIcon",2),r([i({type:String})],R.prototype,"label",2),r([i({type:String})],R.prototype,"errorText",2),r([i({type:String})],R.prototype,"infoText",2),r([i({type:String})],R.prototype,"warningText",2),r([i()],R.prototype,"value",2),r([i({type:Array})],R.prototype,"options",2),r([i({type:String})],R.prototype,"name",2),r([i({type:Boolean})],R.prototype,"required",2),r([i({type:Boolean})],R.prototype,"multiple",2),r([i({type:Number})],R.prototype,"size",2),r([g("#selectElement")],R.prototype,"selectElement",2),R=r([c("nidoca-form-combobox")],R);var T=a=>a??S;var ot=(y=>(y.color="color",y.email="email",y.hidden="hidden",y.number="number",y.password="password",y.tel="tel",y.text="text",y.search="search",y.url="url",y.date="date",y.month="month",y.time="time",y.week="week",y))(ot||{}),k=class extends D{constructor(){super(...arguments);this.type="text";this.label="";this.placeholder="";this.trailingIcon="";this.errorText="";this.infoText="";this.warningText="";this.name="";this.value="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="plain"}render(){return this.type=="hidden"?s`<input id="inputElement" name="${this.name}" type="${this.type}" value="${this.value}" />`:s` <style>
            .parentContainer,
            ::slotted(.parentContainer) {
              color: var(--app-color-text-${this.theme});
              background-color: var(--app-color-${this.theme}-background);
          ...
          ${this.infoText||this.warningText||this.errorText?s`
              ...
              `:s``}`}getOutputData(){let t=this.inputElement?.value;return{key:this.name,value:t?.trim()}}validate(){return this.errorText="",this.inputElement!=null&&!this.inputElement.validity.valid&&this.inputElement.validationMessage!=this.errorText&&(this.errorText=this.inputElement.validationMessage,this.inputElement.validity.patternMismatch&&this.pattern&&(this.errorText=this.errorText.concat(" Format: ").concat(this.pattern))),this.errorText==""}};k.styles=p`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([i({type:ot,converter:String})],k.prototype,"type",2),r([i({type:String})],k.prototype,"label",2),r([i({type:String})],k.prototype,"placeholder",2),r([i({type:String})],k.prototype,"trailingIcon",2),r([i({type:String})],k.prototype,"errorText",2),r([i({type:String})],k.prototype,"infoText",2),r([i({type:String})],k.prototype,"warningText",2),r([i({type:String})],k.prototype,"name",2),r([i()],k.prototype,"value",2),r([i({type:Boolean})],k.prototype,"required",2),r([i({type:Boolean})],k.prototype,"disabled",2),r([i({type:Boolean})],k.prototype,"checked",2),r([i({type:Number})],k.prototype,"maxlength",2),r([i({type:Number})],k.prototype,"minlength",2),r([i({type:Number})],k.prototype,"min",2),r([i({type:Number})],k.prototype,"max",2),r([i({type:String})],k.prototype,"step",2),r([i({type:Number})],k.prototype,"size",2),r([i({type:String})],k.prototype,"pattern",2),r([g("#inputElement")],k.prototype,"inputElement",2),r([i({type:u,converter:String})],k.prototype,"theme",2),k=r([c("nidoca-form-text")],k);var Me=class extends k{constructor(){super(),this.type="date"}};Me=r([c("nidoca-form-date")],Me);var P=class extends D{constructor(){super(...arguments);this.theme="surface";this.infoText="";this.warningText="";this.errorText="";this.name="";this.value="";this.label="";this.required=!1;this.placeholder="";this.disabled=!1;this.rows=5}render(){return s` <style>
        .parentContainer,
        ::slotted(.parentContainer) {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
...
${this.value}</textarea
      ...
      ${this.infoText||this.warningText||this.errorText?s`
          ...
          `:s``}`}getOutputData(){let t=this.inputElement?.value;return{key:this.name,value:t}}validate(){return this.errorText="",this.inputElement!=null&&!this.inputElement.validity.valid&&this.inputElement.validationMessage!=this.errorText&&(this.errorText=this.inputElement.validationMessage),this.errorText==""}};P.styles=p`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([i({type:u,converter:String})],Ht.prototype,"theme",2),r([g("#inputElement")],Ht.prototype,"inputElement",2),Ht=r([c("nidoca-form-upload")],Ht);var B=class extends D{constructor(){super();this.name="";this.label="";this.infoText="";this.errorText="";this.warningText="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="primary";this.theme=b.prototype.getParentTheme(this)||"plain"}render(){return s`
      <style>
        .slider {
  ...
  `,r([i({type:String})],B.prototype,"name",2),r([i({type:String})],B.prototype,"label",2),r([i({type:String})],B.prototype,"infoText",2),r([i({type:String})],B.prototype,"errorText",2),r([i({type:String})],B.prototype,"warningText",2),r([i({type:Boolean})],B.prototype,"required",2),r([i({type:Boolean})],B.prototype,"disabled",2),r([i({type:Boolean})],B.prototype,"checked",2),r([i({type:String})],B.prototype,"theme",2),r([g("#inputElement")],B.prototype,"inputElement",2),B=r([c("nidoca-form-switch")],B);var Z=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Newsletter";this.emailLabel="Deine Emailadresse";this.buttonLabel="Registrieren"}render(){return s`
      <nidoca-box theme="${T(this.theme)}">
        <nidoca-form id="form">
  ...
  `,r([i({type:u,converter:String})],Z.prototype,"theme",2),r([i({type:String,converter:String})],Z.prototype,"label",2),r([i({type:String,converter:String})],Z.prototype,"emailLabel",2),r([i({type:String,converter:String})],Z.prototype,"buttonLabel",2),r([g("#form")],Z.prototype,"formComponent",2),Z=r([c("nidoca-form-newsletter")],Z);var J=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Passwort zur\xFCcksetzen";this.emailLabel="Deine Emailadresse";this.buttonLabel="Zur\xFCcksetzen"}render(){return s`
  ...
  `,r([i({type:u,converter:String})],z.prototype,"theme",2),r([i({type:String,converter:String})],z.prototype,"label",2),r([i({type:String,converter:String})],z.prototype,"oldPasswordLabel",2),r([i({type:String,converter:String})],z.prototype,"newPasswordLabel",2),r([i({type:String,converter:String})],z.prototype,"repeatNewPasswordLabel",2),r([i({type:String,converter:String})],z.prototype,"buttonLabel",2),r([g("#form")],z.prototype,"formComponent",2),r([g("#oldPassword")],z.prototype,"oldPasswordInputField",2),r([g("#newPassword")],z.prototype,"newPasswordInputField",2),r([g("#repeatNewPassword")],z.prototype,"repeatNewPasswordInputField",2),r([i()],z.prototype,"errorMessageSamePasswordLabel",2),r([i()],z.prototype,"errorMessagePasswordDiffLabel",2),z=r([c("nidoca-form-change-password")],z);var K=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Registrieren";this.emailLabel="Email";this.passwordLabel="Passwort";this.buttonLabel="Registrieren"}render(){return s`
      <nidoca-box theme="${T(this.theme)}">
        <nidoca-form id="form">
          <nidoca-text-h2 class="paddingBottom">${this.label}</nidoca-text-h2>
    ...
    `}register(){this.formComponent&&this.formComponent.validate()&&this.dispatchEvent(new CustomEvent("nidoca-form-register-submit",{detail:this.formComponent.getOutputData(),bubbles:!0,composed:!0}))}};K.styles=p`
    :host {
      display: block;
      width: 100%;
    }
  ...
  `,r([i({type:u,converter:String})],K.prototype,"theme",2),r([i({type:String,converter:String})],K.prototype,"label",2),r([i({type:String,converter:String})],K.prototype,"emailLabel",2),r([i({type:String,converter:String})],K.prototype,"passwordLabel",2),r([i({type:String,converter:String})],K.prototype,"buttonLabel",2),r([g("#form")],K.prototype,"formComponent",2),K=r([c("nidoca-form-register")],K);var Wt=class extends d{constructor(){super(...arguments);this.code=""}render(){return s``}};Wt.styles=p``,r([i({type:String})],Wt.prototype,"code",2),Wt=r([c("nidoca-upload")],Wt);var Ot=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return s`
      <style>
        .hr {
          border-color: var(--app-color-${this.theme}-border);
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([i({type:u,converter:String})],Ot.prototype,"theme",2),r([i({type:String,converter:String})],Ot.prototype,"text",2),Ot=r([c("nidoca-hr")],Ot);var Rt=class extends d{constructor(){super(...arguments);this.text="";this.icon=""}render(){return s`
      <div class="container">
        ${this.icon?s` <nidoca-icon
              slot="graphic"
              icon="${this.icon}"
    ...
    `}static example(t=""){return s`<nidoca-menu-area slot="${t}" icon="gavel" text="Rechtliches"></nidoca-menu-area>`}};Rt.styles=p`
    .container {
      display: flex;
      padding-left: var(--space-2);
      padding-right: var(--space-2);
  ...
  `,r([i({type:String})],Rt.prototype,"text",2),r([i({type:String})],Rt.prototype,"icon",2),Rt=r([c("nidoca-menu-area")],Rt);var q=class extends d{constructor(){super(...arguments);this.text="";this.icon="";this.selected=!1;this.theme="surface"}render(){return s`
      <style>
        .container:hover {
          background-color: var(--app-color-${this.theme}-hover);
        }
    ...
    `}clicked(){this.dispatchEvent(new CustomEvent("nidoca-event-menu-item-clicked",{detail:this,bubbles:!0,composed:!0}))}static example(t=""){return s`<nidoca-menu-item slot="${t}" text="Start" icon="home"></nidoca-menu-item>`}};q.styles=p`
    .container {
      display: flex;
      cursor: pointer;
      padding-left: var(--space-2);
  ...
  `,r([i({type:String})],q.prototype,"text",2),r([i({type:String})],q.prototype,"icon",2),r([i({type:Boolean})],q.prototype,"selected",2),r([i({type:String})],q.prototype,"theme",2),q=r([c("nidoca-menu-item")],q);var It=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s` <style>
        :host,
        *,
        ::slotted(*) {
          color: var(--app-color-text-${this.theme});
      ...
      <slot id="slotElement"></slot>`}updated(t){super.updated(t),t.forEach((n,o)=>{if(o=="theme"&&this.slotElement!=null){let l=this.slotElement.assignedElements();for(let m=0;m<l.length;m++){let f=l[m];f instanceof q&&(f.theme=this.theme)}}})}firstUpdated(){this.addEventListener("click",t=>{if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let o=0;o<n.length;o++){let l=n[o];if(l instanceof q){let m=l.getBoundingClientRect();m.left<t.x&&m.right>t.x&&(m.top<t.y&&m.bottom>t.y?l.selected=!0:l.selected=!1)}}}})}static example(t=""){return s`
  ...
  `,r([i({type:String})],It.prototype,"theme",2),r([g("#slotElement")],It.prototype,"slotElement",2),It=r([c("nidoca-menu")],It);var Y=class extends d{constructor(){super(...arguments);this.height="auto";this.width="auto";this.left="auto";this.top="auto";this.right="auto";this.bottom="auto"}render(){return s`
      <slot
        class="floatingContainer"
        style="${this.toStyle(this.height,this.width,this.left,this.right,this.top,this.bottom)}"
      ></slot>
    `}toStyle(t,n,o,l,m,f){return"height:".concat(t).concat(";").concat("width:").concat(n).concat(";").concat("left:").concat(o).concat(";").concat("right:").concat(l).concat(";").concat("top:").concat(m).concat(";").concat("bottom:").concat(f).concat(";")}};Y.styles=p`
    .floatingContainer {
      position: fixed;
      display: inline;
      margin: auto;
  ...
  `,r([i({type:String})],Y.prototype,"height",2),r([i({type:String})],Y.prototype,"width",2),r([i({type:String})],Y.prototype,"left",2),r([i({type:String})],Y.prototype,"top",2),r([i({type:String})],Y.prototype,"right",2),r([i({type:String})],Y.prototype,"bottom",2),Y=r([c("nidoca-layout-floating")],Y);var Ut=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s`
      ${b.getStyle(this.theme)}
      <slot></slot>
    `}};Ut.styles=p`
    :host {
  ...
  `,r([i({type:String})],Ut.prototype,"theme",2),Ut=r([c("nidoca-container")],Ut);var Pt=class extends d{constructor(){super();this.hideSidebox=!0;this.theme=b.prototype.getParentTheme(this)||"plain"}render(){return s` <style>
        .listbox,
        .sidebox {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
      ...
      ${this.hideSidebox?s``:s` <slot class="sidebox" name="sidebox"></slot>`}`}};Pt.styles=p`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: nowrap;
  ...
  `,r([i({type:u,converter:String})],Pt.prototype,"theme",2),r([i({type:Boolean,converter:String})],Pt.prototype,"hideSidebox",2),Pt=r([c("nidoca-split-screen")],Pt);var G=class extends d{constructor(){super(...arguments);this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return s`
      <i
  ...
  `,r([i({type:String})],G.prototype,"icon",2),r([i({type:Boolean})],G.prototype,"clickable",2),r([i({type:Boolean})],G.prototype,"deactivated",2),r([i({type:String})],G.prototype,"title",2),G=r([c("nidoca-icon")],G);var Qt=class extends d{render(){return s`
      <div id="rippleContainer" anim="ripple" @click="${e=>this.clicked(e)}">
        <slot></slot>
      </div>
    `}clicked(e){if(this.rippleContainerElement!=null){e instanceof TouchEvent&&(e=e.touches?e.touches[0]:e);let t=this.rippleContainerElement.getBoundingClientRect(),n=Math.sqrt(Math.pow(t.width,2)+Math.pow(t.height,2))*2;this.rippleContainerElement.style.cssText="--s: 0; --o: 1;",this.rippleContainerElement.offsetTop,(e instanceof MouseEvent||e instanceof Touch)&&(this.rippleContainerElement.style.cssText=`--t: 1; --o: 0; --d: ${n}; --x:${e.clientX-t.left}; --y:${e.clientY-t.top};`)}}};Qt.styles=p`
    :host {
      display: inline-block;
    }
  ...
  `,r([i({type:String})],j.prototype,"src",2),r([i({type:String})],j.prototype,"width",2),r([i({type:String})],j.prototype,"height",2),r([i({type:Boolean})],j.prototype,"zoom",2),j=r([c("nidoca-img")],j);var zt=class extends j{static example(e=""){return s`<nidoca-img-round width="64px" width="64px" slot="${e}" src="face.jpg"></nidoca-img-round>`}};zt.styles=p`
    :host {
      font-size: 0;
      display: inline-block;
      box-sizing: border-box;
  ...
  `,zt=r([c("nidoca-img-round")],zt);var Bt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
    ...
    `}slotChanged(t){let n=t.target;if(n==null)return;let o=n.assignedElements();for(let l=0;l<o.length;l++){let m=o[l];if(m instanceof j){this.selected==null&&l==0&&(this.selected=m.cloneNode(!0)),m.addEventListener("click",h=>{h.target&&(this.selected=h.target.cloneNode(!0))}),m.width="148px";let f=m.classList;f.contains("img")||f.add("img")}}}};Bt.styles=p`
    :host,
    ::slotted(:host) {
      display: flex;
      flex-direction: column;
  ...
  `,r([i({type:u,converter:String})],Bt.prototype,"theme",2),r([De()],Bt.prototype,"selected",2),Bt=r([c("nidoca-img-slider")],Bt);var Kt=class extends d{constructor(){super(...arguments);this.src=""}render(){return s`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
        ...
        ></iframe
      ></span>
    `}};Kt.styles=p``,r([i({type:String})],Kt.prototype,"src",2),Kt=r([c("nidoca-movie")],Kt);var $=class extends d{constructor(){super(...arguments);this.label="";this.placeholder="";this.name="";this.min=1;this.max=10;this.errorText="";this.numberOne=1;this.numberTwo=1}render(){return s`
      <nidoca-form-text
        theme="${T(this.theme)}"
        id="inputfield"
        placeholder="${this.placeholder}"
  ...
  `,r([i({type:u,converter:String})],$.prototype,"theme",2),r([i({type:String})],$.prototype,"label",2),r([i({type:String})],$.prototype,"placeholder",2),r([i({type:String})],$.prototype,"name",2),r([i({type:Number})],$.prototype,"min",2),r([i({type:Number})],$.prototype,"max",2),r([i({type:String})],$.prototype,"errorText",2),r([g("#inputfield")],$.prototype,"inputfield",2),$=r([c("nidoca-form-captcha")],$);var dt=class extends d{constructor(){super(...arguments);this.text="";this.href="";this.targetType="_self"}render(){return s`<a href="${this.href}" .target="${this.targetType}">
  ...
  `,r([i({type:String})],dt.prototype,"text",2),r([i({type:String})],dt.prototype,"href",2),r([i({type:String})],dt.prototype,"targetType",2),dt=r([c("nidoca-link")],dt);var I=class extends d{constructor(){super(...arguments);this.theme="surface";this.primaryText="";this.secondaryText="";this.tertiaryText="";this.infoText="";this.selected=!1}render(){return s`
      <style>
        .container {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([i({type:u,converter:String})],I.prototype,"theme",2),r([i({type:String})],I.prototype,"primaryText",2),r([i({type:String})],I.prototype,"secondaryText",2),r([i({type:String})],I.prototype,"tertiaryText",2),r([i({type:String})],I.prototype,"infoText",2),r([i({type:Boolean})],I.prototype,"selected",2),I=r([c("nidoca-list-item")],I);var it=class extends d{constructor(){super(...arguments);this.theme="surface";this.text=""}render(){return s`
      <style>
        :host {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background-dark);
    ...
    `}static example(){return s`<nidoca-list-section theme="primary">Section A</nidoca-list-section>`}};it.styles=p`
  :host {
     display:block;
     padding-left: var(--space-2);  
     width:100%;
     box-sizing:border-box;
  `,r([i({type:u,converter:String})],it.prototype,"theme",2),r([i({type:String})],it.prototype,"text",2),it=r([c("nidoca-list-section")],it);var ht=class extends d{constructor(){super(...arguments);this.theme="surface";this.multiselect=!1}updated(t){super.updated(t),t.forEach((n,o)=>{o=="theme"&&this.getItems().forEach(l=>{l.theme=this.theme})})}render(){return s`
      <slot
        @nidoca-event-list-item-clicked="${t=>{if(!this.multiselect){this.unselectAll();let n=t.target;n.selected=!0}}}"
        id="slotElement"
      ></slot>
    `}getItems(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let o=0;o<n.length;o++){let l=n[o];l instanceof I&&t.push(l)}}return t}getSelectedItems(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let o=0;o<n.length;o++){let l=n[o];l instanceof I&&l.selected&&t.push(l)}}return t}getSelectedIndexes(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements(),o=0;for(let l=0;l<n.length;l++){let m=n[l];m instanceof I&&(m.selected&&t.push(o),o++)}}return t}selectAll(){this.getItems().forEach(t=>{t.selected=!0})}unselectAll(){this.getItems().forEach(t=>{t.selected=!1})}static example(){return s`<nidoca-list theme="primary">
      ${it.example()} ${I.example()} ${I.example()} ${I.example()}
    </nidoca-list>`}};ht.styles=p`
    :host {
      width: 100%;
    }
    #slotElement {
  ...
  `,r([i({type:u,converter:String})],ht.prototype,"theme",2),r([i({type:Boolean})],ht.prototype,"multiselect",2),r([g("#slotElement")],ht.prototype,"slotElement",2),ht=r([c("nidoca-list")],ht);var Dt=class extends d{constructor(){super(...arguments);this.theme="plain";this.prominent=!1}render(){return s`
      <style>
        * {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([i({type:String,converter:String})],Dt.prototype,"theme",2),r([i({type:Boolean})],Dt.prototype,"prominent",2),Dt=r([c("nidoca-top-app-bar")],Dt);var ut=class extends d{constructor(){super(...arguments);this.headers=["column 1","column 2"];this.rows=[["row 1",new G],["row 2",new G]];this.theme="plain"}render(){return s`
      <style>
        td,
        th {
      ...
      <div>
        <table>
          <thead>
            ${ae([this.headers],()=>s` ${Gt(this.headers,t=>s` <th colspan="1" rowspan="1">${t}</th> `)} `)}
          </thead>
          <tbody>
            ${ae([this.rows],()=>s`
                  ${Gt(this.rows,t=>s`
                        <tr>
                          ${Gt(t,n=>s` <td colspan="1" rowspan="1">${n}</td> `)}
                        </tr>
                      `)}
                `)}
          </tbody>
  ...
  `,r([i({type:Array})],ut.prototype,"headers",2),r([i({type:Array})],ut.prototype,"rows",2),r([i({type:u,converter:String})],ut.prototype,"theme",2),ut=r([c("nidoca-table")],ut);var ft=class extends d{constructor(){super(...arguments);this.selected=!1}render(){return this.selected?s` <slot></slot>`:s``}};ft.styles=p`
    :host,
    slot {
      display: block;
    }
  `,r([i({type:Boolean})],ft.prototype,"selected",2),ft=r([c("nidoca-tab-content")],ft);var X=class extends d{constructor(){super(...arguments);this.selected=!1;this.text="";this.theme="surface"}render(){return s`
      <style>
        .container {
    ...
    `}tabClicked(){console.log("tab clicked."),this.dispatchEvent(new CustomEvent("nidoca-event-tab-clicked",{detail:this,bubbles:!0,composed:!0}))}};X.styles=p`
    :host {
      display: block;
  ...
  `,r([i({type:Boolean})],X.prototype,"selected",2),r([i({type:String})],X.prototype,"text",2),r([i({type:String})],X.prototype,"theme",2),X=r([c("nidoca-tab")],X);var st=class extends d{constructor(){super(...arguments);this.theme="surface";this.tabIndex=0}render(){return s`
      <div class="container" @nidoca-event-tab-clicked="${t=>this.tabClicked(t)}">
        <slot id="tabSlot" name="tab"></slot>
        <slot id="tabContentSlot" name="tabContent"></slot>
      </div>
    `}firstUpdated(t){super.firstUpdated(t),this.tabIndexChanged()}update(t){super.update(t),t.get("tabIndex")!=null&&this.tabIndexChanged()}tabIndexChanged(){this.updateNidocaTabElements(),this.updateNidocaTabContentElemnts()}updateNidocaTabElements(){if(this.tabSlot!=null){let t=this.tabSlot.assignedElements(),o=100/t.length,l=t[this.tabIndex];for(let m=0;m<t.length;m++){let f=t[m];f instanceof X&&(f.theme=this.theme,f.style.width=String(o).concat("%"),f==l?(f.selected=!0,f.classList.add("SELECTED")):(f.selected=!1,f.classList.remove("SELECTED")))}}}updateNidocaTabContentElemnts(){let t=0;if(this.tabContentSlot!=null){let n=this.tabContentSlot.assignedElements();for(let o=0;o<n.length;o++){let l=n[o];l instanceof ft&&(this.tabIndex==t?l.selected=!0:l.selected=!1,t++)}}}tabClicked(t){let n=t.detail;this.changeTabIndex(n)}changeTabIndex(t){if(!t.selected&&this.tabSlot!=null){let n=this.tabSlot.assignedElements();for(let o=0;o<n.length;o++){let l=n[o];if(l instanceof X&&l==t){this.tabIndex=o;break}}}}static example(t=""){return s`
  ...
  `,r([g("#tabSlot")],st.prototype,"tabSlot",2),r([g("#tabContentSlot")],st.prototype,"tabContentSlot",2),r([i({type:String})],st.prototype,"theme",2),r([i({type:Number})],st.prototype,"tabIndex",2),st=r([c("nidoca-tabs")],st);var gt=class extends d{constructor(){super();this.hideLeft=!0;this.prominent=!1;document.getElementsByTagName("html")[0].setAttribute("oncontextmenu","return false"),this.addEventListener("click",t=>{if(!this.hideLeft&&this.leftElement){console.log("close");let n=this.leftElement.getBoundingClientRect();this.hideLeft=641>window.innerWidth&&0<=t.x-n.width}})}render(){return s`
      <slot
        id="left"
  ...
  `,r([i({type:Boolean})],gt.prototype,"hideLeft",2),r([i({type:Boolean})],gt.prototype,"prominent",2),r([g("#left")],gt.prototype,"leftElement",2),gt=r([c("nidoca-template")],gt);var xt=class extends d{firstUpdated(e){super.firstUpdated(e),navigator.mediaDevices.getUserMedia({video:!0,audio:!1}).then(t=>{this.videoElement&&(this.videoElement.srcObject=t)})}render(){return s`
      <video id="video" width="320" height="240" autoplay></video>
      <button id="click-photo" @click="${()=>this.makeFoto()}">Click Photo</button>
      <canvas id="canvas" width="320" height="240"></canvas>
    `}makeFoto(){if(this.canvasElement&&this.videoElement){let e=this.canvasElement.getContext("2d");if(e){e.drawImage(this.videoElement,0,0,this.canvasElement.width,this.canvasElement.height);let t=this.canvasElement.toDataURL("image/jpeg");console.log(t)}}}};xt.styles=p``,r([g("#video")],xt.prototype,"videoElement",2),r([g("#canvas")],xt.prototype,"canvasElement",2),r([g("#click-photo")],xt.prototype,"buttonElement",2),xt=r([c("nidoca-video")],xt);var jt=class extends d{constructor(){super(...arguments);this.src="";this.canvasElements=[];this.storeCanvasElements=[]}render(){return s`
      <img style="display: none;" id="img" src="${this.src}" />

      ${this.canvasElements.map(t=>s`${t}`)}
    `}updated(t){super.updated(t),t.forEach((n,o)=>{if(console.debug(`${this.tagName} : property ${String(o)} changed. oldValue: ${n}`),o=="src"){this.convert();let l=[["App-Symbol",512,512],["Vorstellungsgrafik",1024,500],["screenshoot_dummy",1920,1080]]}})}convert(){this.img&&(console.log("GO"),this.img.onload=()=>{[[12,12],[16,16],[22,22],[24,24],[32,32],[36,36],[48,48],[64,64],[72,72],[96,96],[128,128],[144,144],[192,192]].forEach(t=>{let n=document.createElement("canvas");n.width=t[0],n.height=t[1];let o=n.getContext("2d");o&&this.img&&(this.img.crossOrigin="anonymous",o.drawImage(this.img,0,0,t[0],t[1]),n.toBlob(l=>{},"image/webp")),this.canvasElements.push(n)}),this.requestUpdate()})}};jt.styles=p``,r([i({type:String})],jt.prototype,"src",2),r([g("#img")],jt.prototype,"img",2),jt=r([c("nidoca-svg-2-webp")],jt);var A=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return s`<style>
        slot {
          color: var(--app-color-text-${this.theme});
        }
      </style>
  ...
  `,r([i({type:u,converter:String})],A.prototype,"theme",2),r([i({type:String})],A.prototype,"text",2),A=r([c("nidoca-text")],A);var le=class extends A{render(){return s` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};le.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,le=r([c("nidoca-text-body")],le);var me=class extends A{render(){return s`${super.render()}`}};me.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,me=r([c("nidoca-text-button")],me);var ce=class extends A{};ce.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ce=r([c("nidoca-text-overline")],ce);var pe=class extends A{render(){return s` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};pe.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,pe=r([c("nidoca-text-subtitle")],pe);var C=class extends A{render(){return s`<style>
        slot {
  ...
  `,C=r([c("nidoca-text-caption")],C);var Ve=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-error-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ve=r([c("nidoca-text-error")],Ve);var qe=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-success-background);
        }
      </style>
      <slot>${this.text}</slot>`}};qe=r([c("nidoca-text-success")],qe);var Ge=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-warning-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ge=r([c("nidoca-text-warning")],Ge);var We=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-info-background);
        }
      </style>
      <slot>${this.text}</slot>`}};We=r([c("nidoca-text-info")],We);var de=class extends A{};de.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,de=r([c("nidoca-text-h1")],de);var he=class extends A{};he.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,he=r([c("nidoca-text-h2")],he);var ue=class extends A{};ue.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ue=r([c("nidoca-text-h3")],ue);var fe=class extends A{};fe.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,fe=r([c("nidoca-text-h4")],fe);var ge=class extends A{};ge.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ge=r([c("nidoca-text-h5")],ge);var xe=class extends A{};xe.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,xe=r([c("nidoca-text-h6")],xe);var $t=class extends W{constructor(){super(...arguments);this.message="Dies ist eine Testnachricht"}showToast(t=3e3){this.toastElement.classList.add("show"),setTimeout(()=>{this.hideToast()},t)}hideToast(){this.toastElement.classList.remove("show")}render(){return s`
  ...
  `,r([i({type:String})],$t.prototype,"message",2),r([g("#toast")],$t.prototype,"toastElement",2),$t=r([c("nidoca-toast")],$t);var F=class extends d{constructor(){super(...arguments);this.value="";this.placeholder="";this.disabled=!1;this.theme="plain"}render(){return s`
      <style>
        .container,
        input {
          color: var(--app-color-text-${this.theme});
    ...
    `}clearValue(){this.value=""}async valueChanged(){let t="nidoca-search-bar-event-value-changed",n=new CustomEvent(t,{detail:this.inputElement?.value,bubbles:!0,composed:!0});console.debug("dispatch custom event type: %s, detail: %s",n.type,JSON.stringify(n.detail)),this.dispatchEvent(n)}static example(t=""){return s`<nidoca-search-bar slot="${t}" theme="primary" placeholder="Suche..."></nidoca-search-bar>`}};F.styles=p`
    :host {
      width: 100%;
      display: block;
    }
  ...
  `,r([i({type:String})],F.prototype,"value",2),r([i({type:String})],F.prototype,"placeholder",2),r([i({type:Boolean})],F.prototype,"disabled",2),r([g("#inputElement")],F.prototype,"inputElement",2),r([i({type:u,converter:String})],F.prototype,"theme",2),F=r([c("nidoca-search-bar")],F);var ye=class{static{this.CENTER="CENTER"}static{this.LEFT="LEFT"}static{this.RIGHT="RIGHT"}static{this.TOP="TOP"}static{this.BOTTOM="BOTTOM"}static{this.SLIDE_CENTER="SLIDE_CENTER"}static{this.SLIDE_LEFT="SLIDE_LEFT"}static{this.SLIDE_RIGHT="SLIDE_RIGHT"}static{this.SLIDE_TOP="SLIDE_TOP"}static{this.SLIDE_BOTTOM="SLIDE_BOTTOM"}},Ct=class extends d{constructor(){super(...arguments);this.transitionType=ye.CENTER;this.duration=.5}render(){return s` <div class="${T(this.transitionType)}"><slot></slot></div> `}};Ct.styles=p`
  ...
  `,r([i({type:String})],Ct.prototype,"transitionType",2),r([i({type:Number})],Ct.prototype,"duration",2),Ct=r([c("nidoca-transition")],Ct);var Yt=class extends d{constructor(){super(...arguments);this.show=!1}render(){return this.show?s`
  ...
  `,r([i({type:Boolean})],Yt.prototype,"show",2),Yt=r([c("nidoca-dialog")],Yt);var _=class extends d{constructor(){super(...arguments);this.show=!1;this.title="Ja oder Nein ?";this.description="Entscheide dich";this.labelButtonYes="Ja";this.labelButtonNo="Nein"}render(){return s`<nidoca-dialog .show="${this.show}">
    ...
    </nidoca-dialog>`}};_.styles=p``,r([i({type:Boolean})],_.prototype,"show",2),r([i({type:String})],_.prototype,"title",2),r([i({type:String})],_.prototype,"description",2),r([i({type:String})],_.prototype,"labelButtonYes",2),r([i({type:String})],_.prototype,"labelButtonNo",2),_=r([c("nidoca-dialog-decision")],_);var Xt=class extends d{constructor(){super(...arguments);this.icon=""}render(){return s`
      <nidoca-icon-extended class="icon" icon="${this.icon}"></nidoca-icon-extended>
      <nidoca-card class="card">
        <slot></slot>
      </nidoca-card>
    `}static example(t="",n="surface"){return s`
  ...
  `,r([i({type:String})],Xt.prototype,"icon",2),Xt=r([c("nidoca-infobox")],Xt);var at=class extends d{constructor(){super(...arguments);this.theme="surface";this.src="";this.title="";this.subtitle=""}render(){return s`
            <div
  ...
  `,r([i({type:u,converter:String})],at.prototype,"theme",2),r([i({type:String})],at.prototype,"src",2),r([i({type:String})],at.prototype,"title",2),r([i({type:String})],at.prototype,"subtitle",2),at=r([c("nidoca-avatar")],at);var Zt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return s`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background-light);
          border-color: var(--app-color-${this.theme}-border);
  ...
  `,r([i({type:u,converter:String})],Zt.prototype,"theme",2),Zt=r([c("nidoca-card")],Zt);var be=class extends d{render(){return s`
      <nidoca-layout-spacer bottom="var(--space)" left="">
        <slot id="slotElement" @slotchange="${e=>this.slotChanged(e)}"></slot>
      </nidoca-layout-spacer>
    `}slotChanged(e){let t=e.target;if(t==null)return;let n=t.assignedElements();for(let o=0;o<n.length;o++){let m=n[o].classList;m.contains("flexItem")||m.add("flexItem"),m.contains("flexItemDevice")||m.add("flexItemDevice")}}};be.styles=p`
    slot,
    ::slotted(slot) {
      display: flex;
      flex-direction: row;
  ...
  `,be=r([c("nidoca-gallery")],be);var ve=class extends d{render(){return s`<slot></slot>`}print(){let e=window.open("");e&&(e.document.write(this.innerHTML),e.print(),e.close())}};ve.styles=p`
    :host {
      display: none;
    }
  `,ve=r([c("nidoca-print")],ve);var Ae=class extends d{render(){return s`
      <slot id="container" class="container" @slotchange="${e=>this.slotChanged(e)}"></slot>
    `}slotChanged(e){let n=e.target.assignedElements(),o=n.length;for(let l=0;l<o;l++){let f=n[l].classList,h="item_count_"+o;f.contains(h)||f.add(h)}}};Ae.styles=p`
    :host {
      display: block;
      margin: auto;
      width: 100%;
  ...
  `,Ae=r([c("nidoca-section")],Ae);var Jt=class extends d{constructor(){super(...arguments);this.cards=[]}render(){return s`
      <div class="container">
        ${this.cards.map(t=>s`
    ...
    `}clicked(t){this.dispatchEvent(new CustomEvent("nidoca-event-dashboard-card-clicked",{detail:{index:-1,card:t},bubbles:!0,composed:!0}))}};Jt.styles=p`
    :host {
      display: block;
    }
  ...
  `,r([i({type:Array})],Jt.prototype,"cards",2),Jt=r([c("nidoca-dashboard")],Jt);var Ft=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s`
      ${b.getStyle(this.theme)}
      <slot></slot>
    `}};Ft.styles=p`
    :host {
  ...
  `,r([i({type:u,converter:String})],Ft.prototype,"theme",2),Ft=r([c("nidoca-box")],Ft);var L=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Deine Nachricht";this.nameLabel="Dein Name";this.emailLabel="Deine Email";this.titleLabel="Betreff";this.messageLabel="Deine Nachricht";this.buttonLabel="Senden"}render(){return s`
      <nidoca-box theme="${T(this.theme)}">
  ...
  `,r([i({type:u,converter:String})],L.prototype,"theme",2),r([i({type:String,converter:String})],L.prototype,"label",2),r([i({type:String,converter:String})],L.prototype,"nameLabel",2),r([i({type:String,converter:String})],L.prototype,"emailLabel",2),r([i({type:String,converter:String})],L.prototype,"titleLabel",2),r([i({type:String,converter:String})],L.prototype,"messageLabel",2),r([i({type:String,converter:String})],L.prototype,"buttonLabel",2),r([g("#authenitcate-form")],L.prototype,"formComponent",2),L=r([c("nidoca-form-contact")],L);})();
