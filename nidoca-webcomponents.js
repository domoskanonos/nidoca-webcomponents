"use strict";(()=>{var Hr=Object.defineProperty;var Or=Object.getOwnPropertyDescriptor;var r=(a,e,t,n)=>{for(var i=n>1?void 0:n?Or(e,t):e,l=a.length-1,m;l>=0;l--)(m=a[l])&&(i=(n?m(e,t,i):m(i))||i);return n&&i&&Hr(e,t,i),i};var We=globalThis,be=We.trustedTypes,_e=be?be.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ue="$lit$",tt=`lit$${Math.random().toFixed(9).slice(2)}$`,Qe="?"+tt,Rr=`<${Qe}>`,bt=document,_t=()=>bt.createComment(""),Nt=a=>a===null||typeof a!="object"&&typeof a!="function",Ke=Array.isArray,ir=a=>Ke(a)||typeof a?.[Symbol.iterator]=="function",Ge=`[ 	
\f\r]`,Ft=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ne=/-->/g,tr=/>/g,xt=RegExp(`>|${Ge}(?:([^\\s"'>=/]+)(${Ge}*=${Ge}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),er=/'/g,rr=/"/g,or=/^(?:script|style|textarea|title)$/i,Ye=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),s=Ye(1),Kr=Ye(2),Yr=Ye(3),M=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),nr=new WeakMap,yt=bt.createTreeWalker(bt,129);function sr(a,e){if(!Ke(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return _e!==void 0?_e.createHTML(e):e}var ar=(a,e)=>{let t=a.length-1,n=[],i,l=e===2?"<svg>":e===3?"<math>":"",m=Ft;for(let f=0;f<t;f++){let h=a[f],v,E,x=-1,w=0;for(;w<h.length&&(m.lastIndex=w,E=m.exec(h),E!==null);)w=m.lastIndex,m===Ft?E[1]==="!--"?m=Ne:E[1]!==void 0?m=tr:E[2]!==void 0?(or.test(E[2])&&(i=RegExp("</"+E[2],"g")),m=xt):E[3]!==void 0&&(m=xt):m===xt?E[0]===">"?(m=i??Ft,x=-1):E[1]===void 0?x=-2:(x=m.lastIndex-E[2].length,v=E[1],m=E[3]===void 0?xt:E[3]==='"'?rr:er):m===rr||m===er?m=xt:m===Ne||m===tr?m=Ft:(m=xt,i=void 0);let y=m===xt&&a[f+1].startsWith("/>")?" ":"";l+=m===Ft?h+Rr:x>=0?(n.push(v),h.slice(0,x)+Ue+h.slice(x)+tt+y):h+tt+(x===-2?f:y)}return[sr(a,l+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},te=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let l=0,m=0,f=e.length-1,h=this.parts,[v,E]=ar(e,t);if(this.el=a.createElement(v,n),yt.currentNode=this.el.content,t===2||t===3){let x=this.el.content.firstChild;x.replaceWith(...x.childNodes)}for(;(i=yt.nextNode())!==null&&h.length<f;){if(i.nodeType===1){if(i.hasAttributes())for(let x of i.getAttributeNames())if(x.endsWith(Ue)){let w=E[m++],y=i.getAttribute(x).split(tt),O=/([.?@])?(.*)/.exec(w);h.push({type:1,index:l,name:O[2],strings:y,ctor:O[1]==="."?Ae:O[1]==="?"?ke:O[1]==="@"?we:At}),i.removeAttribute(x)}else x.startsWith(tt)&&(h.push({type:6,index:l}),i.removeAttribute(x));if(or.test(i.tagName)){let x=i.textContent.split(tt),w=x.length-1;if(w>0){i.textContent=be?be.emptyScript:"";for(let y=0;y<w;y++)i.append(x[y],_t()),yt.nextNode(),h.push({type:2,index:++l});i.append(x[w],_t())}}}else if(i.nodeType===8)if(i.data===Qe)h.push({type:2,index:l});else{let x=-1;for(;(x=i.data.indexOf(tt,x+1))!==-1;)h.push({type:7,index:l}),x+=tt.length-1}l++}}static createElement(e,t){let n=bt.createElement("template");return n.innerHTML=e,n}};function vt(a,e,t=a,n){if(e===M)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,l=Nt(e)?void 0:e._$litDirective$;return i?.constructor!==l&&(i?._$AO?.(!1),l===void 0?i=void 0:(i=new l(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=vt(a,i._$AS(a,e.values),i,n)),e}var ve=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??bt).importNode(t,!0);yt.currentNode=i;let l=yt.nextNode(),m=0,f=0,h=n[0];for(;h!==void 0;){if(m===h.index){let v;h.type===2?v=new Ct(l,l.nextSibling,this,e):h.type===1?v=new h.ctor(l,h.name,h.strings,this,e):h.type===6&&(v=new Ee(l,this,e)),this._$AV.push(v),h=n[++f]}m!==h?.index&&(l=yt.nextNode(),m++)}return yt.currentNode=bt,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Ct=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=S,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=vt(this,e,t),Nt(e)?e===S||e==null||e===""?(this._$AH!==S&&this._$AR(),this._$AH=S):e!==this._$AH&&e!==M&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ir(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==S&&Nt(this._$AH)?this._$AA.nextSibling.data=e:this.T(bt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=te.createElement(sr(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let l=new ve(i,this),m=l.u(this.options);l.p(t),this.T(m),this._$AH=l}}_$AC(e){let t=nr.get(e.strings);return t===void 0&&nr.set(e.strings,t=new te(e)),t}k(e){Ke(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let l of e)i===t.length?t.push(n=new a(this.O(_t()),this.O(_t()),this,this.options)):n=t[i],n._$AI(l),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},At=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,l){this.type=1,this._$AH=S,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=l,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=S}_$AI(e,t=this,n,i){let l=this.strings,m=!1;if(l===void 0)e=vt(this,e,t,0),m=!Nt(e)||e!==this._$AH&&e!==M,m&&(this._$AH=e);else{let f=e,h,v;for(e=l[0],h=0;h<l.length-1;h++)v=vt(this,f[n+h],t,h),v===M&&(v=this._$AH[h]),m||=!Nt(v)||v!==this._$AH[h],v===S?e=S:e!==S&&(e+=(v??"")+l[h+1]),this._$AH[h]=v}m&&!i&&this.j(e)}j(e){e===S?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ae=class extends At{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===S?void 0:e}},ke=class extends At{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==S)}},we=class extends At{constructor(e,t,n,i,l){super(e,t,n,i,l),this.type=5}_$AI(e,t=this){if((e=vt(this,e,t,0)??S)===M)return;let n=this._$AH,i=e===S&&n!==S||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,l=e!==S&&(n===S||i);i&&this.element.removeEventListener(this.name,this,n),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ee=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){vt(this,e)}},lr={M:Ue,P:tt,A:Qe,C:1,L:ar,R:ve,D:ir,V:vt,I:Ct,H:At,N:ke,U:we,B:Ae,F:Ee},Ir=We.litHtmlPolyfillSupport;Ir?.(te,Ct),(We.litHtmlVersions??=[]).push("3.2.1");var mr=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let l=t?.renderBefore??null;n._$litPart$=i=new Ct(e.insertBefore(_t(),l),l,void 0,t??{})}return i._$AI(a),i};var c=a=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(a,e)}):customElements.define(a,e)};var Se=globalThis,Te=Se.ShadowRoot&&(Se.ShadyCSS===void 0||Se.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Xe=Symbol(),cr=new WeakMap,ee=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Te&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=cr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&cr.set(t,e))}return e}toString(){return this.cssText}},pr=a=>new ee(typeof a=="string"?a:a+"",void 0,Xe),p=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,l)=>n+(m=>{if(m._$cssResult$===!0)return m.cssText;if(typeof m=="number")return m;throw Error("Value passed to 'css' function must be a 'css' function result: "+m+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[l+1],a[0]);return new ee(t,a,Xe)},Ze=(a,e)=>{if(Te)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=Se.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},He=Te?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return pr(t)})(a):a;var{is:Pr,defineProperty:Br,getOwnPropertyDescriptor:Dr,getOwnPropertyNames:zr,getOwnPropertySymbols:jr,getPrototypeOf:$r}=Object,Oe=globalThis,dr=Oe.trustedTypes,Cr=dr?dr.emptyScript:"",Lr=Oe.reactiveElementPolyfillSupport,re=(a,e)=>a,ne={toAttribute(a,e){switch(e){case Boolean:a=a?Cr:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Re=(a,e)=>!Pr(a,e),hr={attribute:!0,type:String,converter:ne,reflect:!1,hasChanged:Re};Symbol.metadata??=Symbol("metadata"),Oe.litPropertyMetadata??=new WeakMap;var et=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=hr){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&Br(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:l}=Dr(this.prototype,e)??{get(){return this[t]},set(m){this[t]=m}};return{get(){return i?.call(this)},set(m){let f=i?.call(this);l.call(this,m),this.requestUpdate(e,f,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??hr}static _$Ei(){if(this.hasOwnProperty(re("elementProperties")))return;let e=$r(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(re("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(re("properties"))){let t=this.properties,n=[...zr(t),...jr(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(He(i))}else e!==void 0&&t.push(He(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ze(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$EC(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let l=(n.converter?.toAttribute!==void 0?n.converter:ne).toAttribute(t,n.type);this._$Em=e,l==null?this.removeAttribute(i):this.setAttribute(i,l),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let l=n.getPropertyOptions(i),m=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:ne;this._$Em=i,this[i]=m.fromAttribute(t,l.type),this._$Em=null}}requestUpdate(e,t,n){if(e!==void 0){if(n??=this.constructor.getPropertyOptions(e),!(n.hasChanged??Re)(this[e],t))return;this.P(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,t,n){this._$AL.has(e)||this._$AL.set(e,t),n.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,l]of this._$Ep)this[i]=l;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,l]of n)l.wrapped!==!0||this._$AL.has(i)||this[i]===void 0||this.P(i,this[i],l)}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EU()}catch(n){throw e=!1,this._$EU(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(t=>this._$EC(t,this[t])),this._$EU()}updated(e){}firstUpdated(e){}};et.elementStyles=[],et.shadowRootOptions={mode:"open"},et[re("elementProperties")]=new Map,et[re("finalized")]=new Map,Lr?.({ReactiveElement:et}),(Oe.reactiveElementVersions??=[]).push("2.0.4");var Mr={attribute:!0,type:String,converter:ne,reflect:!1,hasChanged:Re},Vr=(a=Mr,e,t)=>{let{kind:n,metadata:i}=t,l=globalThis.litPropertyMetadata.get(i);if(l===void 0&&globalThis.litPropertyMetadata.set(i,l=new Map),l.set(t.name,a),n==="accessor"){let{name:m}=t;return{set(f){let h=e.get.call(this);e.set.call(this,f),this.requestUpdate(m,h,a)},init(f){return f!==void 0&&this.P(m,void 0,a),f}}}if(n==="setter"){let{name:m}=t;return function(f){let h=this[m];e.call(this,f),this.requestUpdate(m,h,a)}}throw Error("Unsupported decorator location: "+n)};function o(a){return(e,t)=>typeof t=="object"?Vr(a,e,t):((n,i,l)=>{let m=i.hasOwnProperty(l);return i.constructor.createProperty(l,m?{...n,wrapped:!0}:n),m?Object.getOwnPropertyDescriptor(i,l):void 0})(a,e,t)}function Ie(a){return o({...a,state:!0,attribute:!1})}var kt=(a,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,t),t);function g(a,e){return(t,n,i)=>{let l=m=>m.renderRoot?.querySelector(a)??null;if(e){let{get:m,set:f}=typeof n=="object"?t:i??(()=>{let h=Symbol();return{get(){return this[h]},set(v){this[h]=v}}})();return kt(t,n,{get(){let h=m.call(this);return h===void 0&&(h=l(this),(h!==null||this.hasUpdated)&&f.call(this,h)),h}})}return kt(t,n,{get(){return l(this)}})}}var X=class extends et{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=mr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};X._$litElement$=!0,X.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:X});var qr=globalThis.litElementPolyfillSupport;qr?.({LitElement:X});(globalThis.litElementVersions??=[]).push("4.1.1");var d=class extends X{};var u=(i=>(i.primary="primary",i.secondary="secondary",i.surface="surface",i.plain="plain",i))(u||{}),b=class{static getStyle(e){return e?e=="plain"?s``:s` <style>
            :host,
            *,
            ::slotted(*) {
          ...
          </style>`:s``}static getOposite(e){return e=="plain"?"surface":e=="primary"||e=="primary"?"secondary":e=="secondary"?"primary":"plain"}getParentTheme(e){let t=e;for(;t!=null;){if(t.theme!=null)return t.theme;t=t.parentElement}}};var Pe=class{static generateImageBase64(e,t,n){let i=document.createElement("canvas");i.width=128,i.height=128;let l=i.getContext("2d");if(!l)throw new Error("Canvas context is not available");l.fillStyle=n,l.fillRect(0,0,i.width,i.height),l.fillStyle=t;let m=document.body,h=getComputedStyle(m).getPropertyValue("--font-family")||"Arial";l.font=`bold 64px ${h}`,l.textAlign="center",l.textBaseline="alphabetic";let v=e.charAt(0).toUpperCase(),E=l.measureText(v),x=E.actualBoundingBoxAscent-E.actualBoundingBoxDescent;return l.fillText(v,i.width/2,i.height/2+x/2),i.toDataURL("image/png")}};var at=class extends d{constructor(){super(...arguments);this.theme="surface";this.textFields=[];this.groupByField="";this.imgSrcField="";this.rightIcon="";this.data=[]}render(){if(!this.data.length)return s`<p>Loading data...</p>`;if(!this.groupByField||this.groupByField==="")return s`
            <nidoca-list theme="${this.theme}">
              ${this.data.map(t=>this.renderListItem(t))}
            </nidoca-list>
          `;{let t=this.data.reduce((n,i)=>{let l=i[this.groupByField]||"UNBEKANNT";return n[l]||(n[l]=[]),n[l].push(i),n},{});return s`
            ${Object.keys(t).map(n=>{let i=t[n];return s`
  ...
  `,r([o({type:u,converter:String})],W.prototype,"theme",2),r([o({type:String})],W.prototype,"header",2),r([o({type:Boolean})],W.prototype,"opened",2),W=r([c("nidoca-accordion-item")],W);var H=class extends d{constructor(){super(...arguments);this.theme="plain";this.overline="";this.title="";this.summary="";this.text=""}render(){return s`
  ...
  `,r([o({type:u,converter:String})],H.prototype,"theme",2),r([o({type:String})],H.prototype,"overline",2),r([o({type:String})],H.prototype,"title",2),r([o({type:String})],H.prototype,"summary",2),r([o({type:String})],H.prototype,"text",2),H=r([c("nidoca-article")],H);var xr=(t=>(t.single="single",t.multi="multi",t))(xr||{}),lt=class extends d{constructor(){super(...arguments);this.theme="plain";this.accordionType="single"}updated(t){super.updated(t),t.forEach((n,i)=>{if(i=="theme"&&this.accordionSlot!=null){let l=this.accordionSlot.assignedElements();for(let m=0;m<l.length;m++){let f=l[m];f instanceof W&&(f.theme=this.theme)}}})}render(){return s`
      ${b.getStyle(this.theme)}
      <slot
        @nidoca-event-accordion-item-clicked="${t=>this.accordionSwitched(t)}"
        id="accordionSlot"
      ></slot>
    `}accordionSwitched(t){let n=t.detail;switch(this.accordionType){case"single":if(this.accordionSlot!=null){let i=this.accordionSlot.assignedElements();for(let l=0;l<i.length;l++){let m=i[l];m instanceof W&&m!=n&&(m.opened=!1)}}break;case"multi":break}t.stopPropagation()}static example(t=""){return s`<nidoca-accordion slot="${t}" theme="plain">
  ...
  `,r([o({type:u,converter:String})],lt.prototype,"theme",2),r([o({type:xr,converter:String})],lt.prototype,"accordionType",2),r([g("#accordionSlot")],lt.prototype,"accordionSlot",2),lt=r([c("nidoca-accordion")],lt);var yr=(i=>(i.none="none",i.shadow_1="shadow_1",i.shadow_2="shadow_2",i.shadow_3="shadow_3",i))(yr||{}),U=class extends d{constructor(){super(...arguments);this.theme="primary";this.shadowType="shadow_1";this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return s`
      <style>
        .iconExtended {
  ...
  `,r([o({type:String})],U.prototype,"theme",2),r([o({type:Object})],U.prototype,"shadowType",2),r([o({type:String})],U.prototype,"icon",2),r([o({type:Boolean})],U.prototype,"clickable",2),r([o({type:Boolean})],U.prototype,"deactivated",2),r([o({type:String})],U.prototype,"title",2),U=r([c("nidoca-icon-extended")],U);var br=(i=>(i[i.current=0]="current",i[i.completed=1]="completed",i[i.open=2]="open",i[i.finish=3]="finish",i))(br||{}),V=class extends d{constructor(){super(...arguments);this.icon="";this.primaryText="";this.isLast=!1;this.first=!1}render(){return s`
      <div
  ...
  `,r([o({type:String})],V.prototype,"icon",2),r([o({type:String})],V.prototype,"primaryText",2),r([o({type:Number})],V.prototype,"state",2),r([o({type:Boolean})],V.prototype,"isLast",2),V=r([c("nidoca-wizard-step")],V);var Lt=class extends d{render(){return s`
      <div
    ...
    `}slotChanged(e){let t=e.target;if(t==null)return;let n=t.assignedElements(),i=0;for(let l=0;l<n.length;l++){let m=n[l];m instanceof V&&(m.index=l,m.state==0&&(i=l),m.index==n.length-1&&(m.isLast=!0))}this.changeState(i)}stepClicked(e){let t=e.detail;console.debug("wizard step clicked, selectedStepIndex: %s",t),this.changeState(t)}changeState(e){if(this.wizardSlot){let t=this.wizardSlot.assignedElements();for(let n=0;n<t.length;n++){let i=t[n];i instanceof V&&i.index!==void 0&&(i.index<e?i.state=1:i.index==e?i.state=0:i.state=2)}}}};Lt.styles=p``,r([g("#wizardSlot")],Lt.prototype,"wizardSlot",2),Lt=r([c("nidoca-wizard")],Lt);var mt=class extends d{constructor(){super(...arguments);this.clickable=!0;this.theme="surface";this.text=""}render(){return s`
      <style>
        .chip:hover {
    ...
    `}static example(t=""){return s`<nidoca-chip slot="${t}" clickable text="Mein Chip"></nidoca-chip>`}};mt.styles=p`
    .chip {
      display: inline-block;
      padding: var(--space-2);
      border-radius: 1rem;
  ...
  `,r([o({type:Boolean})],mt.prototype,"clickable",2),r([o({type:u,converter:String})],mt.prototype,"theme",2),r([o({type:String})],mt.prototype,"text",2),mt=r([c("nidoca-chip")],mt);var wt=class extends d{constructor(){super(...arguments);this.code="";this.theme="plain"}render(){return s`
      <style>
        code {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
    ...
    `}static example(t=""){return s`<nidoca-code slot="${t}" theme="surface"> my code </nidoca-code>`}};wt.styles=p`
    :host {
      display: block;
    }
    pre {
  ...
  `,r([o({type:String})],wt.prototype,"code",2),r([o({type:String})],wt.prototype,"theme",2),wt=r([c("nidoca-code")],wt);var Be=class{static{this.PROGRESS="PROGRESS"}static{this.PROGRESS_CIRCULAR="PROGRESS_CIRCULAR"}},Et=class extends d{constructor(){super(...arguments);this.progressType=Be.PROGRESS}render(){return s` <style>
        :host {
          width: 100%;
          display: block;
        }
      ...
      <progress class="${this.progressType}"></progress>`}};Et.styles=p``,r([o({type:u,converter:String})],Et.prototype,"theme",2),r([o({type:Be,converter:String})],Et.prototype,"progressType",2),Et=r([c("nidoca-progress")],Et);var De=(n=>(n.contained="contained",n.outlined="outlined",n.text="text",n))(De||{}),rt=class extends d{constructor(){super(...arguments);this.theme="primary";this.buttonType="contained";this.icon="";this.text=""}render(){return s`
      <style>
        .outlined {
          color: var(--app-color-${this.theme}-background);
  ...
  `,r([o({type:Boolean})],St.prototype,"autocomplete",2),r([g("#slotElement")],St.prototype,"slotElement",2),St=r([c("nidoca-form")],St);var kr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ze=a=>(...e)=>({_$litDirective$:a,values:e}),Mt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:Gr}=lr;var wr=()=>document.createComment(""),Vt=(a,e,t)=>{let n=a._$AA.parentNode,i=e===void 0?a._$AB:e._$AA;if(t===void 0){let l=n.insertBefore(wr(),i),m=n.insertBefore(wr(),i);t=new Gr(l,m,a,a.options)}else{let l=t._$AB.nextSibling,m=t._$AM,f=m!==a;if(f){let h;t._$AQ?.(a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==m._$AU&&t._$AP(h)}if(l!==i||f){let h=t._$AA;for(;h!==l;){let v=h.nextSibling;n.insertBefore(h,i),h=v}}}return t},ct=(a,e,t=a)=>(a._$AI(e,t),a),Wr={},Er=(a,e=Wr)=>a._$AH=e,Sr=a=>a._$AH,je=a=>{a._$AP?.(!1,!0);let e=a._$AA,t=a._$AB.nextSibling;for(;e!==t;){let n=e.nextSibling;e.remove(),e=n}};var Tr=(a,e,t)=>{let n=new Map;for(let i=e;i<=t;i++)n.set(a[i],i);return n},qt=ze(class extends Mt{constructor(a){if(super(a),a.type!==kr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let n;t===void 0?t=e:e!==void 0&&(n=e);let i=[],l=[],m=0;for(let f of a)i[m]=n?n(f,m):m,l[m]=t(f,m),m++;return{values:l,keys:i}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,n]){let i=Sr(a),{values:l,keys:m}=this.dt(e,t,n);if(!Array.isArray(i))return this.ut=m,l;let f=this.ut??=[],h=[],v,E,x=0,w=i.length-1,y=0,O=l.length-1;for(;x<=w&&y<=O;)if(i[x]===null)x++;else if(i[w]===null)w--;else if(f[x]===m[y])h[y]=ct(i[x],l[y]),x++,y++;else if(f[w]===m[O])h[O]=ct(i[w],l[O]),w--,O--;else if(f[x]===m[O])h[O]=ct(i[x],l[O]),Vt(a,h[O+1],i[x]),x++,O--;else if(f[w]===m[y])h[y]=ct(i[w],l[y]),Vt(a,i[x],i[w]),w--,y++;else if(v===void 0&&(v=Tr(m,y,O),E=Tr(f,x,w)),v.has(f[x]))if(v.has(f[w])){let N=E.get(m[y]),qe=N!==void 0?i[N]:null;if(qe===null){let Fe=Vt(a,i[x]);ct(Fe,l[y]),h[y]=Fe}else h[y]=ct(qe,l[y]),Vt(a,i[x],qe),i[N]=null;y++}else je(i[w]),w--;else je(i[x]),x++;for(;y<=O;){let N=Vt(a,h[O+1]);ct(N,l[y]),h[y++]=N}for(;x<=w;){let N=i[x++];N!==null&&je(N)}return this.ut=m,Er(a,h),M}});var Ur={},ie=ze(class extends Mt{constructor(){super(...arguments),this.ot=Ur}render(a,e){return e()}update(a,[e,t]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((n,i)=>n===this.ot[i]))return M}else if(this.ot===e)return M;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,t)}});var R=class extends z{constructor(){super(...arguments);this.theme="surface";this.trailingIcon="";this.label="";this.errorText="";this.infoText="";this.warningText="";this.value="";this.options=[];this.name="";this.required=!0;this.multiple=!1;this.size=1}render(){return s` <style>
        .parentContainer,
        ...
        <div class="container">
          ...
          >
            ${ie([this.value,this.options],()=>s`
                ${qt(this.options,t=>t==null?s` <option></option>`:this.isSelectedOption(t)?s` <option value="${t.key}" selected>${t.value}</option> `:s` <option value="${t.key}">${t.value}</option> `)}
              `)}
          </select>
        </div>
      </div>
      ${this.infoText||this.warningText||this.errorText?s`
          ...
          `:s``}`}getOutputData(){let t=this.value;if(this.selectElement!=null&&this.multiple){t=[];for(let n=0,i=this.selectElement.options.length;n<i;n++)this.selectElement.options[n].selected&&t.push(this.options[n].key)}else this.selectElement!=null&&(this.selectElement.value.length==0?t=null:t=this.selectElement.value);return{key:this.name,value:t}}validate(){return this.errorText="",this.selectElement!=null&&!this.selectElement.validity.valid&&this.selectElement.validationMessage!=this.errorText&&(this.errorText=this.selectElement.validationMessage),this.errorText.length==0}isSelectedOption(t){if(this.multiple){let n=!1;for(let i of this.value)if(n=t.key===i,n)return!0}return this.value===t.key}static enumToOptions(t,n=!0){let i=[];return n&&i.push({key:"",value:""}),Object.keys(t).forEach(l=>{i.push({key:l,value:t[l]})}),i}static stringArrayToOptions(t,n=!0){let i=[];return n&&i.push({key:"",value:""}),t.forEach(l=>{i.push({key:l,value:l})}),i}static toComboboxOptions(t=null,n=null){if(t==null)return[];let i=[];return Object.values(t).forEach(l=>{let m=String(Object.keys(t)[Object.values(t).indexOf(l)]);n&&(m=m.concat(n)),i.push({key:l,value:m})}),i}};R.styles=p`
    :host,
    slot {
      display: block;
      width: 100%;
  ...
  `,r([o({type:u,converter:String})],R.prototype,"theme",2),r([o({type:String})],R.prototype,"trailingIcon",2),r([o({type:String})],R.prototype,"label",2),r([o({type:String})],R.prototype,"errorText",2),r([o({type:String})],R.prototype,"infoText",2),r([o({type:String})],R.prototype,"warningText",2),r([o()],R.prototype,"value",2),r([o({type:Array})],R.prototype,"options",2),r([o({type:String})],R.prototype,"name",2),r([o({type:Boolean})],R.prototype,"required",2),r([o({type:Boolean})],R.prototype,"multiple",2),r([o({type:Number})],R.prototype,"size",2),r([g("#selectElement")],R.prototype,"selectElement",2),R=r([c("nidoca-form-combobox")],R);var T=a=>a??S;var nt=(y=>(y.color="color",y.email="email",y.hidden="hidden",y.number="number",y.password="password",y.tel="tel",y.text="text",y.search="search",y.url="url",y.date="date",y.month="month",y.time="time",y.week="week",y))(nt||{}),k=class extends z{constructor(){super(...arguments);this.type="text";this.label="";this.placeholder="";this.trailingIcon="";this.errorText="";this.infoText="";this.warningText="";this.name="";this.value="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="surface"}render(){return this.type=="hidden"?s`<input id="inputElement" name="${this.name}" type="${this.type}" value="${this.value}" />`:s` <style>
            .parentContainer,
            ::slotted(.parentContainer) {
              color: var(--app-color-text-${this.theme});
              background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([o({type:nt,converter:String})],k.prototype,"type",2),r([o({type:String})],k.prototype,"label",2),r([o({type:String})],k.prototype,"placeholder",2),r([o({type:String})],k.prototype,"trailingIcon",2),r([o({type:String})],k.prototype,"errorText",2),r([o({type:String})],k.prototype,"infoText",2),r([o({type:String})],k.prototype,"warningText",2),r([o({type:String})],k.prototype,"name",2),r([o()],k.prototype,"value",2),r([o({type:Boolean})],k.prototype,"required",2),r([o({type:Boolean})],k.prototype,"disabled",2),r([o({type:Boolean})],k.prototype,"checked",2),r([o({type:Number})],k.prototype,"maxlength",2),r([o({type:Number})],k.prototype,"minlength",2),r([o({type:Number})],k.prototype,"min",2),r([o({type:Number})],k.prototype,"max",2),r([o({type:String})],k.prototype,"step",2),r([o({type:Number})],k.prototype,"size",2),r([o({type:String})],k.prototype,"pattern",2),r([g("#inputElement")],k.prototype,"inputElement",2),r([o({type:u,converter:String})],k.prototype,"theme",2),k=r([c("nidoca-form-text")],k);var $e=class extends k{constructor(){super(),this.type="date"}};$e=r([c("nidoca-form-date")],$e);var P=class extends z{constructor(){super(...arguments);this.theme="surface";this.infoText="";this.warningText="";this.errorText="";this.name="";this.value="";this.label="";this.required=!1;this.placeholder="";this.disabled=!1;this.rows=5}render(){return s` <style>
        .parentContainer,
        ::slotted(.parentContainer) {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
...
${this.value}</textarea
  ...
  `,r([o({type:u,converter:String})],P.prototype,"theme",2),r([o({type:String})],P.prototype,"infoText",2),r([o({type:String})],P.prototype,"warningText",2),r([o({type:String})],P.prototype,"errorText",2),r([o({type:String})],P.prototype,"name",2),r([o()],P.prototype,"value",2),r([o({type:String})],P.prototype,"label",2),r([o({type:Boolean})],P.prototype,"required",2),r([o({type:String})],P.prototype,"placeholder",2),r([o({type:Boolean})],P.prototype,"disabled",2),r([o({type:Number})],P.prototype,"rows",2),r([g("#inputElement")],P.prototype,"inputElement",2),P=r([c("nidoca-form-textarea")],P);var Tt=class extends z{constructor(){super(...arguments);this.theme="primary"}validate(){throw new Error("Method not implemented.")}getOutputData(){throw new Error("Method not implemented.")}render(){return s`
  ...
  `,r([o({type:u,converter:String})],Tt.prototype,"theme",2),r([g("#inputElement")],Tt.prototype,"inputElement",2),Tt=r([c("nidoca-form-upload")],Tt);var D=class extends z{constructor(){super();this.name="";this.label="";this.infoText="";this.errorText="";this.warningText="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="primary";this.theme=b.prototype.getParentTheme(this)||"plain"}render(){return s`
      <style>
        .slider {
    ...
    `}getOutputData(){return{key:this.name,value:this.checked}}validate(){return this.errorText="",this.inputElement!=null&&!this.inputElement.validity.valid&&this.inputElement.validationMessage!=this.errorText&&(this.errorText=this.inputElement.validationMessage),this.errorText==""}};D.styles=p`
    :host {
      display: flex;
      flex-direction: column;
      width: 100%;
  ...
  `,r([o({type:String})],D.prototype,"name",2),r([o({type:String})],D.prototype,"label",2),r([o({type:String})],D.prototype,"infoText",2),r([o({type:String})],D.prototype,"errorText",2),r([o({type:String})],D.prototype,"warningText",2),r([o({type:Boolean})],D.prototype,"required",2),r([o({type:Boolean})],D.prototype,"disabled",2),r([o({type:Boolean})],D.prototype,"checked",2),r([o({type:String})],D.prototype,"theme",2),r([g("#inputElement")],D.prototype,"inputElement",2),D=r([c("nidoca-form-switch")],D);var Z=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Newsletter";this.emailLabel="Deine Emailadresse";this.buttonLabel="Registrieren"}render(){return s`
      <nidoca-box theme="${T(this.theme)}">
        <nidoca-form id="form">
  ...
  `,r([o({type:u,converter:String})],Z.prototype,"theme",2),r([o({type:String,converter:String})],Z.prototype,"label",2),r([o({type:String,converter:String})],Z.prototype,"emailLabel",2),r([o({type:String,converter:String})],Z.prototype,"buttonLabel",2),r([g("#form")],Z.prototype,"formComponent",2),Z=r([c("nidoca-form-newsletter")],Z);var J=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Passwort zur\xFCcksetzen";this.emailLabel="Deine Emailadresse";this.buttonLabel="Zur\xFCcksetzen"}render(){return s`
  ...
  `,r([o({type:u,converter:String})],B.prototype,"theme",2),r([o({type:String,converter:String})],B.prototype,"label",2),r([o({type:String,converter:String})],B.prototype,"oldPasswordLabel",2),r([o({type:String,converter:String})],B.prototype,"newPasswordLabel",2),r([o({type:String,converter:String})],B.prototype,"repeatNewPasswordLabel",2),r([o({type:String,converter:String})],B.prototype,"buttonLabel",2),r([g("#form")],B.prototype,"formComponent",2),r([g("#oldPassword")],B.prototype,"oldPasswordInputField",2),r([g("#newPassword")],B.prototype,"newPasswordInputField",2),r([g("#repeatNewPassword")],B.prototype,"repeatNewPasswordInputField",2),r([o()],B.prototype,"errorMessageSamePasswordLabel",2),r([o()],B.prototype,"errorMessagePasswordDiffLabel",2),B=r([c("nidoca-form-change-password")],B);var Q=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Registrieren";this.emailLabel="Email";this.passwordLabel="Passwort";this.buttonLabel="Registrieren"}render(){return s`
      <nidoca-box theme="${T(this.theme)}">
        <nidoca-form id="form">
          <nidoca-text-h2 class="paddingBottom">${this.label}</nidoca-text-h2>
  ...
  `,r([o({type:u,converter:String})],Q.prototype,"theme",2),r([o({type:String,converter:String})],Q.prototype,"label",2),r([o({type:String,converter:String})],Q.prototype,"emailLabel",2),r([o({type:String,converter:String})],Q.prototype,"passwordLabel",2),r([o({type:String,converter:String})],Q.prototype,"buttonLabel",2),r([g("#form")],Q.prototype,"formComponent",2),Q=r([c("nidoca-form-register")],Q);var Gt=class extends d{constructor(){super(...arguments);this.code=""}render(){return s``}};Gt.styles=p``,r([o({type:String})],Gt.prototype,"code",2),Gt=r([c("nidoca-upload")],Gt);var Ht=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return s`
      <style>
        .hr {
          border-color: var(--app-color-${this.theme}-border);
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([o({type:u,converter:String})],Ht.prototype,"theme",2),r([o({type:String,converter:String})],Ht.prototype,"text",2),Ht=r([c("nidoca-hr")],Ht);var Ot=class extends d{constructor(){super(...arguments);this.text="";this.icon=""}render(){return s`
      <div class="container">
        ${this.icon?s` <nidoca-icon
              slot="graphic"
              icon="${this.icon}"
    ...
    `}static example(t=""){return s`<nidoca-menu-area slot="${t}" icon="gavel" text="Rechtliches"></nidoca-menu-area>`}};Ot.styles=p`
    .container {
      display: flex;
      padding-left: var(--space-2);
      padding-right: var(--space-2);
  ...
  `,r([o({type:String})],Ot.prototype,"text",2),r([o({type:String})],Ot.prototype,"icon",2),Ot=r([c("nidoca-menu-area")],Ot);var q=class extends d{constructor(){super(...arguments);this.text="";this.icon="";this.selected=!1;this.theme="surface"}render(){return s`
      <style>
        .container:hover {
          background-color: var(--app-color-${this.theme}-hover);
        }
  ...
  `,r([o({type:String})],q.prototype,"text",2),r([o({type:String})],q.prototype,"icon",2),r([o({type:Boolean})],q.prototype,"selected",2),r([o({type:String})],q.prototype,"theme",2),q=r([c("nidoca-menu-item")],q);var Rt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s` <style>
        :host,
        *,
        ::slotted(*) {
          color: var(--app-color-text-${this.theme});
      ...
      <slot id="slotElement"></slot>`}updated(t){super.updated(t),t.forEach((n,i)=>{if(i=="theme"&&this.slotElement!=null){let l=this.slotElement.assignedElements();for(let m=0;m<l.length;m++){let f=l[m];f instanceof q&&(f.theme=this.theme)}}})}firstUpdated(){this.addEventListener("click",t=>{if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];if(l instanceof q){let m=l.getBoundingClientRect();m.left<t.x&&m.right>t.x&&(m.top<t.y&&m.bottom>t.y?l.selected=!0:l.selected=!1)}}}})}static example(t=""){return s`
  ...
  `,r([o({type:String})],Rt.prototype,"theme",2),r([g("#slotElement")],Rt.prototype,"slotElement",2),Rt=r([c("nidoca-menu")],Rt);var K=class extends d{constructor(){super(...arguments);this.height="auto";this.width="auto";this.left="auto";this.top="auto";this.right="auto";this.bottom="auto"}render(){return s`
      <slot
        class="floatingContainer"
        style="${this.toStyle(this.height,this.width,this.left,this.right,this.top,this.bottom)}"
      ></slot>
    `}toStyle(t,n,i,l,m,f){return"height:".concat(t).concat(";").concat("width:").concat(n).concat(";").concat("left:").concat(i).concat(";").concat("right:").concat(l).concat(";").concat("top:").concat(m).concat(";").concat("bottom:").concat(f).concat(";")}};K.styles=p`
    .floatingContainer {
      position: fixed;
      display: inline;
      margin: auto;
  ...
  `,r([o({type:String})],K.prototype,"height",2),r([o({type:String})],K.prototype,"width",2),r([o({type:String})],K.prototype,"left",2),r([o({type:String})],K.prototype,"top",2),r([o({type:String})],K.prototype,"right",2),r([o({type:String})],K.prototype,"bottom",2),K=r([c("nidoca-layout-floating")],K);var Wt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s`
      ${b.getStyle(this.theme)}
      <slot></slot>
    `}};Wt.styles=p`
    :host {
  ...
  `,r([o({type:String})],Wt.prototype,"theme",2),Wt=r([c("nidoca-container")],Wt);var It=class extends d{constructor(){super();this.hideSidebox=!0;this.theme=b.prototype.getParentTheme(this)||"plain"}render(){return s` <style>
        .listbox,
        .sidebox {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
      ...
      ${this.hideSidebox?s``:s` <slot class="sidebox" name="sidebox"></slot>`}`}};It.styles=p`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: nowrap;
  ...
  `,r([o({type:u,converter:String})],It.prototype,"theme",2),r([o({type:Boolean,converter:String})],It.prototype,"hideSidebox",2),It=r([c("nidoca-split-screen")],It);var G=class extends d{constructor(){super(...arguments);this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return s`
      <i
  ...
  `,r([o({type:String})],G.prototype,"icon",2),r([o({type:Boolean})],G.prototype,"clickable",2),r([o({type:Boolean})],G.prototype,"deactivated",2),r([o({type:String})],G.prototype,"title",2),G=r([c("nidoca-icon")],G);var Ut=class extends d{render(){return s`
  ...
  `,r([o({type:String})],j.prototype,"src",2),r([o({type:String})],j.prototype,"width",2),r([o({type:String})],j.prototype,"height",2),r([o({type:Boolean})],j.prototype,"zoom",2),j=r([c("nidoca-img")],j);var Pt=class extends j{static example(e=""){return s`<nidoca-img-round width="64px" width="64px" slot="${e}" src="face.jpg"></nidoca-img-round>`}};Pt.styles=p`
    :host {
      font-size: 0;
      display: inline-block;
      box-sizing: border-box;
  ...
  `,Pt=r([c("nidoca-img-round")],Pt);var Bt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
    ...
    `}slotChanged(t){let n=t.target;if(n==null)return;let i=n.assignedElements();for(let l=0;l<i.length;l++){let m=i[l];if(m instanceof j){this.selected==null&&l==0&&(this.selected=m.cloneNode(!0)),m.addEventListener("click",h=>{h.target&&(this.selected=h.target.cloneNode(!0))}),m.width="148px";let f=m.classList;f.contains("img")||f.add("img")}}}};Bt.styles=p`
    :host,
    ::slotted(:host) {
      display: flex;
      flex-direction: column;
  ...
  `,r([o({type:u,converter:String})],Bt.prototype,"theme",2),r([Ie()],Bt.prototype,"selected",2),Bt=r([c("nidoca-img-slider")],Bt);var Qt=class extends d{constructor(){super(...arguments);this.src=""}render(){return s`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
        ...
        ></iframe
      ></span>
    `}};Qt.styles=p``,r([o({type:String})],Qt.prototype,"src",2),Qt=r([c("nidoca-movie")],Qt);var $=class extends d{constructor(){super(...arguments);this.label="";this.placeholder="";this.name="";this.min=1;this.max=10;this.errorText="";this.numberOne=1;this.numberTwo=1}render(){return s`
      <nidoca-form-text
        theme="${T(this.theme)}"
        id="inputfield"
        placeholder="${this.placeholder}"
  ...
  `,r([o({type:u,converter:String})],$.prototype,"theme",2),r([o({type:String})],$.prototype,"label",2),r([o({type:String})],$.prototype,"placeholder",2),r([o({type:String})],$.prototype,"name",2),r([o({type:Number})],$.prototype,"min",2),r([o({type:Number})],$.prototype,"max",2),r([o({type:String})],$.prototype,"errorText",2),r([g("#inputfield")],$.prototype,"inputfield",2),$=r([c("nidoca-form-captcha")],$);var pt=class extends d{constructor(){super(...arguments);this.text="";this.href="";this.targetType="_self"}render(){return s`<a href="${this.href}" .target="${this.targetType}">
  ...
  `,r([o({type:String})],pt.prototype,"text",2),r([o({type:String})],pt.prototype,"href",2),r([o({type:String})],pt.prototype,"targetType",2),pt=r([c("nidoca-link")],pt);var I=class extends d{constructor(){super(...arguments);this.theme="surface";this.primaryText="";this.secondaryText="";this.tertiaryText="";this.infoText="";this.selected=!1}render(){return s`
      <style>
        .container {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([o({type:u,converter:String})],I.prototype,"theme",2),r([o({type:String})],I.prototype,"primaryText",2),r([o({type:String})],I.prototype,"secondaryText",2),r([o({type:String})],I.prototype,"tertiaryText",2),r([o({type:String})],I.prototype,"infoText",2),r([o({type:Boolean})],I.prototype,"selected",2),I=r([c("nidoca-list-item")],I);var it=class extends d{constructor(){super(...arguments);this.theme="surface";this.text=""}render(){return s`
      <style>
        :host {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background-dark);
  ...
  :host {
     ...
     width:100%;
     box-sizing:border-box;
  `,r([o({type:u,converter:String})],it.prototype,"theme",2),r([o({type:String})],it.prototype,"text",2),it=r([c("nidoca-list-section")],it);var dt=class extends d{constructor(){super(...arguments);this.theme="surface";this.multiselect=!1}updated(t){super.updated(t),t.forEach((n,i)=>{i=="theme"&&this.getItems().forEach(l=>{l.theme=this.theme})})}render(){return s`
      <slot
        @nidoca-event-list-item-clicked="${t=>{if(!this.multiselect){this.unselectAll();let n=t.target;n.selected=!0}}}"
        id="slotElement"
      ></slot>
    `}getItems(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];l instanceof I&&t.push(l)}}return t}getSelectedItems(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];l instanceof I&&l.selected&&t.push(l)}}return t}getSelectedIndexes(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements(),i=0;for(let l=0;l<n.length;l++){let m=n[l];m instanceof I&&(m.selected&&t.push(i),i++)}}return t}selectAll(){this.getItems().forEach(t=>{t.selected=!0})}unselectAll(){this.getItems().forEach(t=>{t.selected=!1})}static example(){return s`<nidoca-list theme="primary">
  ...
  `,r([o({type:u,converter:String})],dt.prototype,"theme",2),r([o({type:Boolean})],dt.prototype,"multiselect",2),r([g("#slotElement")],dt.prototype,"slotElement",2),dt=r([c("nidoca-list")],dt);var Dt=class extends d{constructor(){super(...arguments);this.theme="plain";this.prominent=!1}render(){return s`
      <style>
        * {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([o({type:String,converter:String})],Dt.prototype,"theme",2),r([o({type:Boolean})],Dt.prototype,"prominent",2),Dt=r([c("nidoca-top-app-bar")],Dt);var ht=class extends d{constructor(){super(...arguments);this.headers=["column 1","column 2"];this.rows=[["row 1",new G],["row 2",new G]];this.theme="plain"}render(){return s`
      <style>
        td,
        th {
      ...
      <div>
        <table>
          <thead>
            ${ie([this.headers],()=>s` ${qt(this.headers,t=>s` <th colspan="1" rowspan="1">${t}</th> `)} `)}
          </thead>
          <tbody>
            ${ie([this.rows],()=>s`
                  ${qt(this.rows,t=>s`
                        <tr>
                          ${qt(t,n=>s` <td colspan="1" rowspan="1">${n}</td> `)}
                        </tr>
                      `)}
                `)}
          </tbody>
  ...
  `,r([o({type:Array})],ht.prototype,"headers",2),r([o({type:Array})],ht.prototype,"rows",2),r([o({type:u,converter:String})],ht.prototype,"theme",2),ht=r([c("nidoca-table")],ht);var ut=class extends d{constructor(){super(...arguments);this.selected=!1}render(){return this.selected?s` <slot></slot>`:s``}};ut.styles=p`
    :host,
    slot {
      display: block;
    }
  `,r([o({type:Boolean})],ut.prototype,"selected",2),ut=r([c("nidoca-tab-content")],ut);var Y=class extends d{constructor(){super(...arguments);this.selected=!1;this.text="";this.theme="surface"}render(){return s`
      <style>
        .container {
  ...
  `,r([o({type:Boolean})],Y.prototype,"selected",2),r([o({type:String})],Y.prototype,"text",2),r([o({type:String})],Y.prototype,"theme",2),Y=r([c("nidoca-tab")],Y);var ot=class extends d{constructor(){super(...arguments);this.theme="surface";this.tabIndex=0}render(){return s`
      <div class="container" @nidoca-event-tab-clicked="${t=>this.tabClicked(t)}">
        <slot id="tabSlot" name="tab"></slot>
        <slot id="tabContentSlot" name="tabContent"></slot>
      </div>
    `}firstUpdated(t){super.firstUpdated(t),this.tabIndexChanged()}update(t){super.update(t),t.get("tabIndex")!=null&&this.tabIndexChanged()}tabIndexChanged(){this.updateNidocaTabElements(),this.updateNidocaTabContentElemnts()}updateNidocaTabElements(){if(this.tabSlot!=null){let t=this.tabSlot.assignedElements(),i=100/t.length,l=t[this.tabIndex];for(let m=0;m<t.length;m++){let f=t[m];f instanceof Y&&(f.theme=this.theme,f.style.width=String(i).concat("%"),f==l?(f.selected=!0,f.classList.add("SELECTED")):(f.selected=!1,f.classList.remove("SELECTED")))}}}updateNidocaTabContentElemnts(){let t=0;if(this.tabContentSlot!=null){let n=this.tabContentSlot.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];l instanceof ut&&(this.tabIndex==t?l.selected=!0:l.selected=!1,t++)}}}tabClicked(t){let n=t.detail;this.changeTabIndex(n)}changeTabIndex(t){if(!t.selected&&this.tabSlot!=null){let n=this.tabSlot.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];if(l instanceof Y&&l==t){this.tabIndex=i;break}}}}static example(t=""){return s`
  ...
  `,r([g("#tabSlot")],ot.prototype,"tabSlot",2),r([g("#tabContentSlot")],ot.prototype,"tabContentSlot",2),r([o({type:String})],ot.prototype,"theme",2),r([o({type:Number})],ot.prototype,"tabIndex",2),ot=r([c("nidoca-tabs")],ot);var ft=class extends d{constructor(){super();this.hideLeft=!0;this.prominent=!1;document.getElementsByTagName("html")[0].setAttribute("oncontextmenu","return false"),this.addEventListener("click",t=>{if(!this.hideLeft&&this.leftElement){console.log("close");let n=this.leftElement.getBoundingClientRect();this.hideLeft=641>window.innerWidth&&0<=t.x-n.width}})}render(){return s`
      <slot
        id="left"
  ...
  `,r([o({type:u,converter:String})],A.prototype,"theme",2),r([o({type:String})],A.prototype,"text",2),A=r([c("nidoca-text")],A);var oe=class extends A{render(){return s` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};oe.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,oe=r([c("nidoca-text-body")],oe);var se=class extends A{render(){return s`${super.render()}`}};se.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ae=r([c("nidoca-text-overline")],ae);var le=class extends A{render(){return s` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};le.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,le=r([c("nidoca-text-subtitle")],le);var C=class extends A{render(){return s`<style>
        slot {
  ...
  `,C=r([c("nidoca-text-caption")],C);var Ce=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-error-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ce=r([c("nidoca-text-error")],Ce);var Le=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-success-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Le=r([c("nidoca-text-success")],Le);var Me=class extends C{render(){return s`<style>
        slot {
          color: var(--app-color-warning-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Me=r([c("nidoca-text-warning")],Me);var Ve=class extends C{render(){return s`<style>
        slot {
  ...
  `,ue=r([c("nidoca-text-h6")],ue);var jt=class extends X{constructor(){super(...arguments);this.message="Dies ist eine Testnachricht"}showToast(t=3e3){this.toastElement.classList.add("show"),setTimeout(()=>{this.hideToast()},t)}hideToast(){this.toastElement.classList.remove("show")}render(){return s`
  ...
  `,r([o({type:String})],jt.prototype,"message",2),r([g("#toast")],jt.prototype,"toastElement",2),jt=r([c("nidoca-toast")],jt);var F=class extends d{constructor(){super(...arguments);this.value="";this.placeholder="";this.disabled=!1;this.theme="surface"}render(){return s`
      <style>
        .container,
        input {
          color: var(--app-color-text-${this.theme});
  ...
  `,r([o({type:String})],F.prototype,"value",2),r([o({type:String})],F.prototype,"placeholder",2),r([o({type:Boolean})],F.prototype,"disabled",2),r([g("#inputElement")],F.prototype,"inputElement",2),r([o({type:u,converter:String})],F.prototype,"theme",2),F=r([c("nidoca-search-bar")],F);var fe=class{static{this.CENTER="CENTER"}static{this.LEFT="LEFT"}static{this.RIGHT="RIGHT"}static{this.TOP="TOP"}static{this.BOTTOM="BOTTOM"}static{this.SLIDE_CENTER="SLIDE_CENTER"}static{this.SLIDE_LEFT="SLIDE_LEFT"}static{this.SLIDE_RIGHT="SLIDE_RIGHT"}static{this.SLIDE_TOP="SLIDE_TOP"}static{this.SLIDE_BOTTOM="SLIDE_BOTTOM"}},$t=class extends d{constructor(){super(...arguments);this.transitionType=fe.CENTER;this.duration=.5}render(){return s` <div class="${T(this.transitionType)}"><slot></slot></div> `}};$t.styles=p`
  ...
  `,r([o({type:String})],$t.prototype,"transitionType",2),r([o({type:Number})],$t.prototype,"duration",2),$t=r([c("nidoca-transition")],$t);var Kt=class extends d{constructor(){super(...arguments);this.show=!1}render(){return this.show?s`
  ...
  `,r([o({type:Boolean})],Kt.prototype,"show",2),Kt=r([c("nidoca-dialog")],Kt);var _=class extends d{constructor(){super(...arguments);this.show=!1;this.title="Ja oder Nein ?";this.description="Entscheide dich";this.labelButtonYes="Ja";this.labelButtonNo="Nein"}render(){return s`<nidoca-dialog .show="${this.show}">
    ...
    </nidoca-dialog>`}};_.styles=p``,r([o({type:Boolean})],_.prototype,"show",2),r([o({type:String})],_.prototype,"title",2),r([o({type:String})],_.prototype,"description",2),r([o({type:String})],_.prototype,"labelButtonYes",2),r([o({type:String})],_.prototype,"labelButtonNo",2),_=r([c("nidoca-dialog-decision")],_);var Yt=class extends d{constructor(){super(...arguments);this.icon=""}render(){return s`
  ...
  `,r([o({type:String})],Yt.prototype,"icon",2),Yt=r([c("nidoca-infobox")],Yt);var st=class extends d{constructor(){super(...arguments);this.theme="surface";this.src="";this.title="";this.subtitle=""}render(){return s`
            <div
  ...
  `,r([o({type:u,converter:String})],st.prototype,"theme",2),r([o({type:String})],st.prototype,"src",2),r([o({type:String})],st.prototype,"title",2),r([o({type:String})],st.prototype,"subtitle",2),st=r([c("nidoca-avatar")],st);var Xt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return s`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background-light);
          border-color: var(--app-color-${this.theme}-border);
  ...
  `,r([o({type:u,converter:String})],Xt.prototype,"theme",2),Xt=r([c("nidoca-card")],Xt);var ge=class extends d{render(){return s`
      <nidoca-layout-spacer bottom="var(--space)" left="">
        <slot id="slotElement" @slotchange="${e=>this.slotChanged(e)}"></slot>
      </nidoca-layout-spacer>
    `}slotChanged(e){let t=e.target;if(t==null)return;let n=t.assignedElements();for(let i=0;i<n.length;i++){let m=n[i].classList;m.contains("flexItem")||m.add("flexItem"),m.contains("flexItemDevice")||m.add("flexItemDevice")}}};ge.styles=p`
    slot,
    ::slotted(slot) {
      display: flex;
      flex-direction: row;
  ...
  `,ge=r([c("nidoca-gallery")],ge);var xe=class extends d{render(){return s`<slot></slot>`}print(){let e=window.open("");e&&(e.document.write(this.innerHTML),e.print(),e.close())}};xe.styles=p`
    :host {
      display: none;
    }
  `,xe=r([c("nidoca-print")],xe);var ye=class extends d{render(){return s`
      <slot id="container" class="container" @slotchange="${e=>this.slotChanged(e)}"></slot>
    `}slotChanged(e){let n=e.target.assignedElements(),i=n.length;for(let l=0;l<i;l++){let f=n[l].classList,h="item_count_"+i;f.contains(h)||f.add(h)}}};ye.styles=p`
    :host {
      display: block;
      margin: auto;
      width: 100%;
  ...
  `,ye=r([c("nidoca-section")],ye);var Zt=class extends d{constructor(){super(...arguments);this.cards=[]}render(){return s`
      <div class="container">
        ${this.cards.map(t=>s`
    ...
    `}clicked(){throw new Error("Method not implemented.")}};Zt.styles=p`
  ...
  `,r([o({type:Array})],Zt.prototype,"cards",2),Zt=r([c("nidoca-dashboard")],Zt);var Jt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return s`
      ${b.getStyle(this.theme)}
      <slot></slot>
    `}};Jt.styles=p`
    :host {
  ...
  `,r([o({type:u,converter:String})],Jt.prototype,"theme",2),Jt=r([c("nidoca-box")],Jt);var L=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Deine Nachricht";this.nameLabel="Dein Name";this.emailLabel="Deine Email";this.titleLabel="Betreff";this.messageLabel="Deine Nachricht";this.buttonLabel="Senden"}render(){return s`
      <nidoca-box theme="${T(this.theme)}">
  ...
  `,r([o({type:u,converter:String})],L.prototype,"theme",2),r([o({type:String,converter:String})],L.prototype,"label",2),r([o({type:String,converter:String})],L.prototype,"nameLabel",2),r([o({type:String,converter:String})],L.prototype,"emailLabel",2),r([o({type:String,converter:String})],L.prototype,"titleLabel",2),r([o({type:String,converter:String})],L.prototype,"messageLabel",2),r([o({type:String,converter:String})],L.prototype,"buttonLabel",2),r([g("#authenitcate-form")],L.prototype,"formComponent",2),L=r([c("nidoca-form-contact")],L);})();
