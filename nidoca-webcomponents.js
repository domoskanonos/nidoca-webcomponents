"use strict";(()=>{var Or=Object.defineProperty;var Rr=Object.getOwnPropertyDescriptor;var r=(a,e,t,n)=>{for(var i=n>1?void 0:n?Rr(e,t):e,l=a.length-1,m;l>=0;l--)(m=a[l])&&(i=(n?m(e,t,i):m(i))||i);return n&&i&&Or(e,t,i),i};var Ue=globalThis,ve=Ue.trustedTypes,_e=ve?ve.createPolicy("lit-html",{createHTML:a=>a}):void 0,We="$lit$",tt=`lit$${Math.random().toFixed(9).slice(2)}$`,Qe="?"+tt,Ir=`<${Qe}>`,bt=document,Nt=()=>bt.createComment(""),te=a=>a===null||typeof a!="object"&&typeof a!="function",Ke=Array.isArray,ir=a=>Ke(a)||typeof a?.[Symbol.iterator]=="function",Ge=`[ 	
\f\r]`,_t=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ne=/-->/g,tr=/>/g,gt=RegExp(`>|${Ge}(?:([^\\s"'>=/]+)(${Ge}*=${Ge}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),er=/'/g,rr=/"/g,or=/^(?:script|style|textarea|title)$/i,Ye=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),o=Ye(1),Yr=Ye(2),Xr=Ye(3),V=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),nr=new WeakMap,xt=bt.createTreeWalker(bt,129);function sr(a,e){if(!Ke(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return _e!==void 0?_e.createHTML(e):e}var ar=(a,e)=>{let t=a.length-1,n=[],i,l=e===2?"<svg>":e===3?"<math>":"",m=_t;for(let f=0;f<t;f++){let h=a[f],v,E,x=-1,w=0;for(;w<h.length&&(m.lastIndex=w,E=m.exec(h),E!==null);)w=m.lastIndex,m===_t?E[1]==="!--"?m=Ne:E[1]!==void 0?m=tr:E[2]!==void 0?(or.test(E[2])&&(i=RegExp("</"+E[2],"g")),m=gt):E[3]!==void 0&&(m=gt):m===gt?E[0]===">"?(m=i??_t,x=-1):E[1]===void 0?x=-2:(x=m.lastIndex-E[2].length,v=E[1],m=E[3]===void 0?gt:E[3]==='"'?rr:er):m===rr||m===er?m=gt:m===Ne||m===tr?m=_t:(m=gt,i=void 0);let b=m===gt&&a[f+1].startsWith("/>")?" ":"";l+=m===_t?h+Ir:x>=0?(n.push(v),h.slice(0,x)+We+h.slice(x)+tt+b):h+tt+(x===-2?f:b)}return[sr(a,l+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},ee=class a{constructor({strings:e,_$litType$:t},n){let i;this.parts=[];let l=0,m=0,f=e.length-1,h=this.parts,[v,E]=ar(e,t);if(this.el=a.createElement(v,n),xt.currentNode=this.el.content,t===2||t===3){let x=this.el.content.firstChild;x.replaceWith(...x.childNodes)}for(;(i=xt.nextNode())!==null&&h.length<f;){if(i.nodeType===1){if(i.hasAttributes())for(let x of i.getAttributeNames())if(x.endsWith(We)){let w=E[m++],b=i.getAttribute(x).split(tt),O=/([.?@])?(.*)/.exec(w);h.push({type:1,index:l,name:O[2],strings:b,ctor:O[1]==="."?ke:O[1]==="?"?we:O[1]==="@"?Ee:vt}),i.removeAttribute(x)}else x.startsWith(tt)&&(h.push({type:6,index:l}),i.removeAttribute(x));if(or.test(i.tagName)){let x=i.textContent.split(tt),w=x.length-1;if(w>0){i.textContent=ve?ve.emptyScript:"";for(let b=0;b<w;b++)i.append(x[b],Nt()),xt.nextNode(),h.push({type:2,index:++l});i.append(x[w],Nt())}}}else if(i.nodeType===8)if(i.data===Qe)h.push({type:2,index:l});else{let x=-1;for(;(x=i.data.indexOf(tt,x+1))!==-1;)h.push({type:7,index:l}),x+=tt.length-1}l++}}static createElement(e,t){let n=bt.createElement("template");return n.innerHTML=e,n}};function yt(a,e,t=a,n){if(e===V)return e;let i=n!==void 0?t._$Co?.[n]:t._$Cl,l=te(e)?void 0:e._$litDirective$;return i?.constructor!==l&&(i?._$AO?.(!1),l===void 0?i=void 0:(i=new l(a),i._$AT(a,t,n)),n!==void 0?(t._$Co??=[])[n]=i:t._$Cl=i),i!==void 0&&(e=yt(a,i._$AS(a,e.values),i,n)),e}var Ae=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,i=(e?.creationScope??bt).importNode(t,!0);xt.currentNode=i;let l=xt.nextNode(),m=0,f=0,h=n[0];for(;h!==void 0;){if(m===h.index){let v;h.type===2?v=new Ct(l,l.nextSibling,this,e):h.type===1?v=new h.ctor(l,h.name,h.strings,this,e):h.type===6&&(v=new Se(l,this,e)),this._$AV.push(v),h=n[++f]}m!==h?.index&&(l=xt.nextNode(),m++)}return xt.currentNode=bt,i}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}},Ct=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,i){this.type=2,this._$AH=S,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=yt(this,e,t),te(e)?e===S||e==null||e===""?(this._$AH!==S&&this._$AR(),this._$AH=S):e!==this._$AH&&e!==V&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ir(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==S&&te(this._$AH)?this._$AA.nextSibling.data=e:this.T(bt.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=ee.createElement(sr(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(t);else{let l=new Ae(i,this),m=l.u(this.options);l.p(t),this.T(m),this._$AH=l}}_$AC(e){let t=nr.get(e.strings);return t===void 0&&nr.set(e.strings,t=new ee(e)),t}k(e){Ke(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,n,i=0;for(let l of e)i===t.length?t.push(n=new a(this.O(Nt()),this.O(Nt()),this,this.options)):n=t[i],n._$AI(l),i++;i<t.length&&(this._$AR(n&&n._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},vt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,i,l){this.type=1,this._$AH=S,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=l,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=S}_$AI(e,t=this,n,i){let l=this.strings,m=!1;if(l===void 0)e=yt(this,e,t,0),m=!te(e)||e!==this._$AH&&e!==V,m&&(this._$AH=e);else{let f=e,h,v;for(e=l[0],h=0;h<l.length-1;h++)v=yt(this,f[n+h],t,h),v===V&&(v=this._$AH[h]),m||=!te(v)||v!==this._$AH[h],v===S?e=S:e!==S&&(e+=(v??"")+l[h+1]),this._$AH[h]=v}m&&!i&&this.j(e)}j(e){e===S?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ke=class extends vt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===S?void 0:e}},we=class extends vt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==S)}},Ee=class extends vt{constructor(e,t,n,i,l){super(e,t,n,i,l),this.type=5}_$AI(e,t=this){if((e=yt(this,e,t,0)??S)===V)return;let n=this._$AH,i=e===S&&n!==S||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,l=e!==S&&(n===S||i);i&&this.element.removeEventListener(this.name,this,n),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Se=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){yt(this,e)}},lr={M:We,P:tt,A:Qe,C:1,L:ar,R:Ae,D:ir,V:yt,I:Ct,H:vt,N:we,U:Ee,B:ke,F:Se},Pr=Ue.litHtmlPolyfillSupport;Pr?.(ee,Ct),(Ue.litHtmlVersions??=[]).push("3.2.1");var mr=(a,e,t)=>{let n=t?.renderBefore??e,i=n._$litPart$;if(i===void 0){let l=t?.renderBefore??null;n._$litPart$=i=new Ct(e.insertBefore(Nt(),l),l,void 0,t??{})}return i._$AI(a),i};var c=a=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(a,e)}):customElements.define(a,e)};var Te=globalThis,He=Te.ShadowRoot&&(Te.ShadyCSS===void 0||Te.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Xe=Symbol(),cr=new WeakMap,re=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==Xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(He&&e===void 0){let n=t!==void 0&&t.length===1;n&&(e=cr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&cr.set(t,e))}return e}toString(){return this.cssText}},pr=a=>new re(typeof a=="string"?a:a+"",void 0,Xe),p=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((n,i,l)=>n+(m=>{if(m._$cssResult$===!0)return m.cssText;if(typeof m=="number")return m;throw Error("Value passed to 'css' function must be a 'css' function result: "+m+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[l+1],a[0]);return new re(t,a,Xe)},Ze=(a,e)=>{if(He)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let n=document.createElement("style"),i=Te.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,a.appendChild(n)}},Oe=He?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let n of e.cssRules)t+=n.cssText;return pr(t)})(a):a;var{is:Dr,defineProperty:zr,getOwnPropertyDescriptor:Br,getOwnPropertyNames:jr,getOwnPropertySymbols:Cr,getPrototypeOf:$r}=Object,Re=globalThis,dr=Re.trustedTypes,Lr=dr?dr.emptyScript:"",Vr=Re.reactiveElementPolyfillSupport,ne=(a,e)=>a,ie={toAttribute(a,e){switch(e){case Boolean:a=a?Lr:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},Ie=(a,e)=>!Dr(a,e),hr={attribute:!0,type:String,converter:ie,reflect:!1,hasChanged:Ie};Symbol.metadata??=Symbol("metadata"),Re.litPropertyMetadata??=new WeakMap;var et=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=hr){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){let n=Symbol(),i=this.getPropertyDescriptor(e,n,t);i!==void 0&&zr(this.prototype,e,i)}}static getPropertyDescriptor(e,t,n){let{get:i,set:l}=Br(this.prototype,e)??{get(){return this[t]},set(m){this[t]=m}};return{get(){return i?.call(this)},set(m){let f=i?.call(this);l.call(this,m),this.requestUpdate(e,f,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??hr}static _$Ei(){if(this.hasOwnProperty(ne("elementProperties")))return;let e=$r(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ne("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ne("properties"))){let t=this.properties,n=[...jr(t),...Cr(t)];for(let i of n)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[n,i]of t)this.elementProperties.set(n,i)}this._$Eh=new Map;for(let[t,n]of this.elementProperties){let i=this._$Eu(t,n);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let i of n)t.unshift(Oe(i))}else e!==void 0&&t.push(Oe(e));return t}static _$Eu(e,t){let n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let n of t.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ze(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$EC(e,t){let n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){let l=(n.converter?.toAttribute!==void 0?n.converter:ie).toAttribute(t,n.type);this._$Em=e,l==null?this.removeAttribute(i):this.setAttribute(i,l),this._$Em=null}}_$AK(e,t){let n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let l=n.getPropertyOptions(i),m=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:ie;this._$Em=i,this[i]=m.fromAttribute(t,l.type),this._$Em=null}}requestUpdate(e,t,n){if(e!==void 0){if(n??=this.constructor.getPropertyOptions(e),!(n.hasChanged??Ie)(this[e],t))return;this.P(e,t,n)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,t,n){this._$AL.has(e)||this._$AL.set(e,t),n.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,l]of this._$Ep)this[i]=l;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[i,l]of n)l.wrapped!==!0||this._$AL.has(i)||this[i]===void 0||this.P(i,this[i],l)}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(t)):this._$EU()}catch(n){throw e=!1,this._$EU(),n}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(t=>this._$EC(t,this[t])),this._$EU()}updated(e){}firstUpdated(e){}};et.elementStyles=[],et.shadowRootOptions={mode:"open"},et[ne("elementProperties")]=new Map,et[ne("finalized")]=new Map,Vr?.({ReactiveElement:et}),(Re.reactiveElementVersions??=[]).push("2.0.4");var Mr={attribute:!0,type:String,converter:ie,reflect:!1,hasChanged:Ie},qr=(a=Mr,e,t)=>{let{kind:n,metadata:i}=t,l=globalThis.litPropertyMetadata.get(i);if(l===void 0&&globalThis.litPropertyMetadata.set(i,l=new Map),l.set(t.name,a),n==="accessor"){let{name:m}=t;return{set(f){let h=e.get.call(this);e.set.call(this,f),this.requestUpdate(m,h,a)},init(f){return f!==void 0&&this.P(m,void 0,a),f}}}if(n==="setter"){let{name:m}=t;return function(f){let h=this[m];e.call(this,f),this.requestUpdate(m,h,a)}}throw Error("Unsupported decorator location: "+n)};function s(a){return(e,t)=>typeof t=="object"?qr(a,e,t):((n,i,l)=>{let m=i.hasOwnProperty(l);return i.constructor.createProperty(l,m?{...n,wrapped:!0}:n),m?Object.getOwnPropertyDescriptor(i,l):void 0})(a,e,t)}function ur(a){return s({...a,state:!0,attribute:!1})}var At=(a,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,t),t);function g(a,e){return(t,n,i)=>{let l=m=>m.renderRoot?.querySelector(a)??null;if(e){let{get:m,set:f}=typeof n=="object"?t:i??(()=>{let h=Symbol();return{get(){return this[h]},set(v){this[h]=v}}})();return At(t,n,{get(){let h=m.call(this);return h===void 0&&(h=l(this),(h!==null||this.hasUpdated)&&f.call(this,h)),h}})}return At(t,n,{get(){return l(this)}})}}var U=class extends et{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=mr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return V}};U._$litElement$=!0,U.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:U});var Gr=globalThis.litElementPolyfillSupport;Gr?.({LitElement:U});(globalThis.litElementVersions??=[]).push("4.1.1");var d=class extends U{};var u=(i=>(i.primary="primary",i.secondary="secondary",i.surface="surface",i.plain="plain",i))(u||{}),y=class{static getStyle(e){return e?e=="plain"?o``:o` <style>
            :host,
            *,
            ::slotted(*) {
          ...
          </style>`:o``}static getOposite(e){return e=="plain"?"surface":e=="primary"||e=="primary"?"secondary":e=="secondary"?"primary":"plain"}getParentTheme(e){let t=e;for(;t!=null;){if(t.theme!=null)return t.theme;t=t.parentElement}}};var Pe=class extends d{constructor(){super(...arguments);this.theme="plain";this.data=[]}render(){return this.data==null||!this.data.length?o`<p>Loading data...</p>`:o`
            <nidoca-list theme="${this.theme}">
              ${this.data.map(t=>this.renderListItem(t))}
            </nidoca-list>
          `}};r([s({type:u,converter:String})],Pe.prototype,"theme",2),r([s({})],Pe.prototype,"data",2);var $t=class extends d{constructor(){super();this.identifier=null;this.item={};this.dialogDeleteTitle="";this.dialogDeleteDescription="";this.showDeleteDialog=!1;this.init()}init(){this.identifier=this.getIdentifier(),this.item=this.initObject()}render(){return o`
      <nidoca-form id="form">
      ...
      ></decision-dialog-component>
    `}renderFormFields(){let t=[];console.log("item",this.item);for(let[n,i]of Object.entries(this.item)){let l;switch(typeof i){case"boolean":l=o`
            <nidoca-form-switch
              label="${n}"
              name="${n}"
              .value="${i}"
  ...
  `,r([s({type:u,converter:String})],W.prototype,"theme",2),r([s({type:String})],W.prototype,"header",2),r([s({type:Boolean})],W.prototype,"opened",2),W=r([c("nidoca-accordion-item")],W);var H=class extends d{constructor(){super(...arguments);this.theme="plain";this.overline="";this.title="";this.summary="";this.text=""}render(){return o`
  ...
  `,r([s({type:u,converter:String})],at.prototype,"theme",2),r([s({type:br,converter:String})],at.prototype,"accordionType",2),r([g("#accordionSlot")],at.prototype,"accordionSlot",2),at=r([c("nidoca-accordion")],at);var yr=(i=>(i.none="none",i.shadow_1="shadow_1",i.shadow_2="shadow_2",i.shadow_3="shadow_3",i))(yr||{}),Q=class extends d{constructor(){super(...arguments);this.theme="primary";this.shadowType="shadow_1";this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return o`
      <style>
        .iconExtended {
  ...
  `,r([s({type:String})],M.prototype,"icon",2),r([s({type:String})],M.prototype,"primaryText",2),r([s({type:Number})],M.prototype,"state",2),r([s({type:Boolean})],M.prototype,"isLast",2),M=r([c("nidoca-wizard-step")],M);var Vt=class extends d{render(){return o`
      <div
    ...
    `}slotChanged(e){let t=e.target;if(t==null)return;let n=t.assignedElements(),i=0;for(let l=0;l<n.length;l++){let m=n[l];m instanceof M&&(m.index=l,m.state==0&&(i=l),m.index==n.length-1&&(m.isLast=!0))}this.changeState(i)}stepClicked(e){let t=e.detail;console.debug("wizard step clicked, selectedStepIndex: %s",t),this.changeState(t)}changeState(e){if(this.wizardSlot){let t=this.wizardSlot.assignedElements();for(let n=0;n<t.length;n++){let i=t[n];i instanceof M&&i.index!==void 0&&(i.index<e?i.state=1:i.index==e?i.state=0:i.state=2)}}}};Vt.styles=p``,r([g("#wizardSlot")],Vt.prototype,"wizardSlot",2),Vt=r([c("nidoca-wizard")],Vt);var lt=class extends d{constructor(){super(...arguments);this.clickable=!0;this.theme="surface";this.text=""}render(){return o`
      <style>
        .chip:hover {
    ...
    `}static example(t=""){return o`<nidoca-chip slot="${t}" clickable text="Mein Chip"></nidoca-chip>`}};lt.styles=p`
    .chip {
      display: inline-block;
      padding: var(--space-2);
      border-radius: 1rem;
  ...
  `,r([s({type:Boolean})],lt.prototype,"clickable",2),r([s({type:u,converter:String})],lt.prototype,"theme",2),r([s({type:String})],lt.prototype,"text",2),lt=r([c("nidoca-chip")],lt);var kt=class extends d{constructor(){super(...arguments);this.code="";this.theme="plain"}render(){return o`
      <style>
        code {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:String})],kt.prototype,"code",2),r([s({type:String})],kt.prototype,"theme",2),kt=r([c("nidoca-code")],kt);var De=class{static{this.PROGRESS="PROGRESS"}static{this.PROGRESS_CIRCULAR="PROGRESS_CIRCULAR"}},wt=class extends d{constructor(){super(...arguments);this.progressType=De.PROGRESS}render(){return o` <style>
        :host {
          width: 100%;
          display: block;
        }
      ...
      <progress class="${this.progressType}"></progress>`}};wt.styles=p``,r([s({type:u,converter:String})],wt.prototype,"theme",2),r([s({type:De,converter:String})],wt.prototype,"progressType",2),wt=r([c("nidoca-progress")],wt);var ze=(n=>(n.contained="contained",n.outlined="outlined",n.text="text",n))(ze||{}),rt=class extends d{constructor(){super(...arguments);this.theme="primary";this.buttonType="contained";this.icon="";this.text=""}render(){return o`
      <style>
        .outlined {
          color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:u,converter:String})],rt.prototype,"theme",2),r([s({type:ze,converter:String})],rt.prototype,"buttonType",2),r([s({type:String})],rt.prototype,"icon",2),r([s({type:String})],rt.prototype,"text",2),rt=r([c("nidoca-button")],rt);var Ar=class{constructor(){this.key=""}},B=class extends d{};var kr=class{constructor(){this.formData=FormData.prototype}},Et=class extends d{constructor(){super(...arguments);this.autocomplete=!0}render(){return o`
  ...
  `,r([s({type:Boolean})],Et.prototype,"autocomplete",2),r([g("#slotElement")],Et.prototype,"slotElement",2),Et=r([c("nidoca-form")],Et);var wr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Be=a=>(...e)=>({_$litDirective$:a,values:e}),Mt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:Ur}=lr;var Er=()=>document.createComment(""),qt=(a,e,t)=>{let n=a._$AA.parentNode,i=e===void 0?a._$AB:e._$AA;if(t===void 0){let l=n.insertBefore(Er(),i),m=n.insertBefore(Er(),i);t=new Ur(l,m,a,a.options)}else{let l=t._$AB.nextSibling,m=t._$AM,f=m!==a;if(f){let h;t._$AQ?.(a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==m._$AU&&t._$AP(h)}if(l!==i||f){let h=t._$AA;for(;h!==l;){let v=h.nextSibling;n.insertBefore(h,i),h=v}}}return t},mt=(a,e,t=a)=>(a._$AI(e,t),a),Wr={},Sr=(a,e=Wr)=>a._$AH=e,Tr=a=>a._$AH,je=a=>{a._$AP?.(!1,!0);let e=a._$AA,t=a._$AB.nextSibling;for(;e!==t;){let n=e.nextSibling;e.remove(),e=n}};var Hr=(a,e,t)=>{let n=new Map;for(let i=e;i<=t;i++)n.set(a[i],i);return n},Gt=Be(class extends Mt{constructor(a){if(super(a),a.type!==wr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let n;t===void 0?t=e:e!==void 0&&(n=e);let i=[],l=[],m=0;for(let f of a)i[m]=n?n(f,m):m,l[m]=t(f,m),m++;return{values:l,keys:i}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,n]){let i=Tr(a),{values:l,keys:m}=this.dt(e,t,n);if(!Array.isArray(i))return this.ut=m,l;let f=this.ut??=[],h=[],v,E,x=0,w=i.length-1,b=0,O=l.length-1;for(;x<=w&&b<=O;)if(i[x]===null)x++;else if(i[w]===null)w--;else if(f[x]===m[b])h[b]=mt(i[x],l[b]),x++,b++;else if(f[w]===m[O])h[O]=mt(i[w],l[O]),w--,O--;else if(f[x]===m[O])h[O]=mt(i[x],l[O]),qt(a,h[O+1],i[x]),x++,O--;else if(f[w]===m[b])h[b]=mt(i[w],l[b]),qt(a,i[x],i[w]),w--,b++;else if(v===void 0&&(v=Hr(m,b,O),E=Hr(f,x,w)),v.has(f[x]))if(v.has(f[w])){let N=E.get(m[b]),qe=N!==void 0?i[N]:null;if(qe===null){let Fe=qt(a,i[x]);mt(Fe,l[b]),h[b]=Fe}else h[b]=mt(qe,l[b]),qt(a,i[x],qe),i[N]=null;b++}else je(i[w]),w--;else je(i[x]),x++;for(;b<=O;){let N=qt(a,h[O+1]);mt(N,l[b]),h[b++]=N}for(;x<=w;){let N=i[x++];N!==null&&je(N)}return this.ut=m,Sr(a,h),V}});var Qr={},oe=Be(class extends Mt{constructor(){super(...arguments),this.ot=Qr}render(a,e){return e()}update(a,[e,t]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((n,i)=>n===this.ot[i]))return V}else if(this.ot===e)return V;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,t)}});var R=class extends B{constructor(){super(...arguments);this.theme="surface";this.trailingIcon="";this.label="";this.errorText="";this.infoText="";this.warningText="";this.value="";this.options=[];this.name="";this.required=!0;this.multiple=!1;this.size=1}render(){return o` <style>
        .parentContainer,
  ...
  `,r([s({type:nt,converter:String})],k.prototype,"type",2),r([s({type:String})],k.prototype,"label",2),r([s({type:String})],k.prototype,"placeholder",2),r([s({type:String})],k.prototype,"trailingIcon",2),r([s({type:String})],k.prototype,"errorText",2),r([s({type:String})],k.prototype,"infoText",2),r([s({type:String})],k.prototype,"warningText",2),r([s({type:String})],k.prototype,"name",2),r([s()],k.prototype,"value",2),r([s({type:Boolean})],k.prototype,"required",2),r([s({type:Boolean})],k.prototype,"disabled",2),r([s({type:Boolean})],k.prototype,"checked",2),r([s({type:Number})],k.prototype,"maxlength",2),r([s({type:Number})],k.prototype,"minlength",2),r([s({type:Number})],k.prototype,"min",2),r([s({type:Number})],k.prototype,"max",2),r([s({type:String})],k.prototype,"step",2),r([s({type:Number})],k.prototype,"size",2),r([s({type:String})],k.prototype,"pattern",2),r([g("#inputElement")],k.prototype,"inputElement",2),r([s({type:u,converter:String})],k.prototype,"theme",2),k=r([c("nidoca-form-text")],k);var Ce=class extends k{constructor(){super(),this.type="date"}};Ce=r([c("nidoca-form-date")],Ce);var P=class extends B{constructor(){super(...arguments);this.theme="surface";this.infoText="";this.warningText="";this.errorText="";this.name="";this.value="";this.label="";this.required=!1;this.placeholder="";this.disabled=!1;this.rows=5}render(){return o` <style>
        .parentContainer,
        ::slotted(.parentContainer) {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
...
${this.value}</textarea
  ...
  `,r([s({type:u,converter:String})],Z.prototype,"theme",2),r([s({type:String,converter:String})],Z.prototype,"label",2),r([s({type:String,converter:String})],Z.prototype,"emailLabel",2),r([s({type:String,converter:String})],Z.prototype,"buttonLabel",2),r([g("#form")],Z.prototype,"formComponent",2),Z=r([c("nidoca-form-newsletter")],Z);var J=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Passwort zur\xFCcksetzen";this.emailLabel="Deine Emailadresse";this.buttonLabel="Zur\xFCcksetzen"}render(){return o`
  ...
  `,r([s({type:u,converter:String})],K.prototype,"theme",2),r([s({type:String,converter:String})],K.prototype,"label",2),r([s({type:String,converter:String})],K.prototype,"emailLabel",2),r([s({type:String,converter:String})],K.prototype,"passwordLabel",2),r([s({type:String,converter:String})],K.prototype,"buttonLabel",2),r([g("#form")],K.prototype,"formComponent",2),K=r([c("nidoca-form-register")],K);var Ut=class extends d{constructor(){super(...arguments);this.code=""}render(){return o``}};Ut.styles=p``,r([s({type:String})],Ut.prototype,"code",2),Ut=r([c("nidoca-upload")],Ut);var Tt=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return o`
      <style>
        .hr {
          border-color: var(--app-color-${this.theme}-border);
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:u,converter:String})],Tt.prototype,"theme",2),r([s({type:String,converter:String})],Tt.prototype,"text",2),Tt=r([c("nidoca-hr")],Tt);var Ht=class extends d{constructor(){super(...arguments);this.text="";this.icon=""}render(){return o`
      <div class="container">
        ${this.icon?o` <nidoca-icon
              slot="graphic"
              icon="${this.icon}"
    ...
    `}static example(t=""){return o`<nidoca-menu-area slot="${t}" icon="gavel" text="Rechtliches"></nidoca-menu-area>`}};Ht.styles=p`
    .container {
      display: flex;
      padding-left: var(--space-2);
      padding-right: var(--space-2);
  ...
  `,r([s({type:String})],Ht.prototype,"text",2),r([s({type:String})],Ht.prototype,"icon",2),Ht=r([c("nidoca-menu-area")],Ht);var q=class extends d{constructor(){super(...arguments);this.text="";this.icon="";this.selected=!1;this.theme="surface"}render(){return o`
      <style>
        .container:hover {
          background-color: var(--app-color-${this.theme}-hover);
        }
  ...
  `,r([s({type:String})],q.prototype,"text",2),r([s({type:String})],q.prototype,"icon",2),r([s({type:Boolean})],q.prototype,"selected",2),r([s({type:String})],q.prototype,"theme",2),q=r([c("nidoca-menu-item")],q);var Ot=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return o` <style>
        :host,
        *,
        ::slotted(*) {
          color: var(--app-color-text-${this.theme});
      ...
      <slot id="slotElement"></slot>`}updated(t){super.updated(t),t.forEach((n,i)=>{if(i=="theme"&&this.slotElement!=null){let l=this.slotElement.assignedElements();for(let m=0;m<l.length;m++){let f=l[m];f instanceof q&&(f.theme=this.theme)}}})}firstUpdated(){this.addEventListener("click",t=>{if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];if(l instanceof q){let m=l.getBoundingClientRect();m.left<t.x&&m.right>t.x&&(m.top<t.y&&m.bottom>t.y?l.selected=!0:l.selected=!1)}}}})}static example(t=""){return o`
  ...
  `,r([s({type:String})],Ot.prototype,"theme",2),r([g("#slotElement")],Ot.prototype,"slotElement",2),Ot=r([c("nidoca-menu")],Ot);var Y=class extends d{constructor(){super(...arguments);this.height="auto";this.width="auto";this.left="auto";this.top="auto";this.right="auto";this.bottom="auto"}render(){return o`
      <slot
        class="floatingContainer"
        style="${this.toStyle(this.height,this.width,this.left,this.right,this.top,this.bottom)}"
      ></slot>
    `}toStyle(t,n,i,l,m,f){return"height:".concat(t).concat(";").concat("width:").concat(n).concat(";").concat("left:").concat(i).concat(";").concat("right:").concat(l).concat(";").concat("top:").concat(m).concat(";").concat("bottom:").concat(f).concat(";")}};Y.styles=p`
    .floatingContainer {
      position: fixed;
      display: inline;
      margin: auto;
  ...
  `,r([s({type:String})],Y.prototype,"height",2),r([s({type:String})],Y.prototype,"width",2),r([s({type:String})],Y.prototype,"left",2),r([s({type:String})],Y.prototype,"top",2),r([s({type:String})],Y.prototype,"right",2),r([s({type:String})],Y.prototype,"bottom",2),Y=r([c("nidoca-layout-floating")],Y);var Wt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return o`
      ${y.getStyle(this.theme)}
      <slot></slot>
    `}};Wt.styles=p`
    :host {
  ...
  `,r([s({type:String})],Wt.prototype,"theme",2),Wt=r([c("nidoca-container")],Wt);var Rt=class extends d{constructor(){super();this.hideSidebox=!0;this.theme=y.prototype.getParentTheme(this)||"plain"}render(){return o` <style>
        .listbox,
        .sidebox {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
      ...
      ${this.hideSidebox?o``:o` <slot class="sidebox" name="sidebox"></slot>`}`}};Rt.styles=p`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: nowrap;
  ...
  `,r([s({type:u,converter:String})],Rt.prototype,"theme",2),r([s({type:Boolean,converter:String})],Rt.prototype,"hideSidebox",2),Rt=r([c("nidoca-split-screen")],Rt);var G=class extends d{constructor(){super(...arguments);this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return o`
      <i
  ...
  `,r([s({type:String})],G.prototype,"icon",2),r([s({type:Boolean})],G.prototype,"clickable",2),r([s({type:Boolean})],G.prototype,"deactivated",2),r([s({type:String})],G.prototype,"title",2),G=r([c("nidoca-icon")],G);var Qt=class extends d{render(){return o`
  ...
  `,r([s({type:String})],j.prototype,"src",2),r([s({type:String})],j.prototype,"width",2),r([s({type:String})],j.prototype,"height",2),r([s({type:Boolean})],j.prototype,"zoom",2),j=r([c("nidoca-img")],j);var It=class extends j{static example(e=""){return o`<nidoca-img-round width="64px" width="64px" slot="${e}" src="face.jpg"></nidoca-img-round>`}};It.styles=p`
    :host {
      font-size: 0;
      display: inline-block;
      box-sizing: border-box;
  ...
  `,It=r([c("nidoca-img-round")],It);var Pt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return o`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
  ...
  `,r([s({type:u,converter:String})],Pt.prototype,"theme",2),r([ur()],Pt.prototype,"selected",2),Pt=r([c("nidoca-img-slider")],Pt);var Kt=class extends d{constructor(){super(...arguments);this.src=""}render(){return o`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
        ...
        ></iframe
      ></span>
    `}};Kt.styles=p``,r([s({type:String})],Kt.prototype,"src",2),Kt=r([c("nidoca-movie")],Kt);var C=class extends d{constructor(){super(...arguments);this.label="";this.placeholder="";this.name="";this.min=1;this.max=10;this.errorText="";this.numberOne=1;this.numberTwo=1}render(){return o`
      <nidoca-form-text
        theme="${T(this.theme)}"
        id="inputfield"
        placeholder="${this.placeholder}"
  ...
  `,r([s({type:u,converter:String})],I.prototype,"theme",2),r([s({type:String})],I.prototype,"primaryText",2),r([s({type:String})],I.prototype,"secondaryText",2),r([s({type:String})],I.prototype,"tertiaryText",2),r([s({type:String})],I.prototype,"infoText",2),r([s({type:Boolean})],I.prototype,"selected",2),I=r([c("nidoca-list-item")],I);var it=class extends d{constructor(){super(...arguments);this.theme="surface";this.text=""}render(){return o`
      <style>
        :host {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background-dark);
  ...
  :host {
     ...
     width:100%;
     box-sizing:border-box;
  `,r([s({type:u,converter:String})],it.prototype,"theme",2),r([s({type:String})],it.prototype,"text",2),it=r([c("nidoca-list-section")],it);var pt=class extends d{constructor(){super(...arguments);this.theme="surface";this.multiselect=!1}updated(t){super.updated(t),t.forEach((n,i)=>{i=="theme"&&this.getItems().forEach(l=>{l.theme=this.theme})})}render(){return o`
      <slot
        @nidoca-event-list-item-clicked="${t=>{if(!this.multiselect){this.unselectAll();let n=t.target;n.selected=!0}}}"
        id="slotElement"
      ></slot>
    `}getItems(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];l instanceof I&&t.push(l)}}return t}getSelectedItems(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];l instanceof I&&l.selected&&t.push(l)}}return t}getSelectedIndexes(){let t=[];if(this.slotElement!=null){let n=this.slotElement.assignedElements(),i=0;for(let l=0;l<n.length;l++){let m=n[l];m instanceof I&&(m.selected&&t.push(i),i++)}}return t}selectAll(){this.getItems().forEach(t=>{t.selected=!0})}unselectAll(){this.getItems().forEach(t=>{t.selected=!1})}static example(){return o`<nidoca-list theme="primary">
  ...
  `,r([s({type:u,converter:String})],pt.prototype,"theme",2),r([s({type:Boolean})],pt.prototype,"multiselect",2),r([g("#slotElement")],pt.prototype,"slotElement",2),pt=r([c("nidoca-list")],pt);var Dt=class extends d{constructor(){super(...arguments);this.theme="plain";this.prominent=!1}render(){return o`
      <style>
        * {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:String,converter:String})],Dt.prototype,"theme",2),r([s({type:Boolean})],Dt.prototype,"prominent",2),Dt=r([c("nidoca-top-app-bar")],Dt);var dt=class extends d{constructor(){super(...arguments);this.headers=["column 1","column 2"];this.rows=[["row 1",new G],["row 2",new G]];this.theme="plain"}render(){return o`
      <style>
        td,
        th {
      ...
      <div>
        <table>
          <thead>
            ${oe([this.headers],()=>o` ${Gt(this.headers,t=>o` <th colspan="1" rowspan="1">${t}</th> `)} `)}
          </thead>
          <tbody>
            ${oe([this.rows],()=>o`
                  ${Gt(this.rows,t=>o`
                        <tr>
                          ${Gt(t,n=>o` <td colspan="1" rowspan="1">${n}</td> `)}
                        </tr>
                      `)}
                `)}
          </tbody>
  ...
  `,r([s({type:Array})],dt.prototype,"headers",2),r([s({type:Array})],dt.prototype,"rows",2),r([s({type:u,converter:String})],dt.prototype,"theme",2),dt=r([c("nidoca-table")],dt);var ht=class extends d{constructor(){super(...arguments);this.selected=!1}render(){return this.selected?o` <slot></slot>`:o``}};ht.styles=p`
    :host,
    slot {
      display: block;
    }
  `,r([s({type:Boolean})],ht.prototype,"selected",2),ht=r([c("nidoca-tab-content")],ht);var X=class extends d{constructor(){super(...arguments);this.selected=!1;this.text="";this.theme="surface"}render(){return o`
      <style>
        .container {
  ...
  `,r([s({type:Boolean})],X.prototype,"selected",2),r([s({type:String})],X.prototype,"text",2),r([s({type:String})],X.prototype,"theme",2),X=r([c("nidoca-tab")],X);var ot=class extends d{constructor(){super(...arguments);this.theme="surface";this.tabIndex=0}render(){return o`
      <div class="container" @nidoca-event-tab-clicked="${t=>this.tabClicked(t)}">
        <slot id="tabSlot" name="tab"></slot>
        <slot id="tabContentSlot" name="tabContent"></slot>
      </div>
    `}firstUpdated(t){super.firstUpdated(t),this.tabIndexChanged()}update(t){super.update(t),t.get("tabIndex")!=null&&this.tabIndexChanged()}tabIndexChanged(){this.updateNidocaTabElements(),this.updateNidocaTabContentElemnts()}updateNidocaTabElements(){if(this.tabSlot!=null){let t=this.tabSlot.assignedElements(),i=100/t.length,l=t[this.tabIndex];for(let m=0;m<t.length;m++){let f=t[m];f instanceof X&&(f.theme=this.theme,f.style.width=String(i).concat("%"),f==l?(f.selected=!0,f.classList.add("SELECTED")):(f.selected=!1,f.classList.remove("SELECTED")))}}}updateNidocaTabContentElemnts(){let t=0;if(this.tabContentSlot!=null){let n=this.tabContentSlot.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];l instanceof ht&&(this.tabIndex==t?l.selected=!0:l.selected=!1,t++)}}}tabClicked(t){let n=t.detail;this.changeTabIndex(n)}changeTabIndex(t){if(!t.selected&&this.tabSlot!=null){let n=this.tabSlot.assignedElements();for(let i=0;i<n.length;i++){let l=n[i];if(l instanceof X&&l==t){this.tabIndex=i;break}}}}static example(t=""){return o`
  ...
  `,r([g("#tabSlot")],ot.prototype,"tabSlot",2),r([g("#tabContentSlot")],ot.prototype,"tabContentSlot",2),r([s({type:String})],ot.prototype,"theme",2),r([s({type:Number})],ot.prototype,"tabIndex",2),ot=r([c("nidoca-tabs")],ot);var ut=class extends d{constructor(){super();this.hideLeft=!0;this.prominent=!1;document.getElementsByTagName("html")[0].setAttribute("oncontextmenu","return false"),this.addEventListener("click",t=>{if(!this.hideLeft&&this.leftElement){console.log("close");let n=this.leftElement.getBoundingClientRect();this.hideLeft=641>window.innerWidth&&0<=t.x-n.width}})}render(){return o`
      <slot
        id="left"
  ...
  `,r([s({type:u,converter:String})],A.prototype,"theme",2),r([s({type:String})],A.prototype,"text",2),A=r([c("nidoca-text")],A);var se=class extends A{render(){return o` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};se.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,se=r([c("nidoca-text-body")],se);var ae=class extends A{render(){return o`${super.render()}`}};ae.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,le=r([c("nidoca-text-overline")],le);var me=class extends A{render(){return o` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};me.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,me=r([c("nidoca-text-subtitle")],me);var $=class extends A{render(){return o`<style>
        slot {
  ...
  `,$=r([c("nidoca-text-caption")],$);var $e=class extends ${render(){return o`<style>
        slot {
          color: var(--app-color-error-background);
        }
      </style>
      <slot>${this.text}</slot>`}};$e=r([c("nidoca-text-error")],$e);var Le=class extends ${render(){return o`<style>
        slot {
          color: var(--app-color-success-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Le=r([c("nidoca-text-success")],Le);var Ve=class extends ${render(){return o`<style>
        slot {
          color: var(--app-color-warning-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ve=r([c("nidoca-text-warning")],Ve);var Me=class extends ${render(){return o`<style>
        slot {
          color: var(--app-color-info-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Me=r([c("nidoca-text-info")],Me);var ce=class extends A{};ce.styles=p`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,fe=r([c("nidoca-text-h6")],fe);var Bt=class extends U{constructor(){super(...arguments);this.message="Dies ist eine Testnachricht"}showToast(t=3e3){this.toastElement.classList.add("show"),setTimeout(()=>{this.hideToast()},t)}hideToast(){this.toastElement.classList.remove("show")}render(){return o`
  ...
  `,r([s({type:String})],Bt.prototype,"message",2),r([g("#toast")],Bt.prototype,"toastElement",2),Bt=r([c("nidoca-toast")],Bt);var F=class extends d{constructor(){super(...arguments);this.value="";this.placeholder="";this.disabled=!1;this.theme="plain"}render(){return o`
      <style>
        .container,
        input {
          color: var(--app-color-text-${this.theme});
  ...
  `,r([s({type:String})],F.prototype,"value",2),r([s({type:String})],F.prototype,"placeholder",2),r([s({type:Boolean})],F.prototype,"disabled",2),r([g("#inputElement")],F.prototype,"inputElement",2),r([s({type:u,converter:String})],F.prototype,"theme",2),F=r([c("nidoca-search-bar")],F);var ge=class{static{this.CENTER="CENTER"}static{this.LEFT="LEFT"}static{this.RIGHT="RIGHT"}static{this.TOP="TOP"}static{this.BOTTOM="BOTTOM"}static{this.SLIDE_CENTER="SLIDE_CENTER"}static{this.SLIDE_LEFT="SLIDE_LEFT"}static{this.SLIDE_RIGHT="SLIDE_RIGHT"}static{this.SLIDE_TOP="SLIDE_TOP"}static{this.SLIDE_BOTTOM="SLIDE_BOTTOM"}},jt=class extends d{constructor(){super(...arguments);this.transitionType=ge.CENTER;this.duration=.5}render(){return o` <div class="${T(this.transitionType)}"><slot></slot></div> `}};jt.styles=p`
  ...
  `,r([s({type:String})],jt.prototype,"transitionType",2),r([s({type:Number})],jt.prototype,"duration",2),jt=r([c("nidoca-transition")],jt);var Yt=class extends d{constructor(){super(...arguments);this.show=!1}render(){return this.show?o`
  ...
  `,r([s({type:Boolean})],Yt.prototype,"show",2),Yt=r([c("nidoca-dialog")],Yt);var _=class extends d{constructor(){super(...arguments);this.show=!1;this.title="Ja oder Nein ?";this.description="Entscheide dich";this.labelButtonYes="Ja";this.labelButtonNo="Nein"}render(){return o`<nidoca-dialog .show="${this.show}">
    ...
    </nidoca-dialog>`}};_.styles=p``,r([s({type:Boolean})],_.prototype,"show",2),r([s({type:String})],_.prototype,"title",2),r([s({type:String})],_.prototype,"description",2),r([s({type:String})],_.prototype,"labelButtonYes",2),r([s({type:String})],_.prototype,"labelButtonNo",2),_=r([c("nidoca-dialog-decision")],_);var Xt=class extends d{constructor(){super(...arguments);this.icon=""}render(){return o`
  ...
  `,r([s({type:String})],Xt.prototype,"icon",2),Xt=r([c("nidoca-infobox")],Xt);var st=class extends d{constructor(){super(...arguments);this.theme="surface";this.src="";this.title="";this.subtitle=""}render(){return o`
            <div
  ...
  `,r([s({type:u,converter:String})],st.prototype,"theme",2),r([s({type:String})],st.prototype,"src",2),r([s({type:String})],st.prototype,"title",2),r([s({type:String})],st.prototype,"subtitle",2),st=r([c("nidoca-avatar")],st);var Zt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return o`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background-light);
          border-color: var(--app-color-${this.theme}-border);
  ...
  `,r([s({type:u,converter:String})],Zt.prototype,"theme",2),Zt=r([c("nidoca-card")],Zt);var xe=class extends d{render(){return o`
      <nidoca-layout-spacer bottom="var(--space)" left="">
        <slot id="slotElement" @slotchange="${e=>this.slotChanged(e)}"></slot>
      </nidoca-layout-spacer>
    `}slotChanged(e){let t=e.target;if(t==null)return;let n=t.assignedElements();for(let i=0;i<n.length;i++){let m=n[i].classList;m.contains("flexItem")||m.add("flexItem"),m.contains("flexItemDevice")||m.add("flexItemDevice")}}};xe.styles=p`
    slot,
    ::slotted(slot) {
      display: flex;
      flex-direction: row;
  ...
  `,xe=r([c("nidoca-gallery")],xe);var be=class extends d{render(){return o`<slot></slot>`}print(){let e=window.open("");e&&(e.document.write(this.innerHTML),e.print(),e.close())}};be.styles=p`
    :host {
      display: none;
    }
  `,be=r([c("nidoca-print")],be);var ye=class extends d{render(){return o`
  ...
  `,ye=r([c("nidoca-section")],ye);var Jt=class extends d{constructor(){super(...arguments);this.cards=[]}render(){return o`
      <div class="container">
        ${this.cards.map(t=>o`
  ...
  `,r([s({type:Array})],Jt.prototype,"cards",2),Jt=r([c("nidoca-dashboard")],Jt);var Ft=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return o`
      ${y.getStyle(this.theme)}
      <slot></slot>
    `}};Ft.styles=p`
    :host {
  ...
  `,r([s({type:u,converter:String})],Ft.prototype,"theme",2),Ft=r([c("nidoca-box")],Ft);var L=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Deine Nachricht";this.nameLabel="Dein Name";this.emailLabel="Deine Email";this.titleLabel="Betreff";this.messageLabel="Deine Nachricht";this.buttonLabel="Senden"}render(){return o`
      <nidoca-box theme="${T(this.theme)}">
