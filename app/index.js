"use strict";(()=>{var Dr=Object.defineProperty;var Lr=Object.getOwnPropertyDescriptor;var r=(a,e,t,o)=>{for(var i=o>1?void 0:o?Lr(e,t):e,l=a.length-1,c;l>=0;l--)(c=a[l])&&(i=(o?c(e,t,i):c(i))||i);return o&&i&&Dr(e,t,i),i};var _=class a{constructor(){this.listeners=[];window.onpopstate=e=>{console.trace("onpopstate event: location: "+document.location+", state: "+JSON.stringify(e.state)),this.notifyListeners()},document.addEventListener("click",e=>{if(!this.shouldIgnoreEvent(e)){let t=this.getAnchor(e);t&&!this.shouldIgnoreAnchor(t)&&(e.preventDefault(),t.hash.length>0&&this.navigate(t.hash))}})}static getUniqueInstance(){return a.uniqueInstance||(a.uniqueInstance=new a),a.uniqueInstance}subscribe(e){console.trace("subscribe router listener"),this.listeners.push(e)}back(){history.back()}forward(){history.forward()}navigate(e,t=null){if(e.indexOf("#")==-1&&(e="#".concat(e)),console.trace("navigate to: %s",e),t!=null&&console.trace("state: %s",JSON.stringify(t)),document.location.hash===e){console.trace("you are already on page: "+e);return}history.pushState(t,"",e),this.notifyListeners()}getCurrentState(){return history.state}getStateProperty(e){let t=this.getCurrentState();return t!=null?t[e]:null}getCurrentPage(){return document.location.hash.replace("#","")}getHash(){return document.location.hash}notifyListeners(){let e=this.getCurrentPage();this.listeners.forEach(t=>t.routeChanged(e))}shouldIgnoreEvent(e){return e.defaultPrevented||e.button!==0||e.shiftKey||e.ctrlKey||e.altKey||e.metaKey}getAnchor(e){for(let o of e.composedPath?e.composedPath():[])if(this.isAnchor(o))return o;let t=e.target;for(;t&&!this.isAnchor(t);)t=t.parentNode;return t&&this.isAnchor(t)?t:null}isAnchor(e){return e.nodeName&&e.nodeName.toLowerCase()==="a"}shouldIgnoreAnchor(e){return!!(e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||(e.origin||this.getAnchorOrigin(e))!==window.location.origin)}getAnchorOrigin(e){let t=e.port,o=e.protocol,c=o==="http:"&&t==="80"||o==="https:"&&t==="443"?e.hostname:e.host;return`${o}//${c}`}};var Ce=class{static generateImageBase64(e,t,o){let i=document.createElement("canvas");i.width=128,i.height=128;let l=i.getContext("2d");if(!l)throw new Error("Canvas context is not available");l.fillStyle=o,l.fillRect(0,0,i.width,i.height),l.fillStyle=t;let c=document.body,h=getComputedStyle(c).getPropertyValue("--font-family")||"Arial";l.font=`bold 64px ${h}`,l.textAlign="center",l.textBaseline="alphabetic";let A=e.charAt(0).toUpperCase(),S=l.measureText(A),y=S.actualBoundingBoxAscent-S.actualBoundingBoxDescent;return l.fillText(A,i.width/2,i.height/2+y/2),i.toDataURL("image/png")}};var Pe=globalThis,ze=Pe.ShadowRoot&&(Pe.ShadyCSS===void 0||Pe.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ar=Symbol(),gr=new WeakMap,re=class{constructor(e,t,o){if(this._$cssResult$=!0,o!==ar)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(ze&&e===void 0){let o=t!==void 0&&t.length===1;o&&(e=gr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),o&&gr.set(t,e))}return e}toString(){return this.cssText}},yr=a=>new re(typeof a=="string"?a:a+"",void 0,ar),m=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((o,i,l)=>o+(c=>{if(c._$cssResult$===!0)return c.cssText;if(typeof c=="number")return c;throw Error("Value passed to 'css' function must be a 'css' function result: "+c+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[l+1],a[0]);return new re(t,a,ar)},lr=(a,e)=>{if(ze)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let o=document.createElement("style"),i=Pe.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=t.cssText,a.appendChild(o)}},je=ze?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let o of e.cssRules)t+=o.cssText;return yr(t)})(a):a;var{is:Mr,defineProperty:Vr,getOwnPropertyDescriptor:Gr,getOwnPropertyNames:qr,getOwnPropertySymbols:Ur,getPrototypeOf:Kr}=Object,We=globalThis,br=We.trustedTypes,Qr=br?br.emptyScript:"",Yr=We.reactiveElementPolyfillSupport,oe=(a,e)=>a,ne={toAttribute(a,e){switch(e){case Boolean:a=a?Qr:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},De=(a,e)=>!Mr(a,e),xr={attribute:!0,type:String,converter:ne,reflect:!1,hasChanged:De};Symbol.metadata??=Symbol("metadata"),We.litPropertyMetadata??=new WeakMap;var ft=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=xr){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){let o=Symbol(),i=this.getPropertyDescriptor(e,o,t);i!==void 0&&Vr(this.prototype,e,i)}}static getPropertyDescriptor(e,t,o){let{get:i,set:l}=Gr(this.prototype,e)??{get(){return this[t]},set(c){this[t]=c}};return{get(){return i?.call(this)},set(c){let u=i?.call(this);l.call(this,c),this.requestUpdate(e,u,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??xr}static _$Ei(){if(this.hasOwnProperty(oe("elementProperties")))return;let e=Kr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(oe("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(oe("properties"))){let t=this.properties,o=[...qr(t),...Ur(t)];for(let i of o)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[o,i]of t)this.elementProperties.set(o,i)}this._$Eh=new Map;for(let[t,o]of this.elementProperties){let i=this._$Eu(t,o);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let o=new Set(e.flat(1/0).reverse());for(let i of o)t.unshift(je(i))}else e!==void 0&&t.push(je(e));return t}static _$Eu(e,t){let o=t.attribute;return o===!1?void 0:typeof o=="string"?o:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let o of t.keys())this.hasOwnProperty(o)&&(e.set(o,this[o]),delete this[o]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return lr(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,o){this._$AK(e,o)}_$EC(e,t){let o=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,o);if(i!==void 0&&o.reflect===!0){let l=(o.converter?.toAttribute!==void 0?o.converter:ne).toAttribute(t,o.type);this._$Em=e,l==null?this.removeAttribute(i):this.setAttribute(i,l),this._$Em=null}}_$AK(e,t){let o=this.constructor,i=o._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let l=o.getPropertyOptions(i),c=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:ne;this._$Em=i,this[i]=c.fromAttribute(t,l.type),this._$Em=null}}requestUpdate(e,t,o){if(e!==void 0){if(o??=this.constructor.getPropertyOptions(e),!(o.hasChanged??De)(this[e],t))return;this.P(e,t,o)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,t,o){this._$AL.has(e)||this._$AL.set(e,t),o.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,l]of this._$Ep)this[i]=l;this._$Ep=void 0}let o=this.constructor.elementProperties;if(o.size>0)for(let[i,l]of o)l.wrapped!==!0||this._$AL.has(i)||this[i]===void 0||this.P(i,this[i],l)}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(t)):this._$EU()}catch(o){throw e=!1,this._$EU(),o}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(t=>this._$EC(t,this[t])),this._$EU()}updated(e){}firstUpdated(e){}};ft.elementStyles=[],ft.shadowRootOptions={mode:"open"},ft[oe("elementProperties")]=new Map,ft[oe("finalized")]=new Map,Yr?.({ReactiveElement:ft}),(We.reactiveElementVersions??=[]).push("2.0.4");var mr=globalThis,Le=mr.trustedTypes,vr=Le?Le.createPolicy("lit-html",{createHTML:a=>a}):void 0,cr="$lit$",gt=`lit$${Math.random().toFixed(9).slice(2)}$`,dr="?"+gt,Xr=`<${dr}>`,Ht=document,se=()=>Ht.createComment(""),ae=a=>a===null||typeof a!="object"&&typeof a!="function",hr=Array.isArray,Sr=a=>hr(a)||typeof a?.[Symbol.iterator]=="function",pr=`[ 	
\f\r]`,ie=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ar=/-->/g,wr=/>/g,Tt=RegExp(`>|${pr}(?:([^\\s"'>=/]+)(${pr}*=${pr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),kr=/'/g,Er=/"/g,Hr=/^(?:script|style|textarea|title)$/i,ur=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),n=ur(1),mo=ur(2),co=ur(3),Y=Symbol.for("lit-noChange"),R=Symbol.for("lit-nothing"),Tr=new WeakMap,St=Ht.createTreeWalker(Ht,129);function Rr(a,e){if(!hr(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return vr!==void 0?vr.createHTML(e):e}var $r=(a,e)=>{let t=a.length-1,o=[],i,l=e===2?"<svg>":e===3?"<math>":"",c=ie;for(let u=0;u<t;u++){let h=a[u],A,S,y=-1,k=0;for(;k<h.length&&(c.lastIndex=k,S=c.exec(h),S!==null);)k=c.lastIndex,c===ie?S[1]==="!--"?c=Ar:S[1]!==void 0?c=wr:S[2]!==void 0?(Hr.test(S[2])&&(i=RegExp("</"+S[2],"g")),c=Tt):S[3]!==void 0&&(c=Tt):c===Tt?S[0]===">"?(c=i??ie,y=-1):S[1]===void 0?y=-2:(y=c.lastIndex-S[2].length,A=S[1],c=S[3]===void 0?Tt:S[3]==='"'?Er:kr):c===Er||c===kr?c=Tt:c===Ar||c===wr?c=ie:(c=Tt,i=void 0);let b=c===Tt&&a[u+1].startsWith("/>")?" ":"";l+=c===ie?h+Xr:y>=0?(o.push(A),h.slice(0,y)+cr+h.slice(y)+gt+b):h+gt+(y===-2?u:b)}return[Rr(a,l+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),o]},le=class a{constructor({strings:e,_$litType$:t},o){let i;this.parts=[];let l=0,c=0,u=e.length-1,h=this.parts,[A,S]=$r(e,t);if(this.el=a.createElement(A,o),St.currentNode=this.el.content,t===2||t===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(i=St.nextNode())!==null&&h.length<u;){if(i.nodeType===1){if(i.hasAttributes())for(let y of i.getAttributeNames())if(y.endsWith(cr)){let k=S[c++],b=i.getAttribute(y).split(gt),O=/([.?@])?(.*)/.exec(k);h.push({type:1,index:l,name:O[2],strings:b,ctor:O[1]==="."?Ve:O[1]==="?"?Ge:O[1]==="@"?qe:$t}),i.removeAttribute(y)}else y.startsWith(gt)&&(h.push({type:6,index:l}),i.removeAttribute(y));if(Hr.test(i.tagName)){let y=i.textContent.split(gt),k=y.length-1;if(k>0){i.textContent=Le?Le.emptyScript:"";for(let b=0;b<k;b++)i.append(y[b],se()),St.nextNode(),h.push({type:2,index:++l});i.append(y[k],se())}}}else if(i.nodeType===8)if(i.data===dr)h.push({type:2,index:l});else{let y=-1;for(;(y=i.data.indexOf(gt,y+1))!==-1;)h.push({type:7,index:l}),y+=gt.length-1}l++}}static createElement(e,t){let o=Ht.createElement("template");return o.innerHTML=e,o}};function Rt(a,e,t=a,o){if(e===Y)return e;let i=o!==void 0?t._$Co?.[o]:t._$Cl,l=ae(e)?void 0:e._$litDirective$;return i?.constructor!==l&&(i?._$AO?.(!1),l===void 0?i=void 0:(i=new l(a),i._$AT(a,t,o)),o!==void 0?(t._$Co??=[])[o]=i:t._$Cl=i),i!==void 0&&(e=Rt(a,i._$AS(a,e.values),i,o)),e}var Me=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:o}=this._$AD,i=(e?.creationScope??Ht).importNode(t,!0);St.currentNode=i;let l=St.nextNode(),c=0,u=0,h=o[0];for(;h!==void 0;){if(c===h.index){let A;h.type===2?A=new qt(l,l.nextSibling,this,e):h.type===1?A=new h.ctor(l,h.name,h.strings,this,e):h.type===6&&(A=new Ue(l,this,e)),this._$AV.push(A),h=o[++u]}c!==h?.index&&(l=St.nextNode(),c++)}return St.currentNode=Ht,i}p(e){let t=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}},qt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,i){this.type=2,this._$AH=R,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Rt(this,e,t),ae(e)?e===R||e==null||e===""?(this._$AH!==R&&this._$AR(),this._$AH=R):e!==this._$AH&&e!==Y&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Sr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==R&&ae(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ht.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:o}=e,i=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=le.createElement(Rr(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===i)this._$AH.p(t);else{let l=new Me(i,this),c=l.u(this.options);l.p(t),this.T(c),this._$AH=l}}_$AC(e){let t=Tr.get(e.strings);return t===void 0&&Tr.set(e.strings,t=new le(e)),t}k(e){hr(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,o,i=0;for(let l of e)i===t.length?t.push(o=new a(this.O(se()),this.O(se()),this,this.options)):o=t[i],o._$AI(l),i++;i<t.length&&(this._$AR(o&&o._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let o=e.nextSibling;e.remove(),e=o}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},$t=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,i,l){this.type=1,this._$AH=R,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=l,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=R}_$AI(e,t=this,o,i){let l=this.strings,c=!1;if(l===void 0)e=Rt(this,e,t,0),c=!ae(e)||e!==this._$AH&&e!==Y,c&&(this._$AH=e);else{let u=e,h,A;for(e=l[0],h=0;h<l.length-1;h++)A=Rt(this,u[o+h],t,h),A===Y&&(A=this._$AH[h]),c||=!ae(A)||A!==this._$AH[h],A===R?e=R:e!==R&&(e+=(A??"")+l[h+1]),this._$AH[h]=A}c&&!i&&this.j(e)}j(e){e===R?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Ve=class extends $t{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===R?void 0:e}},Ge=class extends $t{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==R)}},qe=class extends $t{constructor(e,t,o,i,l){super(e,t,o,i,l),this.type=5}_$AI(e,t=this){if((e=Rt(this,e,t,0)??R)===Y)return;let o=this._$AH,i=e===R&&o!==R||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,l=e!==R&&(o===R||i);i&&this.element.removeEventListener(this.name,this,o),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ue=class{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){Rt(this,e)}},Or={M:cr,P:gt,A:dr,C:1,L:$r,R:Me,D:Sr,V:Rt,I:qt,H:$t,N:Ge,U:qe,B:Ve,F:Ue},Zr=mr.litHtmlPolyfillSupport;Zr?.(le,qt),(mr.litHtmlVersions??=[]).push("3.2.1");var Ir=(a,e,t)=>{let o=t?.renderBefore??e,i=o._$litPart$;if(i===void 0){let l=t?.renderBefore??null;o._$litPart$=i=new qt(e.insertBefore(se(),l),l,void 0,t??{})}return i._$AI(a),i};var D=class extends ft{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ir(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Y}};D._$litElement$=!0,D.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:D});var Jr=globalThis.litElementPolyfillSupport;Jr?.({LitElement:D});(globalThis.litElementVersions??=[]).push("4.1.1");var f=(i=>(i.primary="primary",i.secondary="secondary",i.surface="surface",i.plain="plain",i))(f||{}),x=class{static getStyle(e){return e?e=="plain"?n``:n` <style>
            :host,
            *,
            ::slotted(*) {
          ...
          </style>`:n``}static getOposite(e){return e=="plain"?"surface":e=="primary"||e=="primary"?"secondary":e=="secondary"?"primary":"plain"}getParentTheme(e){let t=e;for(;t!=null;){if(t.theme!=null)return t.theme;t=t.parentElement}}};var d=class extends D{};var p=a=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(a,e)}):customElements.define(a,e)};var Fr={attribute:!0,type:String,converter:ne,reflect:!1,hasChanged:De},Nr=(a=Fr,e,t)=>{let{kind:o,metadata:i}=t,l=globalThis.litPropertyMetadata.get(i);if(l===void 0&&globalThis.litPropertyMetadata.set(i,l=new Map),l.set(t.name,a),o==="accessor"){let{name:c}=t;return{set(u){let h=e.get.call(this);e.set.call(this,u),this.requestUpdate(c,h,a)},init(u){return u!==void 0&&this.P(c,void 0,a),u}}}if(o==="setter"){let{name:c}=t;return function(u){let h=this[c];e.call(this,u),this.requestUpdate(c,h,a)}}throw Error("Unsupported decorator location: "+o)};function s(a){return(e,t)=>typeof t=="object"?Nr(a,e,t):((o,i,l)=>{let c=i.hasOwnProperty(l);return i.constructor.createProperty(l,c?{...o,wrapped:!0}:o),c?Object.getOwnPropertyDescriptor(i,l):void 0})(a,e,t)}function Ke(a){return s({...a,state:!0,attribute:!1})}var Ot=(a,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,t),t);function g(a,e){return(t,o,i)=>{let l=c=>c.renderRoot?.querySelector(a)??null;if(e){let{get:c,set:u}=typeof o=="object"?t:i??(()=>{let h=Symbol();return{get(){return this[h]},set(A){this[h]=A}}})();return Ot(t,o,{get(){let h=c.call(this);return h===void 0&&(h=l(this),(h!==null||this.hasUpdated)&&u.call(this,h)),h}})}return Ot(t,o,{get(){return l(this)}})}}var tt=class extends d{constructor(){super(...arguments);this.theme="surface";this.header="";this.opened=!1}render(){return n`
  ...
  `,r([s({type:f,converter:String})],et.prototype,"theme",2),r([s({type:Br,converter:String})],et.prototype,"accordionType",2),r([g("#accordionSlot")],et.prototype,"accordionSlot",2),et=r([p("nidoca-accordion")],et);var P=class extends d{constructor(){super(...arguments);this.theme="primary";this.endpoint="";this.primaryTextField="";this.secondaryTextField="";this.tertiaryTextField="";this.infoTextField="";this.groupByField="";this.imgSrcField="";this.rightIcon="";this.data=[]}connectedCallback(){super.connectedCallback(),this.fetchData()}async fetchData(){if(this.endpoint)try{let t=await fetch(this.endpoint);if(!t.ok)throw new Error(`Failed to fetch data: ${t.status}`);this.data=await t.json()}catch(t){console.error("Error fetching data:",t)}}render(){if(!this.data.length)return n`<p>Loading data...</p>`;if(this.groupByField){let t=this.data.reduce((o,i)=>{let l=i[this.groupByField]||"UNBEKANNT";return o[l]||(o[l]=[]),o[l].push(i),o},{});return n`
          ...
          `}renderImg(t,o){return o==null||o==null||o==""?Ce.generateImageBase64(t,"#555555","#ffffff"):o}itemClicked(t){this.dispatchEvent(new CustomEvent("nidoca-event-nidoca-api-list-item-clicked",{detail:t,bubbles:!0,composed:!0}))}static example(t=""){return n`
          <nidoca-api-list 
            theme="primary"
            slot="${t}"
        ...
        `}};r([s({type:f,converter:String})],P.prototype,"theme",2),r([s({type:String})],P.prototype,"endpoint",2),r([s({type:String})],P.prototype,"primaryTextField",2),r([s({type:String})],P.prototype,"secondaryTextField",2),r([s({type:String})],P.prototype,"tertiaryTextField",2),r([s({type:String})],P.prototype,"infoTextField",2),r([s({type:String})],P.prototype,"groupByField",2),r([s({type:String})],P.prototype,"imgSrcField",2),r([s({type:String})],P.prototype,"rightIcon",2),r([Ke()],P.prototype,"data",2),P=r([p("nidoca-api-list")],P);var L=class extends d{constructor(){super(...arguments);this.theme="primary";this.shadowType="shadow_1";this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return n`
      <style>
        .iconExtended {
  ...
  `,r([s({type:String})],X.prototype,"icon",2),r([s({type:String})],X.prototype,"primaryText",2),r([s({type:Number})],X.prototype,"state",2),r([s({type:Boolean})],X.prototype,"isLast",2),X=r([p("nidoca-wizard-step")],X);var Ut=class extends d{render(){return n`
      <div
    ...
    `}slotChanged(e){let t=e.target;if(t==null)return;let o=t.assignedElements(),i=0;for(let l=0;l<o.length;l++){let c=o[l];c instanceof X&&(c.index=l,c.state==0&&(i=l),c.index==o.length-1&&(c.isLast=!0))}this.changeState(i)}stepClicked(e){let t=e.detail;console.debug("wizard step clicked, selectedStepIndex: %s",t),this.changeState(t)}changeState(e){if(this.wizardSlot){let t=this.wizardSlot.assignedElements();for(let o=0;o<t.length;o++){let i=t[o];i instanceof X&&i.index!==void 0&&(i.index<e?i.state=1:i.index==e?i.state=0:i.state=2)}}}};Ut.styles=m``,r([g("#wizardSlot")],Ut.prototype,"wizardSlot",2),Ut=r([p("nidoca-wizard")],Ut);var rt=class extends d{constructor(){super(...arguments);this.clickable=!0;this.theme="surface";this.text=""}render(){return n`
      <style>
        .chip:hover {
  ...
  `,r([s({type:String})],at.prototype,"code",2),r([s({type:String})],at.prototype,"theme",2),at=r([p("nidoca-code")],at);var It=class extends d{constructor(){super();this.show=!1;addEventListener("click",t=>{let o=this.associatedElement?.getBoundingClientRect();o&&(o.top>t.clientY||o.right<t.clientX||o.left>t.clientX||o.bottom<t.clientY)&&this.dispatchEvent(new CustomEvent("nidoca-elevation-event-closeme",{detail:this,bubbles:!0,composed:!0}))})}render(){return this.show?n`
  ...
  `,r([s({type:Boolean})],It.prototype,"show",2),r([s({type:Object})],It.prototype,"associatedElement",2),It=r([p("nidoca-elevation")],It);var Qe=class{static{this.PROGRESS="PROGRESS"}static{this.PROGRESS_CIRCULAR="PROGRESS_CIRCULAR"}},Bt=class extends d{constructor(){super(...arguments);this.progressType=Qe.PROGRESS}render(){return n` <style>
      ...
      <progress class="${this.progressType}"></progress>`}};Bt.styles=m``,r([s({type:f,converter:String})],Bt.prototype,"theme",2),r([s({type:Qe,converter:String})],Bt.prototype,"progressType",2),Bt=r([p("nidoca-progress")],Bt);var Ye=(o=>(o.contained="contained",o.outlined="outlined",o.text="text",o))(Ye||{}),Z=class extends d{constructor(){super(...arguments);this.theme="primary";this.buttonType="contained";this.icon="";this.text=""}render(){return n`
      <style>
        .outlined {
          color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:f,converter:String})],Z.prototype,"theme",2),r([s({type:Ye,converter:String})],Z.prototype,"buttonType",2),r([s({type:String})],Z.prototype,"icon",2),r([s({type:String})],Z.prototype,"text",2),Z=r([p("nidoca-button")],Z);var M=class extends d{};var Ct=class extends d{constructor(){super(...arguments);this.autocomplete=!0}render(){return n`
  ...
  `,r([s({type:Boolean})],Ct.prototype,"autocomplete",2),r([g("#slotElement")],Ct.prototype,"slotElement",2),Ct=r([p("nidoca-form")],Ct);var Cr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Xe=a=>(...e)=>({_$litDirective$:a,values:e}),Kt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:_r}=Or;var Pr=()=>document.createComment(""),Qt=(a,e,t)=>{let o=a._$AA.parentNode,i=e===void 0?a._$AB:e._$AA;if(t===void 0){let l=o.insertBefore(Pr(),i),c=o.insertBefore(Pr(),i);t=new _r(l,c,a,a.options)}else{let l=t._$AB.nextSibling,c=t._$AM,u=c!==a;if(u){let h;t._$AQ?.(a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==c._$AU&&t._$AP(h)}if(l!==i||u){let h=t._$AA;for(;h!==l;){let A=h.nextSibling;o.insertBefore(h,i),h=A}}}return t},bt=(a,e,t=a)=>(a._$AI(e,t),a),to={},zr=(a,e=to)=>a._$AH=e,jr=a=>a._$AH,Ze=a=>{a._$AP?.(!1,!0);let e=a._$AA,t=a._$AB.nextSibling;for(;e!==t;){let o=e.nextSibling;e.remove(),e=o}};var Wr=(a,e,t)=>{let o=new Map;for(let i=e;i<=t;i++)o.set(a[i],i);return o},xt=Xe(class extends Kt{constructor(a){if(super(a),a.type!==Cr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let o;t===void 0?t=e:e!==void 0&&(o=e);let i=[],l=[],c=0;for(let u of a)i[c]=o?o(u,c):c,l[c]=t(u,c),c++;return{values:l,keys:i}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,o]){let i=jr(a),{values:l,keys:c}=this.dt(e,t,o);if(!Array.isArray(i))return this.ut=c,l;let u=this.ut??=[],h=[],A,S,y=0,k=i.length-1,b=0,O=l.length-1;for(;y<=k&&b<=O;)if(i[y]===null)y++;else if(i[k]===null)k--;else if(u[y]===c[b])h[b]=bt(i[y],l[b]),y++,b++;else if(u[k]===c[O])h[O]=bt(i[k],l[O]),k--,O--;else if(u[y]===c[O])h[O]=bt(i[y],l[O]),Qt(a,h[O+1],i[y]),y++,O--;else if(u[k]===c[b])h[b]=bt(i[k],l[b]),Qt(a,i[y],i[k]),k--,b++;else if(A===void 0&&(A=Wr(c,b,O),S=Wr(u,y,k)),A.has(u[y]))if(A.has(u[k])){let ut=S.get(c[b]),sr=ut!==void 0?i[ut]:null;if(sr===null){let fr=Qt(a,i[y]);bt(fr,l[b]),h[b]=fr}else h[b]=bt(sr,l[b]),Qt(a,i[y],sr),i[ut]=null;b++}else Ze(i[k]),k--;else Ze(i[y]),y++;for(;b<=O;){let ut=Qt(a,h[O+1]);bt(ut,l[b]),h[b++]=ut}for(;y<=k;){let ut=i[y++];ut!==null&&Ze(ut)}return this.ut=c,zr(a,h),Y}});var eo={},Pt=Xe(class extends Kt{constructor(){super(...arguments),this.ot=eo}render(a,e){return e()}update(a,[e,t]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((o,i)=>o===this.ot[i]))return Y}else if(this.ot===e)return Y;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,t)}});var E=class extends M{constructor(){super(...arguments);this.theme="surface";this.trailingIcon="";this.label="";this.errorText="";this.infoText="";this.warningText="";this.value="";this.options=[];this.name="";this.required=!0;this.multiple=!1;this.size=1}render(){return n` <style>
        .parentContainer,
...
${this.value}</textarea
  ...
  `,r([s({type:f,converter:String})],zt.prototype,"theme",2),r([g("#inputElement")],zt.prototype,"inputElement",2),zt=r([p("nidoca-form-upload")],zt);var j=class extends M{constructor(){super();this.name="";this.label="";this.infoText="";this.errorText="";this.warningText="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="primary";this.theme=x.prototype.getParentTheme(this)||"plain"}render(){return n`
      <style>
        .slider {
  ...
  `,r([s({type:f,converter:String})],nt.prototype,"theme",2),r([s({type:String,converter:String})],nt.prototype,"label",2),r([s({type:String,converter:String})],nt.prototype,"emailLabel",2),r([s({type:String,converter:String})],nt.prototype,"passwordLabel",2),r([s({type:String,converter:String})],nt.prototype,"buttonLabel",2),r([g("#form")],nt.prototype,"formComponent",2),nt=r([p("nidoca-form-register")],nt);var Yt=class extends d{constructor(){super(...arguments);this.code=""}render(){return n``}};Yt.styles=m``,r([s({type:String})],Yt.prototype,"code",2),Yt=r([p("nidoca-upload")],Yt);var jt=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return n`
      <style>
        .hr {
          border-color: var(--app-color-${this.theme}-border);
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:f,converter:String})],jt.prototype,"theme",2),r([s({type:String,converter:String})],jt.prototype,"text",2),jt=r([p("nidoca-hr")],jt);var mt=class extends d{constructor(){super(...arguments);this.text="";this.icon=""}render(){return n`
      <div class="container">
        ${this.icon?n` <nidoca-icon
              slot="graphic"
              icon="${this.icon}"
  ...
  `,r([s({type:String})],it.prototype,"height",2),r([s({type:String})],it.prototype,"width",2),r([s({type:String})],it.prototype,"left",2),r([s({type:String})],it.prototype,"top",2),r([s({type:String})],it.prototype,"right",2),r([s({type:String})],it.prototype,"bottom",2),it=r([p("nidoca-layout-floating")],it);var Xt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return n`
      ${x.getStyle(this.theme)}
      <slot></slot>
    `}};Xt.styles=m`
    :host {
  ...
  `,r([s({type:f,converter:String})],Wt.prototype,"theme",2),r([s({type:Boolean,converter:String})],Wt.prototype,"hideSidebox",2),Wt=r([p("nidoca-split-screen")],Wt);var C=class extends d{constructor(){super(...arguments);this.icon="";this.clickable=!0;this.deactivated=!1;this.title=""}render(){return n`
      <i
  ...
  `,r([s({type:String})],C.prototype,"icon",2),r([s({type:Boolean})],C.prototype,"clickable",2),r([s({type:Boolean})],C.prototype,"deactivated",2),r([s({type:String})],C.prototype,"title",2),C=r([p("nidoca-icon")],C);var Zt=class extends d{render(){return n`
  ...
  `,J=r([p("nidoca-img-round")],J);var Dt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return n`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
  ...
  `,r([s({type:f,converter:String})],Dt.prototype,"theme",2),r([Ke()],Dt.prototype,"selected",2),Dt=r([p("nidoca-img-slider")],Dt);var Jt=class extends d{constructor(){super(...arguments);this.src=""}render(){return n`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
        ...
        ></iframe
      ></span>
    `}};Jt.styles=m``,r([s({type:String})],Jt.prototype,"src",2),Jt=r([p("nidoca-movie")],Jt);var G=class extends d{constructor(){super(...arguments);this.label="";this.placeholder="";this.name="";this.min=1;this.max=10;this.errorText="";this.numberOne=1;this.numberTwo=1}render(){return n`
      <nidoca-form-text
        theme="${$(this.theme)}"
        id="inputfield"
        placeholder="${this.placeholder}"
  ...
  `,r([s({type:f,converter:String})],G.prototype,"theme",2),r([s({type:String})],G.prototype,"label",2),r([s({type:String})],G.prototype,"placeholder",2),r([s({type:String})],G.prototype,"name",2),r([s({type:Number})],G.prototype,"min",2),r([s({type:Number})],G.prototype,"max",2),r([s({type:String})],G.prototype,"errorText",2),r([g("#inputfield")],G.prototype,"inputfield",2),G=r([p("nidoca-form-captcha")],G);var vt=class extends d{constructor(){super(...arguments);this.text="";this.href="";this.targetType="_self"}render(){return n`<a href="${this.href}" .target="${this.targetType}">
  ...
  `,r([s({type:f,converter:String})],q.prototype,"theme",2),r([s({type:Boolean})],q.prototype,"multiselect",2),r([g("#slotElement")],q.prototype,"slotElement",2),q=r([p("nidoca-list")],q);var dt=class extends d{constructor(){super(...arguments);this.theme="primary";this.prominent=!1}render(){return n`
      <style>
        * {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:String,converter:String})],dt.prototype,"theme",2),r([s({type:Boolean})],dt.prototype,"prominent",2),dt=r([p("nidoca-top-app-bar")],dt);var At=class extends d{constructor(){super(...arguments);this.headers=["column 1","column 2"];this.rows=[["row 1",new C],["row 2",new C]];this.theme="plain"}render(){return n`
      <style>
        td,
        th {
      ...
      <div>
        <table>
          <thead>
            ${Pt([this.headers],()=>n` ${xt(this.headers,t=>n` <th colspan="1" rowspan="1">${t}</th> `)} `)}
          </thead>
          <tbody>
            ${Pt([this.rows],()=>n`
                  ${xt(this.rows,t=>n`
  ...
  `,r([s({type:Boolean})],wt.prototype,"selected",2),wt=r([p("nidoca-tab-content")],wt);var st=class extends d{constructor(){super(...arguments);this.selected=!1;this.text="";this.theme="surface"}render(){return n`
      <style>
        .container {
  ...
  `,r([g("#tabSlot")],F.prototype,"tabSlot",2),r([g("#tabContentSlot")],F.prototype,"tabContentSlot",2),r([s({type:String})],F.prototype,"theme",2),r([s({type:Number})],F.prototype,"tabIndex",2),F=r([p("nidoca-tabs")],F);var kt=class extends d{constructor(){super();this.hideLeft=!0;this.prominent=!1;document.getElementsByTagName("html")[0].setAttribute("oncontextmenu","return false"),this.addEventListener("click",t=>{if(!this.hideLeft&&this.leftElement){console.log("close");let o=this.leftElement.getBoundingClientRect();this.hideLeft=641>window.innerWidth&&0<=t.x-o.width}})}render(){return n`
      <slot
        id="left"
  ...
  `,de=r([p("nidoca-text-subtitle")],de);var U=class extends v{render(){return n`<style>
        slot {
  ...
  `,U=r([p("nidoca-text-caption")],U);var Fe=class extends U{render(){return n`<style>
        slot {
          color: var(--app-color-error-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Fe=r([p("nidoca-text-error")],Fe);var Ne=class extends U{render(){return n`<style>
        slot {
          color: var(--app-color-success-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ne=r([p("nidoca-text-success")],Ne);var _e=class extends U{render(){return n`<style>
        slot {
          color: var(--app-color-warning-background);
        }
      </style>
      <slot>${this.text}</slot>`}};_e=r([p("nidoca-text-warning")],_e);var tr=class extends U{render(){return n`<style>
        slot {
  ...
  `,be=r([p("nidoca-text-h6")],be);var K=class extends d{constructor(){super(...arguments);this.value="";this.placeholder="";this.disabled=!1;this.theme="surface"}render(){return n`
      <style>
        .container,
        input {
          color: var(--app-color-text-${this.theme});
  ...
  `,r([s({type:String})],K.prototype,"value",2),r([s({type:String})],K.prototype,"placeholder",2),r([s({type:Boolean})],K.prototype,"disabled",2),r([g("#inputElement")],K.prototype,"inputElement",2),r([s({type:f,converter:String})],K.prototype,"theme",2),K=r([p("nidoca-search-bar")],K);var xe=class{static{this.CENTER="CENTER"}static{this.LEFT="LEFT"}static{this.RIGHT="RIGHT"}static{this.TOP="TOP"}static{this.BOTTOM="BOTTOM"}static{this.SLIDE_CENTER="SLIDE_CENTER"}static{this.SLIDE_LEFT="SLIDE_LEFT"}static{this.SLIDE_RIGHT="SLIDE_RIGHT"}static{this.SLIDE_TOP="SLIDE_TOP"}static{this.SLIDE_BOTTOM="SLIDE_BOTTOM"}},Mt=class extends d{constructor(){super(...arguments);this.transitionType=xe.CENTER;this.duration=.5}render(){return n` <div class="${$(this.transitionType)}"><slot></slot></div> `}};Mt.styles=m`
  ...
  `,r([s({type:Boolean})],Ft.prototype,"show",2),Ft=r([p("nidoca-dialog")],Ft);var ht=class extends d{constructor(){super(...arguments);this.show=!1;this.title="Ja oder Nein ?";this.description="Entscheide dich";this.labelButtonYes="Ja";this.labelButtonNo="Nein"}render(){return n`<nidoca-dialog .show="${this.show}">
  ...
  `,r([s({type:f,converter:String})],N.prototype,"theme",2),r([s({type:String})],N.prototype,"src",2),r([s({type:String})],N.prototype,"title",2),r([s({type:String})],N.prototype,"subtitle",2),N=r([p("nidoca-avatar")],N);var Nt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return n`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background-light);
          border-color: var(--app-color-${this.theme}-border);
  ...
  `,r([s({type:f,converter:String})],_t.prototype,"theme",2),_t=r([p("nidoca-box")],_t);var Q=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Deine Nachricht";this.nameLabel="Dein Name";this.emailLabel="Deine Email";this.titleLabel="Betreff";this.messageLabel="Deine Nachricht";this.buttonLabel="Senden"}render(){return n`
      <nidoca-box theme="${$(this.theme)}">
...
`.trim()}renderPropertyGui(){let e=[];for(let t of this.getPropertyGuiWrappers())e.push(n`
        ...
        `);return e}getPropertyGuiWrappers(){let e=[];for(let t of this.webcomponentWrapper.getElementProperties())e.push(new or(t));return e}getPropertieNames(){let e=[];return this.getPropertyGuiWrappers().map(t=>{e.push(t.propertyWrapper.propertyName)}),e}hasProperties(){return this.getPropertieNames().length>0}};var Gt=class extends D{constructor(){super(...arguments);this.webcomponentGuiWrapper=null;this.customEventNames=[]}updated(t){t.has("element")&&this.element!=null&&(this.element.style.flexBasis="auto",this.webcomponentGuiWrapper=new nr(this,new rr(this.element)),this.requestUpdate())}render(){return this.element?n` <nidoca-section theme="primary">
            <div>
  ...
  `,r([s({type:Array})],Gt.prototype,"customEventNames",2),r([s({type:Object})],Gt.prototype,"element",2),Gt=r([p("webcomponent-viewer")],Gt);var te=class extends D{constructor(){super(...arguments);this.componentMap=new Map;this.value="";this.options=[]}render(){return n`
      <nidoca-form-combobox
        name="components"
        label="Komponenten"
        value="${this.value}"
  ...
  `,r([g("#webcomponentViewer")],te.prototype,"webcomponentViewer",2),te=r([p("webcomponent-viewer-container")],te);var ir=class extends D{render(){return n`<nidoca-container>
      <nidoca-section>
  ...
  `,Re=r([p("nidoca-page-webcomponents")],Re);var $e=class extends d{render(){return n`
      <nidoca-container>
