"use strict";(()=>{var Lr=Object.defineProperty;var Dr=Object.getOwnPropertyDescriptor;var r=(a,e,t,o)=>{for(var i=o>1?void 0:o?Dr(e,t):e,l=a.length-1,c;l>=0;l--)(c=a[l])&&(i=(o?c(e,t,i):c(i))||i);return o&&i&&Lr(e,t,i),i};var lr=globalThis,Pe=lr.trustedTypes,gr=Pe?Pe.createPolicy("lit-html",{createHTML:a=>a}):void 0,pr="$lit$",ut=`lit$${Math.random().toFixed(9).slice(2)}$`,mr="?"+ut,Mr=`<${mr}>`,Ht=document,oe=()=>Ht.createComment(""),ne=a=>a===null||typeof a!="object"&&typeof a!="function",cr=Array.isArray,wr=a=>cr(a)||typeof a?.[Symbol.iterator]=="function",ar=`[ 	
\f\r]`,re=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,yr=/-->/g,br=/>/g,Tt=RegExp(`>|${ar}(?:([^\\s"'>=/]+)(${ar}*=${ar}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),xr=/'/g,vr=/"/g,kr=/^(?:script|style|textarea|title)$/i,dr=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),n=dr(1),oo=dr(2),no=dr(3),Q=Symbol.for("lit-noChange"),R=Symbol.for("lit-nothing"),Ar=new WeakMap,St=Ht.createTreeWalker(Ht,129);function Er(a,e){if(!cr(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return gr!==void 0?gr.createHTML(e):e}var Tr=(a,e)=>{let t=a.length-1,o=[],i,l=e===2?"<svg>":e===3?"<math>":"",c=re;for(let u=0;u<t;u++){let h=a[u],A,S,y=-1,k=0;for(;k<h.length&&(c.lastIndex=k,S=c.exec(h),S!==null);)k=c.lastIndex,c===re?S[1]==="!--"?c=yr:S[1]!==void 0?c=br:S[2]!==void 0?(kr.test(S[2])&&(i=RegExp("</"+S[2],"g")),c=Tt):S[3]!==void 0&&(c=Tt):c===Tt?S[0]===">"?(c=i??re,y=-1):S[1]===void 0?y=-2:(y=c.lastIndex-S[2].length,A=S[1],c=S[3]===void 0?Tt:S[3]==='"'?vr:xr):c===vr||c===xr?c=Tt:c===yr||c===br?c=re:(c=Tt,i=void 0);let b=c===Tt&&a[u+1].startsWith("/>")?" ":"";l+=c===re?h+Mr:y>=0?(o.push(A),h.slice(0,y)+pr+h.slice(y)+ut+b):h+ut+(y===-2?u:b)}return[Er(a,l+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),o]},ie=class a{constructor({strings:e,_$litType$:t},o){let i;this.parts=[];let l=0,c=0,u=e.length-1,h=this.parts,[A,S]=Tr(e,t);if(this.el=a.createElement(A,o),St.currentNode=this.el.content,t===2||t===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(i=St.nextNode())!==null&&h.length<u;){if(i.nodeType===1){if(i.hasAttributes())for(let y of i.getAttributeNames())if(y.endsWith(pr)){let k=S[c++],b=i.getAttribute(y).split(ut),$=/([.?@])?(.*)/.exec(k);h.push({type:1,index:l,name:$[2],strings:b,ctor:$[1]==="."?ze:$[1]==="?"?je:$[1]==="@"?We:Ot}),i.removeAttribute(y)}else y.startsWith(ut)&&(h.push({type:6,index:l}),i.removeAttribute(y));if(kr.test(i.tagName)){let y=i.textContent.split(ut),k=y.length-1;if(k>0){i.textContent=Pe?Pe.emptyScript:"";for(let b=0;b<k;b++)i.append(y[b],oe()),St.nextNode(),h.push({type:2,index:++l});i.append(y[k],oe())}}}else if(i.nodeType===8)if(i.data===mr)h.push({type:2,index:l});else{let y=-1;for(;(y=i.data.indexOf(ut,y+1))!==-1;)h.push({type:7,index:l}),y+=ut.length-1}l++}}static createElement(e,t){let o=Ht.createElement("template");return o.innerHTML=e,o}};function Rt(a,e,t=a,o){if(e===Q)return e;let i=o!==void 0?t._$Co?.[o]:t._$Cl,l=ne(e)?void 0:e._$litDirective$;return i?.constructor!==l&&(i?._$AO?.(!1),l===void 0?i=void 0:(i=new l(a),i._$AT(a,t,o)),o!==void 0?(t._$Co??=[])[o]=i:t._$Cl=i),i!==void 0&&(e=Rt(a,i._$AS(a,e.values),i,o)),e}var Ce=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:o}=this._$AD,i=(e?.creationScope??Ht).importNode(t,!0);St.currentNode=i;let l=St.nextNode(),c=0,u=0,h=o[0];for(;h!==void 0;){if(c===h.index){let A;h.type===2?A=new qt(l,l.nextSibling,this,e):h.type===1?A=new h.ctor(l,h.name,h.strings,this,e):h.type===6&&(A=new Le(l,this,e)),this._$AV.push(A),h=o[++u]}c!==h?.index&&(l=St.nextNode(),c++)}return St.currentNode=Ht,i}p(e){let t=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}},qt=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,i){this.type=2,this._$AH=R,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Rt(this,e,t),ne(e)?e===R||e==null||e===""?(this._$AH!==R&&this._$AR(),this._$AH=R):e!==this._$AH&&e!==Q&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):wr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==R&&ne(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ht.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:o}=e,i=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=ie.createElement(Er(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===i)this._$AH.p(t);else{let l=new Ce(i,this),c=l.u(this.options);l.p(t),this.T(c),this._$AH=l}}_$AC(e){let t=Ar.get(e.strings);return t===void 0&&Ar.set(e.strings,t=new ie(e)),t}k(e){cr(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,o,i=0;for(let l of e)i===t.length?t.push(o=new a(this.O(oe()),this.O(oe()),this,this.options)):o=t[i],o._$AI(l),i++;i<t.length&&(this._$AR(o&&o._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){let o=e.nextSibling;e.remove(),e=o}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ot=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,i,l){this.type=1,this._$AH=R,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=l,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=R}_$AI(e,t=this,o,i){let l=this.strings,c=!1;if(l===void 0)e=Rt(this,e,t,0),c=!ne(e)||e!==this._$AH&&e!==Q,c&&(this._$AH=e);else{let u=e,h,A;for(e=l[0],h=0;h<l.length-1;h++)A=Rt(this,u[o+h],t,h),A===Q&&(A=this._$AH[h]),c||=!ne(A)||A!==this._$AH[h],A===R?e=R:e!==R&&(e+=(A??"")+l[h+1]),this._$AH[h]=A}c&&!i&&this.j(e)}j(e){e===R?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ze=class extends Ot{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===R?void 0:e}},je=class extends Ot{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==R)}},We=class extends Ot{constructor(e,t,o,i,l){super(e,t,o,i,l),this.type=5}_$AI(e,t=this){if((e=Rt(this,e,t,0)??R)===Q)return;let o=this._$AH,i=e===R&&o!==R||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,l=e!==R&&(o===R||i);i&&this.element.removeEventListener(this.name,this,o),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Le=class{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){Rt(this,e)}},Sr={M:pr,P:ut,A:mr,C:1,L:Tr,R:Ce,D:wr,V:Rt,I:qt,H:Ot,N:je,U:We,B:ze,F:Le},Vr=lr.litHtmlPolyfillSupport;Vr?.(ie,qt),(lr.litHtmlVersions??=[]).push("3.2.1");var Hr=(a,e,t)=>{let o=t?.renderBefore??e,i=o._$litPart$;if(i===void 0){let l=t?.renderBefore??null;o._$litPart$=i=new qt(e.insertBefore(oe(),l),l,void 0,t??{})}return i._$AI(a),i};var p=a=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(a,e)}):customElements.define(a,e)};var De=globalThis,Me=De.ShadowRoot&&(De.ShadyCSS===void 0||De.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,hr=Symbol(),Rr=new WeakMap,se=class{constructor(e,t,o){if(this._$cssResult$=!0,o!==hr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(Me&&e===void 0){let o=t!==void 0&&t.length===1;o&&(e=Rr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),o&&Rr.set(t,e))}return e}toString(){return this.cssText}},Or=a=>new se(typeof a=="string"?a:a+"",void 0,hr),m=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((o,i,l)=>o+(c=>{if(c._$cssResult$===!0)return c.cssText;if(typeof c=="number")return c;throw Error("Value passed to 'css' function must be a 'css' function result: "+c+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+a[l+1],a[0]);return new se(t,a,hr)},ur=(a,e)=>{if(Me)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let o=document.createElement("style"),i=De.litNonce;i!==void 0&&o.setAttribute("nonce",i),o.textContent=t.cssText,a.appendChild(o)}},Ve=Me?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let o of e.cssRules)t+=o.cssText;return Or(t)})(a):a;var{is:Gr,defineProperty:qr,getOwnPropertyDescriptor:Ur,getOwnPropertyNames:Kr,getOwnPropertySymbols:Qr,getPrototypeOf:Yr}=Object,Ge=globalThis,$r=Ge.trustedTypes,Xr=$r?$r.emptyScript:"",Zr=Ge.reactiveElementPolyfillSupport,ae=(a,e)=>a,le={toAttribute(a,e){switch(e){case Boolean:a=a?Xr:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},qe=(a,e)=>!Gr(a,e),Ir={attribute:!0,type:String,converter:le,reflect:!1,hasChanged:qe};Symbol.metadata??=Symbol("metadata"),Ge.litPropertyMetadata??=new WeakMap;var ft=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Ir){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){let o=Symbol(),i=this.getPropertyDescriptor(e,o,t);i!==void 0&&qr(this.prototype,e,i)}}static getPropertyDescriptor(e,t,o){let{get:i,set:l}=Ur(this.prototype,e)??{get(){return this[t]},set(c){this[t]=c}};return{get(){return i?.call(this)},set(c){let u=i?.call(this);l.call(this,c),this.requestUpdate(e,u,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ir}static _$Ei(){if(this.hasOwnProperty(ae("elementProperties")))return;let e=Yr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ae("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ae("properties"))){let t=this.properties,o=[...Kr(t),...Qr(t)];for(let i of o)this.createProperty(i,t[i])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[o,i]of t)this.elementProperties.set(o,i)}this._$Eh=new Map;for(let[t,o]of this.elementProperties){let i=this._$Eu(t,o);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let o=new Set(e.flat(1/0).reverse());for(let i of o)t.unshift(Ve(i))}else e!==void 0&&t.push(Ve(e));return t}static _$Eu(e,t){let o=t.attribute;return o===!1?void 0:typeof o=="string"?o:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let o of t.keys())this.hasOwnProperty(o)&&(e.set(o,this[o]),delete this[o]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ur(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,o){this._$AK(e,o)}_$EC(e,t){let o=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,o);if(i!==void 0&&o.reflect===!0){let l=(o.converter?.toAttribute!==void 0?o.converter:le).toAttribute(t,o.type);this._$Em=e,l==null?this.removeAttribute(i):this.setAttribute(i,l),this._$Em=null}}_$AK(e,t){let o=this.constructor,i=o._$Eh.get(e);if(i!==void 0&&this._$Em!==i){let l=o.getPropertyOptions(i),c=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:le;this._$Em=i,this[i]=c.fromAttribute(t,l.type),this._$Em=null}}requestUpdate(e,t,o){if(e!==void 0){if(o??=this.constructor.getPropertyOptions(e),!(o.hasChanged??qe)(this[e],t))return;this.P(e,t,o)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(e,t,o){this._$AL.has(e)||this._$AL.set(e,t),o.reflect===!0&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,l]of this._$Ep)this[i]=l;this._$Ep=void 0}let o=this.constructor.elementProperties;if(o.size>0)for(let[i,l]of o)l.wrapped!==!0||this._$AL.has(i)||this[i]===void 0||this.P(i,this[i],l)}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(t)):this._$EU()}catch(o){throw e=!1,this._$EU(),o}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach(t=>this._$EC(t,this[t])),this._$EU()}updated(e){}firstUpdated(e){}};ft.elementStyles=[],ft.shadowRootOptions={mode:"open"},ft[ae("elementProperties")]=new Map,ft[ae("finalized")]=new Map,Zr?.({ReactiveElement:ft}),(Ge.reactiveElementVersions??=[]).push("2.0.4");var Jr={attribute:!0,type:String,converter:le,reflect:!1,hasChanged:qe},Fr=(a=Jr,e,t)=>{let{kind:o,metadata:i}=t,l=globalThis.litPropertyMetadata.get(i);if(l===void 0&&globalThis.litPropertyMetadata.set(i,l=new Map),l.set(t.name,a),o==="accessor"){let{name:c}=t;return{set(u){let h=e.get.call(this);e.set.call(this,u),this.requestUpdate(c,h,a)},init(u){return u!==void 0&&this.P(c,void 0,a),u}}}if(o==="setter"){let{name:c}=t;return function(u){let h=this[c];e.call(this,u),this.requestUpdate(c,h,a)}}throw Error("Unsupported decorator location: "+o)};function s(a){return(e,t)=>typeof t=="object"?Fr(a,e,t):((o,i,l)=>{let c=i.hasOwnProperty(l);return i.constructor.createProperty(l,c?{...o,wrapped:!0}:o),c?Object.getOwnPropertyDescriptor(i,l):void 0})(a,e,t)}function Ue(a){return s({...a,state:!0,attribute:!1})}var $t=(a,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,t),t);function g(a,e){return(t,o,i)=>{let l=c=>c.renderRoot?.querySelector(a)??null;if(e){let{get:c,set:u}=typeof o=="object"?t:i??(()=>{let h=Symbol();return{get(){return this[h]},set(A){this[h]=A}}})();return $t(t,o,{get(){let h=c.call(this);return h===void 0&&(h=l(this),(h!==null||this.hasUpdated)&&u.call(this,h)),h}})}return $t(t,o,{get(){return l(this)}})}}var W=class extends ft{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Hr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Q}};W._$litElement$=!0,W.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:W});var Nr=globalThis.litElementPolyfillSupport;Nr?.({LitElement:W});(globalThis.litElementVersions??=[]).push("4.1.1");var d=class extends W{};var f=(i=>(i.primary="primary",i.secondary="secondary",i.surface="surface",i.plain="plain",i))(f||{}),x=class{static getStyle(e){return e?e=="plain"?n``:n` <style>
            :host,
            *,
            ::slotted(*) {
  ...
  `,r([s({type:f,converter:String})],H.prototype,"theme",2),r([s({type:String})],H.prototype,"overline",2),r([s({type:String})],H.prototype,"title",2),r([s({type:String})],H.prototype,"summary",2),r([s({type:String})],H.prototype,"text",2),H=r([p("nidoca-article")],H);var Br=(t=>(t.single="single",t.multi="multi",t))(Br||{}),tt=class extends d{constructor(){super(...arguments);this.theme="plain";this.accordionType="single"}updated(t){super.updated(t),t.forEach((o,i)=>{if(i=="theme"&&this.accordionSlot!=null){let l=this.accordionSlot.assignedElements();for(let c=0;c<l.length;c++){let u=l[c];u instanceof _&&(u.theme=this.theme)}}})}render(){return n`
  ...
  `,r([s({type:String})],Y.prototype,"icon",2),r([s({type:String})],Y.prototype,"primaryText",2),r([s({type:Number})],Y.prototype,"state",2),r([s({type:Boolean})],Y.prototype,"isLast",2),Y=r([p("nidoca-wizard-step")],Y);var Ut=class extends d{render(){return n`
      <div
    ...
    `}slotChanged(e){let t=e.target;if(t==null)return;let o=t.assignedElements(),i=0;for(let l=0;l<o.length;l++){let c=o[l];c instanceof Y&&(c.index=l,c.state==0&&(i=l),c.index==o.length-1&&(c.isLast=!0))}this.changeState(i)}stepClicked(e){let t=e.detail;console.debug("wizard step clicked, selectedStepIndex: %s",t),this.changeState(t)}changeState(e){if(this.wizardSlot){let t=this.wizardSlot.assignedElements();for(let o=0;o<t.length;o++){let i=t[o];i instanceof Y&&i.index!==void 0&&(i.index<e?i.state=1:i.index==e?i.state=0:i.state=2)}}}};Ut.styles=m``,r([g("#wizardSlot")],Ut.prototype,"wizardSlot",2),Ut=r([p("nidoca-wizard")],Ut);var et=class extends d{constructor(){super(...arguments);this.clickable=!0;this.theme="surface";this.text=""}render(){return n`
      <style>
        .chip:hover {
  ...
  `,r([s({type:String})],st.prototype,"code",2),r([s({type:String})],st.prototype,"theme",2),st=r([p("nidoca-code")],st);var It=class extends d{constructor(){super();this.show=!1;addEventListener("click",t=>{let o=this.associatedElement?.getBoundingClientRect();o&&(o.top>t.clientY||o.right<t.clientX||o.left>t.clientX||o.bottom<t.clientY)&&this.dispatchEvent(new CustomEvent("nidoca-elevation-event-closeme",{detail:this,bubbles:!0,composed:!0}))})}render(){return this.show?n`
          <div class="container" style="${this.calculatePositionStyle(this.associatedElement)}">
            <nidoca-border>
              <slot id="slot"></slot>
            </nidoca-border>
          </div>
        `:n``}calculatePositionStyle(t){let o="";if(t){let i=t.getBoundingClientRect();i.right>window.innerWidth/2?o+=`right:${window.innerWidth-i.right}px;`:o+=`left:${i.left}px;`,i.top>window.innerHeight/2?o+=`bottom:${i.height+window.innerHeight-i.top}px;`:o+=`top:${i.bottom}px;`}return o}};It.styles=m`
    .container {
      position: fixed;
      z-index: 999;
    }
  `,r([s({type:Boolean})],It.prototype,"show",2),r([s({type:Object})],It.prototype,"associatedElement",2),It=r([p("nidoca-elevation")],It);var Qe=class{static{this.PROGRESS="PROGRESS"}static{this.PROGRESS_CIRCULAR="PROGRESS_CIRCULAR"}},Bt=class extends d{constructor(){super(...arguments);this.progressType=Qe.PROGRESS}render(){return n` <style>
        :host {
          width: 100%;
          display: block;
        }
      ...
      <progress class="${this.progressType}"></progress>`}};Bt.styles=m``,r([s({type:f,converter:String})],Bt.prototype,"theme",2),r([s({type:Qe,converter:String})],Bt.prototype,"progressType",2),Bt=r([p("nidoca-progress")],Bt);var Ye=(o=>(o.contained="contained",o.outlined="outlined",o.text="text",o))(Ye||{}),X=class extends d{constructor(){super(...arguments);this.theme="primary";this.buttonType="contained";this.icon="";this.text=""}render(){return n`
      <style>
        .outlined {
          color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:f,converter:String})],X.prototype,"theme",2),r([s({type:Ye,converter:String})],X.prototype,"buttonType",2),r([s({type:String})],X.prototype,"icon",2),r([s({type:String})],X.prototype,"text",2),X=r([p("nidoca-button")],X);var D=class extends d{};var Pt=class extends d{constructor(){super(...arguments);this.autocomplete=!0}render(){return n`
  ...
  `,r([s({type:Boolean})],Pt.prototype,"autocomplete",2),r([g("#slotElement")],Pt.prototype,"slotElement",2),Pt=r([p("nidoca-form")],Pt);var Pr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Xe=a=>(...e)=>({_$litDirective$:a,values:e}),Kt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var{I:_r}=Sr;var Cr=()=>document.createComment(""),Qt=(a,e,t)=>{let o=a._$AA.parentNode,i=e===void 0?a._$AB:e._$AA;if(t===void 0){let l=o.insertBefore(Cr(),i),c=o.insertBefore(Cr(),i);t=new _r(l,c,a,a.options)}else{let l=t._$AB.nextSibling,c=t._$AM,u=c!==a;if(u){let h;t._$AQ?.(a),t._$AM=a,t._$AP!==void 0&&(h=a._$AU)!==c._$AU&&t._$AP(h)}if(l!==i||u){let h=t._$AA;for(;h!==l;){let A=h.nextSibling;o.insertBefore(h,i),h=A}}}return t},bt=(a,e,t=a)=>(a._$AI(e,t),a),to={},zr=(a,e=to)=>a._$AH=e,jr=a=>a._$AH,Ze=a=>{a._$AP?.(!1,!0);let e=a._$AA,t=a._$AB.nextSibling;for(;e!==t;){let o=e.nextSibling;e.remove(),e=o}};var Wr=(a,e,t)=>{let o=new Map;for(let i=e;i<=t;i++)o.set(a[i],i);return o},xt=Xe(class extends Kt{constructor(a){if(super(a),a.type!==Pr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(a,e,t){let o;t===void 0?t=e:e!==void 0&&(o=e);let i=[],l=[],c=0;for(let u of a)i[c]=o?o(u,c):c,l[c]=t(u,c),c++;return{values:l,keys:i}}render(a,e,t){return this.dt(a,e,t).values}update(a,[e,t,o]){let i=jr(a),{values:l,keys:c}=this.dt(e,t,o);if(!Array.isArray(i))return this.ut=c,l;let u=this.ut??=[],h=[],A,S,y=0,k=i.length-1,b=0,$=l.length-1;for(;y<=k&&b<=$;)if(i[y]===null)y++;else if(i[k]===null)k--;else if(u[y]===c[b])h[b]=bt(i[y],l[b]),y++,b++;else if(u[k]===c[$])h[$]=bt(i[k],l[$]),k--,$--;else if(u[y]===c[$])h[$]=bt(i[y],l[$]),Qt(a,h[$+1],i[y]),y++,$--;else if(u[k]===c[b])h[b]=bt(i[k],l[b]),Qt(a,i[y],i[k]),k--,b++;else if(A===void 0&&(A=Wr(c,b,$),S=Wr(u,y,k)),A.has(u[y]))if(A.has(u[k])){let ht=S.get(c[b]),sr=ht!==void 0?i[ht]:null;if(sr===null){let fr=Qt(a,i[y]);bt(fr,l[b]),h[b]=fr}else h[b]=bt(sr,l[b]),Qt(a,i[y],sr),i[ht]=null;b++}else Ze(i[k]),k--;else Ze(i[y]),y++;for(;b<=$;){let ht=Qt(a,h[$+1]);bt(ht,l[b]),h[b++]=ht}for(;y<=k;){let ht=i[y++];ht!==null&&Ze(ht)}return this.ut=c,zr(a,h),Q}});var eo={},Ct=Xe(class extends Kt{constructor(){super(...arguments),this.ot=eo}render(a,e){return e()}update(a,[e,t]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((o,i)=>o===this.ot[i]))return Q}else if(this.ot===e)return Q;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,t)}});var E=class extends D{constructor(){super(...arguments);this.theme="surface";this.trailingIcon="";this.label="";this.errorText="";this.infoText="";this.warningText="";this.value="";this.options=[];this.name="";this.required=!0;this.multiple=!1;this.size=1}render(){return n` <style>
        .parentContainer,
      ...
      <div class="parentContainer">
        ...
        <div class="container">
          ...
          >
            ${Ct([this.value,this.options],()=>n`
                ${xt(this.options,t=>t==null?n` <option></option>`:this.isSelectedOption(t)?n` <option value="${t.key}" selected>${t.value}</option> `:n` <option value="${t.key}">${t.value}</option> `)}
              `)}
          </select>
        </div>
      </div>
...
${this.value}</textarea
  ...
  `,r([s({type:f,converter:String})],zt.prototype,"theme",2),r([g("#inputElement")],zt.prototype,"inputElement",2),zt=r([p("nidoca-form-upload")],zt);var z=class extends D{constructor(){super();this.name="";this.label="";this.infoText="";this.errorText="";this.warningText="";this.required=!1;this.disabled=!1;this.checked=!1;this.theme="primary";this.theme=x.prototype.getParentTheme(this)||"plain"}render(){return n`
      <style>
        .slider {
  ...
  `,r([s({type:String})],z.prototype,"name",2),r([s({type:String})],z.prototype,"label",2),r([s({type:String})],z.prototype,"infoText",2),r([s({type:String})],z.prototype,"errorText",2),r([s({type:String})],z.prototype,"warningText",2),r([s({type:Boolean})],z.prototype,"required",2),r([s({type:Boolean})],z.prototype,"disabled",2),r([s({type:Boolean})],z.prototype,"checked",2),r([s({type:String})],z.prototype,"theme",2),r([g("#inputElement")],z.prototype,"inputElement",2),z=r([p("nidoca-form-switch")],z);var at=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Newsletter";this.emailLabel="Deine Emailadresse";this.buttonLabel="Registrieren"}render(){return n`
      <nidoca-box theme="${O(this.theme)}">
        <nidoca-form id="form">
  ...
  `,r([s({type:f,converter:String})],ot.prototype,"theme",2),r([s({type:String,converter:String})],ot.prototype,"label",2),r([s({type:String,converter:String})],ot.prototype,"emailLabel",2),r([s({type:String,converter:String})],ot.prototype,"passwordLabel",2),r([s({type:String,converter:String})],ot.prototype,"buttonLabel",2),r([g("#form")],ot.prototype,"formComponent",2),ot=r([p("nidoca-form-register")],ot);var Yt=class extends d{constructor(){super(...arguments);this.code=""}render(){return n``}};Yt.styles=m``,r([s({type:String})],Yt.prototype,"code",2),Yt=r([p("nidoca-upload")],Yt);var jt=class extends d{constructor(){super(...arguments);this.theme="plain";this.text=""}render(){return n`
      <style>
        .hr {
          border-color: var(--app-color-${this.theme}-border);
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:f,converter:String})],jt.prototype,"theme",2),r([s({type:String,converter:String})],jt.prototype,"text",2),jt=r([p("nidoca-hr")],jt);var pt=class extends d{constructor(){super(...arguments);this.text="";this.icon=""}render(){return n`
      <div class="container">
        ${this.icon?n` <nidoca-icon
              slot="graphic"
              icon="${this.icon}"
  ...
  `,r([s({type:String})],pt.prototype,"text",2),r([s({type:String})],pt.prototype,"icon",2),pt=r([p("nidoca-menu-area")],pt);var j=class extends d{constructor(){super(...arguments);this.text="";this.icon="";this.selected=!1;this.theme="surface"}render(){return n`
      <style>
        .container:hover {
          background-color: var(--app-color-${this.theme}-hover);
        }
  ...
  `,r([s({type:String})],j.prototype,"text",2),r([s({type:String})],j.prototype,"icon",2),r([s({type:Boolean})],j.prototype,"selected",2),r([s({type:String})],j.prototype,"theme",2),j=r([p("nidoca-menu-item")],j);var mt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return n` <style>
        :host,
        *,
        ::slotted(*) {
          color: var(--app-color-text-${this.theme});
  ...
  `,r([s({type:String})],nt.prototype,"height",2),r([s({type:String})],nt.prototype,"width",2),r([s({type:String})],nt.prototype,"left",2),r([s({type:String})],nt.prototype,"top",2),r([s({type:String})],nt.prototype,"right",2),r([s({type:String})],nt.prototype,"bottom",2),nt=r([p("nidoca-layout-floating")],nt);var Xt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return n`
      ${x.getStyle(this.theme)}
      <slot></slot>
    `}};Xt.styles=m`
    :host {
  ...
  `,r([s({type:String})],Xt.prototype,"theme",2),Xt=r([p("nidoca-container")],Xt);var Wt=class extends d{constructor(){super();this.hideSidebox=!0;this.theme=x.prototype.getParentTheme(this)||"plain"}render(){return n` <style>
        .listbox,
        .sidebox {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:String})],P.prototype,"icon",2),r([s({type:Boolean})],P.prototype,"clickable",2),r([s({type:Boolean})],P.prototype,"deactivated",2),r([s({type:String})],P.prototype,"title",2),P=r([p("nidoca-icon")],P);var Zt=class extends d{render(){return n`
      <div id="rippleContainer" anim="ripple" @click="${e=>this.clicked(e)}">
        <slot></slot>
      </div>
    `}clicked(e){if(this.rippleContainerElement!=null){e instanceof TouchEvent&&(e=e.touches?e.touches[0]:e);let t=this.rippleContainerElement.getBoundingClientRect(),o=Math.sqrt(Math.pow(t.width,2)+Math.pow(t.height,2))*2;this.rippleContainerElement.style.cssText="--s: 0; --o: 1;",this.rippleContainerElement.offsetTop,(e instanceof MouseEvent||e instanceof Touch)&&(this.rippleContainerElement.style.cssText=`--t: 1; --o: 0; --d: ${o}; --x:${e.clientX-t.left}; --y:${e.clientY-t.top};`)}}};Zt.styles=m`
    :host {
      display: inline-block;
    }
  ...
  `,Z=r([p("nidoca-img-round")],Z);var Lt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return n`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
    ...
    `}slotChanged(t){let o=t.target;if(o==null)return;let i=o.assignedElements();for(let l=0;l<i.length;l++){let c=i[l];if(c instanceof C){this.selected==null&&l==0&&(this.selected=c.cloneNode(!0)),c.addEventListener("click",h=>{h.target&&(this.selected=h.target.cloneNode(!0))}),c.width="148px";let u=c.classList;u.contains("img")||u.add("img")}}}};Lt.styles=m`
    :host,
    ::slotted(:host) {
      display: flex;
      flex-direction: column;
  ...
  `,r([s({type:f,converter:String})],Lt.prototype,"theme",2),r([Ue()],Lt.prototype,"selected",2),Lt=r([p("nidoca-img-slider")],Lt);var Jt=class extends d{constructor(){super(...arguments);this.src=""}render(){return n`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
        ...
        ></iframe
      ></span>
    `}};Jt.styles=m``,r([s({type:String})],Jt.prototype,"src",2),Jt=r([p("nidoca-movie")],Jt);var V=class extends d{constructor(){super(...arguments);this.label="";this.placeholder="";this.name="";this.min=1;this.max=10;this.errorText="";this.numberOne=1;this.numberTwo=1}render(){return n`
      <nidoca-form-text
        theme="${O(this.theme)}"
        id="inputfield"
        placeholder="${this.placeholder}"
  ...
  `,r([s({type:String})],vt.prototype,"text",2),r([s({type:String})],vt.prototype,"href",2),r([s({type:String})],vt.prototype,"targetType",2),vt=r([p("nidoca-link")],vt);var T=class extends d{constructor(){super(...arguments);this.theme="surface";this.primaryText="";this.secondaryText="";this.tertiaryText="";this.infoText="";this.selected=!1}render(){return n`
      <style>
        .container {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background);
  ...
  `,r([s({type:String,converter:String})],ct.prototype,"theme",2),r([s({type:Boolean})],ct.prototype,"prominent",2),ct=r([p("nidoca-top-app-bar")],ct);var At=class extends d{constructor(){super(...arguments);this.headers=["column 1","column 2"];this.rows=[["row 1",new P],["row 2",new P]];this.theme="plain"}render(){return n`
      <style>
        td,
        th {
      ...
      <div>
        <table>
          <thead>
            ${Ct([this.headers],()=>n` ${xt(this.headers,t=>n` <th colspan="1" rowspan="1">${t}</th> `)} `)}
          </thead>
          <tbody>
            ${Ct([this.rows],()=>n`
                  ${xt(this.rows,t=>n`
                        <tr>
                          ${xt(t,o=>n` <td colspan="1" rowspan="1">${o}</td> `)}
                        </tr>
                      `)}
                `)}
          </tbody>
  ...
  `,r([s({type:Array})],At.prototype,"headers",2),r([s({type:Array})],At.prototype,"rows",2),r([s({type:f,converter:String})],At.prototype,"theme",2),At=r([p("nidoca-table")],At);var wt=class extends d{constructor(){super(...arguments);this.selected=!1}render(){return this.selected?n` <slot></slot>`:n``}};wt.styles=m`
    :host,
    slot {
      display: block;
    }
  `,r([s({type:Boolean})],wt.prototype,"selected",2),wt=r([p("nidoca-tab-content")],wt);var it=class extends d{constructor(){super(...arguments);this.selected=!1;this.text="";this.theme="surface"}render(){return n`
      <style>
        .container {
  ...
  `,r([g("#tabSlot")],J.prototype,"tabSlot",2),r([g("#tabContentSlot")],J.prototype,"tabContentSlot",2),r([s({type:String})],J.prototype,"theme",2),r([s({type:Number})],J.prototype,"tabIndex",2),J=r([p("nidoca-tabs")],J);var kt=class extends d{constructor(){super();this.hideLeft=!0;this.prominent=!1;document.getElementsByTagName("html")[0].setAttribute("oncontextmenu","return false"),this.addEventListener("click",t=>{if(!this.hideLeft&&this.leftElement){console.log("close");let o=this.leftElement.getBoundingClientRect();this.hideLeft=641>window.innerWidth&&0<=t.x-o.width}})}render(){return n`
      <slot
        id="left"
  ...
  `,r([s({type:f,converter:String})],v.prototype,"theme",2),r([s({type:String})],v.prototype,"text",2),v=r([p("nidoca-text")],v);var pe=class extends v{render(){return n` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};pe.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,pe=r([p("nidoca-text-body")],pe);var me=class extends v{render(){return n`${super.render()}`}};me.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ce=r([p("nidoca-text-overline")],ce);var de=class extends v{render(){return n` <slot style="color: var(--app-color-text-${this.theme});">${this.text}</slot>`}};de.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,de=r([p("nidoca-text-subtitle")],de);var q=class extends v{render(){return n`<style>
        slot {
  ...
  `,q=r([p("nidoca-text-caption")],q);var Fe=class extends q{render(){return n`<style>
        slot {
          color: var(--app-color-error-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Fe=r([p("nidoca-text-error")],Fe);var Ne=class extends q{render(){return n`<style>
        slot {
          color: var(--app-color-success-background);
        }
      </style>
      <slot>${this.text}</slot>`}};Ne=r([p("nidoca-text-success")],Ne);var _e=class extends q{render(){return n`<style>
        slot {
          color: var(--app-color-warning-background);
        }
      </style>
      <slot>${this.text}</slot>`}};_e=r([p("nidoca-text-warning")],_e);var tr=class extends q{render(){return n`<style>
        slot {
          color: var(--app-color-info-background);
        }
      </style>
      <slot>${this.text}</slot>`}};tr=r([p("nidoca-text-info")],tr);var he=class extends v{};he.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ue=r([p("nidoca-text-h2")],ue);var fe=class extends v{};fe.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,fe=r([p("nidoca-text-h3")],fe);var ge=class extends v{};ge.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,ge=r([p("nidoca-text-h4")],ge);var ye=class extends v{};ye.styles=m`
    :host,
    slot,
    ::slotted(:host),
    ::slotted(slot) {
  ...
  `,be=r([p("nidoca-text-h6")],be);var U=class extends d{constructor(){super(...arguments);this.value="";this.placeholder="";this.disabled=!1;this.theme="surface"}render(){return n`
      <style>
        .container,
        input {
          color: var(--app-color-text-${this.theme});
  ...
  `,r([s({type:String})],Mt.prototype,"transitionType",2),r([s({type:Number})],Mt.prototype,"duration",2),Mt=r([p("nidoca-transition")],Mt);var Ft=class extends d{constructor(){super(...arguments);this.show=!1}render(){return this.show?n`
  ...
  `,r([s({type:Boolean})],Ft.prototype,"show",2),Ft=r([p("nidoca-dialog")],Ft);var dt=class extends d{constructor(){super(...arguments);this.show=!1;this.title="Ja oder Nein ?";this.description="Entscheide dich";this.labelButtonYes="Ja";this.labelButtonNo="Nein"}render(){return n`<nidoca-dialog .show="${this.show}">
    ...
    </nidoca-dialog>`}};dt.styles=m``,r([s({type:Boolean})],dt.prototype,"show",2),r([s({type:String})],dt.prototype,"title",2),r([s({type:String})],dt.prototype,"description",2),r([s({type:String})],dt.prototype,"labelButtonYes",2),r([s({type:String})],dt.prototype,"labelButtonNo",2),dt=r([p("nidoca-dialog-decision")],dt);var gt=class extends d{constructor(){super(...arguments);this.icon=""}render(){return n`
  ...
  `,r([s({type:String})],gt.prototype,"icon",2),gt=r([p("nidoca-infobox")],gt);var F=class extends d{constructor(){super(...arguments);this.theme="surface";this.src="";this.title="";this.subtitle=""}render(){return n`
            <div
  ...
  `,r([s({type:f,converter:String})],F.prototype,"theme",2),r([s({type:String})],F.prototype,"src",2),r([s({type:String})],F.prototype,"title",2),r([s({type:String})],F.prototype,"subtitle",2),F=r([p("nidoca-avatar")],F);var Nt=class extends d{constructor(){super(...arguments);this.theme="surface"}render(){return n`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background-light);
          border-color: var(--app-color-${this.theme}-border);
  ...
  `,r([s({type:f,converter:String})],Nt.prototype,"theme",2),Nt=r([p("nidoca-card")],Nt);var ve=class extends d{render(){return n`
      <nidoca-layout-spacer bottom="var(--space)" left="">
        <slot id="slotElement" @slotchange="${e=>this.slotChanged(e)}"></slot>
      </nidoca-layout-spacer>
    `}slotChanged(e){let t=e.target;if(t==null)return;let o=t.assignedElements();for(let i=0;i<o.length;i++){let c=o[i].classList;c.contains("flexItem")||c.add("flexItem"),c.contains("flexItemDevice")||c.add("flexItemDevice")}}};ve.styles=m`
    slot,
    ::slotted(slot) {
      display: flex;
      flex-direction: row;
  ...
  `,ve=r([p("nidoca-gallery")],ve);var Ae=class extends d{render(){return n`<slot></slot>`}print(){let e=window.open("");e&&(e.document.write(this.innerHTML),e.print(),e.close())}};Ae.styles=m`
    :host {
      display: none;
    }
  `,Ae=r([p("nidoca-print")],Ae);var we=class extends d{render(){return n`
      <slot id="container" class="container" @slotchange="${e=>this.slotChanged(e)}"></slot>
    `}slotChanged(e){let o=e.target.assignedElements(),i=o.length;for(let l=0;l<i;l++){let u=o[l].classList,h="item_count_"+i;u.contains(h)||u.add(h)}}};we.styles=m`
    :host {
      display: block;
      margin: auto;
      width: 100%;
  ...
  `,we=r([p("nidoca-section")],we);var ke=class extends d{render(){return n` <slot></slot>`}};ke.styles=m`
    :host {
      display: block;
    }
  ...
  `,ke=r([p("nidoca-dashboard")],ke);var Ee=class extends d{render(){return n` <slot></slot>`}};Ee.styles=m`
    :host {
      display: block;
      width: 25%;
    }
  ...
  `,Ee=r([p("nidoca-dashboard-box-25")],Ee);var Te=class extends d{render(){return n` <slot></slot>`}};Te.styles=m`
    :host {
      width: 50%;
      display: block;
    }
  ...
  `,Te=r([p("nidoca-dashboard-box-50")],Te);var Se=class extends d{render(){return n` <slot></slot>`}};Se.styles=m`
    :host {
      width: 100%;
      display: block;
    }
  `,Se=r([p("nidoca-dashboard-box-100")],Se);var Vt=class extends d{constructor(){super(...arguments);this.clickable=!0;this.title=""}render(){return n`
    ...
    `}clicked(){this.clickable&&this.dispatchEvent(new CustomEvent("nidoca-event-dashboard-card-clicked",{detail:this,bubbles:!0,composed:!0}))}};Vt.styles=m`
    :host {
      padding: var(--space-2);
      box-sizing: border-box;
    }
  ...
  `,r([s({type:Boolean})],Vt.prototype,"clickable",2),r([s({type:String})],Vt.prototype,"title",2),Vt=r([p("nidoca-dashboard-card")],Vt);var _t=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return n`
      ${x.getStyle(this.theme)}
      <slot></slot>
    `}};_t.styles=m`
    :host {
  ...
  `,r([s({type:f,converter:String})],_t.prototype,"theme",2),_t=r([p("nidoca-box")],_t);var K=class extends d{constructor(){super(...arguments);this.theme="primary";this.label="Deine Nachricht";this.nameLabel="Dein Name";this.emailLabel="Deine Email";this.titleLabel="Betreff";this.messageLabel="Deine Nachricht";this.buttonLabel="Senden"}render(){return n`
      <nidoca-box theme="${O(this.theme)}">
...
`.trim()}renderPropertyGui(){let e=[];for(let t of this.getPropertyGuiWrappers())e.push(n`
        ...
        `);return e}getPropertyGuiWrappers(){let e=[];for(let t of this.webcomponentWrapper.getElementProperties())e.push(new or(t));return e}getPropertieNames(){let e=[];return this.getPropertyGuiWrappers().map(t=>{e.push(t.propertyWrapper.propertyName)}),e}hasProperties(){return this.getPropertieNames().length>0}};var Gt=class extends W{constructor(){super(...arguments);this.webcomponentGuiWrapper=null;this.customEventNames=[]}updated(t){t.has("element")&&this.element!=null&&(this.element.style.flexBasis="auto",this.webcomponentGuiWrapper=new nr(this,new rr(this.element)),this.requestUpdate())}render(){return this.element?n` <nidoca-section theme="primary">
            <div>
          ...
          <slot @slotchange="${t=>this.slotChanged(t)}"></slot>`:n`Kein Element ausgewählt.`}slotChanged(t){let o=t.target;if(o==null)return;let l=o.assignedElements()[0];l instanceof HTMLElement&&(this.element=l)}toAttributeRows(t){let o=[[]];return t&&t.map(i=>{let l=[];return l.push(i.propertyWrapper.propertyName),l.push(i.propertyWrapper.getTypeName()),l.push(i.propertyWrapper.getConverterTypeName()),l.push(i.propertyWrapper.getRenderType()),o.push(l),l}),o}toSlotRows(t){let o=[[]];return t&&t.map(i=>{let l=[];return l.push(i),o.push(l),l}),o}toCustomEventRows(t){let o=[[]];return t&&t.map(i=>{let l=[];return l.push(i),o.push(l),l}),o}};Gt.styles=m`
    .container {
      display: grid;
      grid-template-columns: 1fr;
    }
  ...
  `,r([s({type:Array})],Gt.prototype,"customEventNames",2),r([s({type:Object})],Gt.prototype,"element",2),Gt=r([p("webcomponent-viewer")],Gt);var te=class extends W{constructor(){super(...arguments);this.componentMap=new Map;this.value="";this.options=[]}render(){return n`
      <nidoca-form-combobox
        name="components"
        label="Komponenten"
        value="${this.value}"
  ...
  `,r([g("#webcomponentViewer")],te.prototype,"webcomponentViewer",2),te=r([p("webcomponent-viewer-container")],te);var ir=class extends W{render(){return n`<nidoca-container>
      <nidoca-section>
    ...
    </nidoca-container>`}};ir=r([p("nidoca-viewer")],ir);var He=class extends d{render(){return n`
  ...
  -->
      ...
      ${this.getComponentHtml(gt,new gt,"Infobox Komponente.")}
    ...
    </nidoca-container>`}};He.styles=m``,He=r([p("nidoca-page-main")],He);var Re=class extends d{render(){return n`
      <nidoca-container>
  ...
  `,Re=r([p("nidoca-page-webcomponents")],Re);var Oe=class extends d{render(){return n`
      <nidoca-container>
