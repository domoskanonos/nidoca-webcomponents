...
${this.value}</textarea
  ...
  `,J=r([p("nidoca-img-round")],J);var Lt=class extends d{constructor(){super(...arguments);this.theme="plain"}render(){return o`
      <style>
        :host {
          background-color: var(--app-color-${this.theme}-background);
        }
  ...
  `,r([s({type:u,converter:String})],Lt.prototype,"theme",2),r([Ue()],Lt.prototype,"selected",2),Lt=r([p("nidoca-img-slider")],Lt);var Jt=class extends d{constructor(){super(...arguments);this.src=""}render(){return o`
      <span>
        <iframe
          src="${this.src}"
          frameborder="0"
  ...
  `,r([s({type:u,converter:String})],S.prototype,"theme",2),r([s({type:String})],S.prototype,"primaryText",2),r([s({type:String})],S.prototype,"secondaryText",2),r([s({type:Boolean})],S.prototype,"selected",2),S=r([p("nidoca-list-item")],S);var V=class extends d{constructor(){super(...arguments);this.theme="surface";this.text=""}render(){return o`
      <style>
        :host {
          color: var(--app-color-text-${this.theme});
          background-color: var(--app-color-${this.theme}-background-dark);
    ...
    `}static example(){return o`<nidoca-list-section theme="primary">Section A</nidoca-list-section>`}};V.styles=m`
  :host {
     display:block;
     padding-left: var(--space-2);  
     width:100%;
     box-sizing:border-box;
  `,r([s({type:u,converter:String})],V.prototype,"theme",2),r([s({type:String})],V.prototype,"text",2),V=r([p("nidoca-list-section")],V);var q=class extends d{constructor(){super(...arguments);this.theme="surface";this.multiselect=!1}updated(t){super.updated(t),t.forEach((n,i)=>{i=="theme"&&this.getItems().forEach(l=>{l.theme=this.theme})})}render(){return o`
      <slot
  ...
  `,r([s({type:String})],Mt.prototype,"transitionType",2),r([s({type:Number})],Mt.prototype,"duration",2),Mt=r([p("nidoca-transition")],Mt);var Ft=class extends d{constructor(){super(...arguments);this.show=!1}render(){return this.show?o`
