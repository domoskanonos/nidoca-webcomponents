...
export abstract class NidocaShowcaseTemplate extends NidocaTemplate {
  ...
  getLeftNavigationContent(): TemplateResult {
    return html`
        ...
        <nidoca-navigation-link slot="links" icon="" text="<nidoca-wizard>"
                                href="nidoca-wizard"></nidoca-navigation-link>
        ...
        <nidoca-navigation-link slot="links" icon="" text="<nidoca-border>"
                                href="nidoca-border"></nidoca-navigation-link>
        ...
        <nidoca-navigation-link slot="links" icon="" text="<nidoca-button>"
                                href="nidoca-button"></nidoca-navigation-link>
        ...
        <nidoca-navigation-link slot="links" icon="" text="<nidoca-spacer>"
                                href="nidoca-spacer"></nidoca-navigation-link>
        ...
        <nidoca-navigation-link slot="links" icon="" text="<nidoca-dialog>"
                                href="nidoca-dialog"></nidoca-navigation-link>
  ...
  navigationLinkClicked(event: CustomEvent) {
    let href = event.detail;
    console.log('navigate to page: %s', href);
