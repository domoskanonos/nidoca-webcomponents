import {FlexContainerProperties, FlexItemProperties, NidocaTable, TypographyType} from '@domoskanonos/nidoca-core';
    ...
    return html`
      ...
      >
        ...
        >
          ...
          <nidoca-code
            code="${'<nidoca-table .\n    headers="' +
            this.toValue(this.headers) +
            '" .\n    rows="' +
            this.toValue(this.rows) +
            '" >\n     nidoca-table\n</nidoca-table>'}"
          ></nidoca-code>
        </nidoca-flex-container>
