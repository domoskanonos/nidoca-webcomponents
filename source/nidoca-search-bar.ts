...
export class NidocaSearchBar extends LitElement {
  ...
  render() {
    return html`
      <nidoca-grid-container .gridJustifyItems="${GridJustifyItems.STRETCH}" .gridAlignItems="${GridAlignItems.STRETCH}" .gridTemplateRows="${['1fr']}" .gridTemplateColumns="${['auto', '1fr']}">
