    ...
    render() {
        return html`
            <nidoca-ripple>
                ...
                >
                    <nidoca-visible visibleType="${BasicService.getUniqueInstance().isNotBlank(this.leadingIcon) ? VisibleType.NORMAL : VisibleType.HIDE}">
                        <nidoca-icon icon="${this.leadingIcon}"> </nidoca-icon>
                    </nidoca-visible>
                    <nidoca-visible visibleType="${BasicService.getUniqueInstance().isBlank(this.leadingIcon) ? VisibleType.NORMAL : VisibleType.HIDE}"
