  ...
  render() {
    return html`
      <div
        ...
        style="${this.toGridJustifyItems(this.gridJustifyItems)}${this.toGridAlignItems(this.gridAlignItems)}${this.toGridTemplateRowsStyle(this.gridTemplateRows)}${this.toGridTemplateColumnsStyle(
