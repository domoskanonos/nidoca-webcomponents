...
import {NidocaTheme, NidocaFormTextType} from ".";
      ...
      <div class="parentContainer border">
        <div class="container">
          <nidoca-text
            ...
            class="label"
            .type="${NidocaFormTextType.CAPTION}"
            text="${this.label}"
          ></nidoca-text>
...
${this.value}</textarea
      ...
      ${this.infoText || this.warningText || this.errorText
        ? html`<div style="display:flex;flex-direction:column;">
            ${this.infoText
              ? html` <nidoca-text .type="${NidocaFormTextType.SUBTITLE1}" text="${this.infoText}"></nidoca-text>`
              : html``}
            ${this.warningText
              ? html` <nidoca-text
                  style="color:var(--app-color-warning-background)"
                  .type="${NidocaFormTextType.SUBTITLE1}"
