...
import {NidocaLayoutSpacerType, NidocaTypographyType} from ".";
      ...
      <div class="container ${this.type}">
        ${this.icon
          ...
          : html`<nidoca-layout-spacer
              slot="graphic"
              .spacerTypes="${[NidocaLayoutSpacerType.HORIZONTAL]}"
              spacerSize="28px"
            ></nidoca-layout-spacer>`}
        ${this.text
          ? html`<nidoca-typography .typographyType="${NidocaTypographyType.H6}">${this.text}</nidoca-typography>`
          : html``}
      </div>
    `;
  }
