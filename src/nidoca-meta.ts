...
export class Nidoca {
    initDefaultComponents() {
        ...
        this._registeredElementsMap.set("nidoca-dialog", html`
            <nidoca-dialog>
                <nidoca-button @click="${(event: any) => {
...
export class NidocaTheme {
    ...
    static getOposite(theme: string | undefined) {
        return theme == NidocaTheme.BACKGROUND ? NidocaTheme.PRIMARY : theme == NidocaTheme.PRIMARY ? NidocaTheme.SECONDARY : NidocaTheme.SURFACE;
    }
}
