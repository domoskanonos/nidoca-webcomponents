...
export class Nidoca {
    initDefaultComponents() {
        this._registeredElementsMap.set(
            ...
            html`
                <nidoca-form-register
                        ...
                        theme="${NidocaTheme.PRIMARY}"></nidoca-form-register>`
        );
        ...
        this._registeredElementsMap.set(
            ...
            html`
                <nidoca-form-newsletter
                        ...
                        theme="${NidocaTheme.SURFACE}"></nidoca-form-newsletter>`
        );

        this._registeredElementsMap.set("nidoca-form-login", html`
            <nidoca-form-login
                    @nidoca-form-login-submit="${(event: CustomEvent) => alert(JSON.stringify(event.detail))}"></nidoca-form-login>`);

        this._registeredElementsMap.set(
            "nidoca-form-contact",
            html`
                <nidoca-form-contact theme="${NidocaTheme.SECONDARY}"></nidoca-form-contact>`
        );
        ...
        //nidoca-text
        this.registeredElementsMap.set("nidoca-text", html`
            <nidoca-text>Ut enim ad minim veniam.</nidoca-text>`);
        ...
        this.registeredElementsMap.set(
            "nidoca-search-bar",
            html`
                <nidoca-search-bar theme="secondary" placeholder="Suche..."></nidoca-search-bar>`
        );
        ...
        this.registeredElementsMap.set(
            "nidoca-list",
            html`
                <nidoca-list theme="primary" selectionMode>
        ...
        this._registeredElementsMap.set(
            "nidoca-accordion",
            html`
                <nidoca-accordion .theme="${NidocaTheme.PRIMARY}">
        ...
        this._registeredElementsMap.set(
            "nidoca-button",
            html`
                <nidoca-button leadingIcon="home" buttonType="CONTAINED">Mein Button</nidoca-button>`
        );
        this._registeredElementsMap.set("nidoca-card", html`
            <nidoca-card></nidoca-card>`);
        this._registeredElementsMap.set("nidoca-chip", html`
            <nidoca-chip>Lorem Ipsum</nidoca-chip>`);
        this._registeredElementsMap.set("nidoca-code", html`
            <nidoca-code>Lorem Ipsum</nidoca-code>`);
        this._registeredElementsMap.set("nidoca-dialog-action", html`
            <nidoca-dialog-action></nidoca-dialog-action>`);
        this._registeredElementsMap.set(
            "nidoca-dialog",
            html`
                <nidoca-dialog>
        ...
        this._registeredElementsMap.set("nidoca-form-switch", html`
        ...
        this._registeredElementsMap.set("nidoca-link", html`
            <nidoca-link></nidoca-link>`);
        this._registeredElementsMap.set("nidoca-ripple", html`
            <nidoca-ripple></nidoca-ripple>`);
        this._registeredElementsMap.set(
            "nidoca-tabs",
            html`
        ...
        this._registeredElementsMap.set("nidoca-table", html`
        ...
        this._registeredElementsMap.set("nidoca-upload", html`
            <nidoca-upload></nidoca-upload>`);
        this._registeredElementsMap.set("nidoca-wizard", html`
        ...
        this._registeredElementsMap.set(
            ...
            html`
                <nidoca-icon-with-description title="Komponentenbibliothek" icon="local_library">
                    ...
                    ${Nidoca.getUniqueInstance().registeredElementNames.length} Komponenten. Diese sind für den direkten
                    Einsatz in
