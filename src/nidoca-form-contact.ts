...
export class NidocaFormContact extends LitElement {
  ...
  render(): TemplateResult {
    return html` <nidoca-layout-container minWidth="350px" maxWidth="80%" .theme="${NidocaTheme.PRIMARY}">
      ...
      >
        <nidoca-form id="authenitcate-form">
          <nidoca-typography .typographyType="${NidocaTypographyType.H1}">Kontaktformular</nidoca-typography>
