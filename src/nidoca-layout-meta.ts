import {DESKTOP_MIN_WIDTH, MOBILE_MAX_WIDTH, MOBILE_MIN_WIDTH, TABLET_MAX_WIDTH, TABLET_MIN_WIDTH} from ".";
...
export class NidocaDevice {
  ...
  static readonly TABLET = new NidocaDevice("TABLET", TABLET_MIN_WIDTH, TABLET_MAX_WIDTH);
  static readonly DESKTOP = new NidocaDevice("DESKTOP", DESKTOP_MIN_WIDTH);
  static readonly WIDE_DESKTOP = new NidocaDevice("WIDE_DESKTOP", DESKTOP_MIN_WIDTH);
