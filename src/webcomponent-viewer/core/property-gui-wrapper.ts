      ...
      switch (propertyType) {
                    ...
                    <nidoca-form-text .textType="${NidocaFormTextType.TEXT}"
                                      ...
                                      value="${
                                         classWrapper.instance[
                                            this.propertyWrapper.propertyName as keyof LitElement
                                         ]
                                      }"
                                      @input="${(eventArg: any) => {
         ...
         case RenderType.COMBOBOX: {
            return html` <nidoca-form-combobox
               ...
               @input="${(eventArg: any) => {
                  classWrapper.instance[this.propertyWrapper.propertyName] =
                     this.propertyWrapper.getEnumValue(eventArg.target.getOutputData().value);
                  classGuiWrapper.parent.requestUpdate();
               }}"
            >
