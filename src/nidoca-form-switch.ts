        ...
        return html`
            ...
            <nidoca-list-item>
                ...
                ${this.infoText.length > 0
                        ? html`
                            <nidoca-text-caption text="${this.infoText}"></nidoca-text-caption>`
                        : html``}
            ...
            ${this.warningText ? html`
                <nidoca-text-error text="${this.warningText}"></nidoca-text-error>` : html``}
            ${this.errorText ? html`
                <nidoca-text-error text="${this.errorText}"></nidoca-text-error>` : html``}
        `;
    }
