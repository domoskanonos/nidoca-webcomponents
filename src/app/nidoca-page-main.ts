  ...
  render(): TemplateResult {
    return html`
      ...
      >
        ...
        >
          <nidoca-layout-container
            .containerSize="${NidocaContainerSize._25}"
            .contentSize="${NidocaContainerSize._100}"
            .theme="${NidocaTheme.PRIMARY}"
          >
            <nidoca-layout-spacer>
              ...
              >
                ...
                <nidoca-layout-spacer>
                  ...
                  >
                    The components looks good on all devices, because they are designed responsive. Responsive web
                    design is a creative and technical paradigm for creating websites, so that they can react to the
                    properties of the end device used, especially smartphones and tablet computers.
                  </nidoca-typography>
                </nidoca-layout-spacer>
              </nidoca-layout-flex>
            </nidoca-layout-spacer>
              ...
              >
                ...
                <nidoca-layout-spacer>
                  <nidoca-typography
                    ...
                    .typographyAlignment="${NidocaTypographyAlignment.CENTER}"
                  >
                    It is a very small, leightweight component framework which is just 32KB small. It contains more than
                    30 components and various additional functions such as routing / internationalization and storage.
