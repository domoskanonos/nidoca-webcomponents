...
import {Nidoca, NidocaDevice, NidocaTheme, NidocaFormTextType} from "..";
    ...
    return html`
      <nidoca-section style="width:50%;">
        <div style="padding-top:20vh;padding-bottom:20vh;">
          <div style="display:flex;align-items:center;justify-content:center;align-content:flex-start;">
            ...
            <nidoca-text .type="${NidocaFormTextType.H1}">&nbsp;nidoca-webcomponents</nidoca-text>
          </div>
        </div>
      </nidoca-section>
      ...
      <nidoca-layout-container .theme="${NidocaTheme.SECONDARY}">
        <nidoca-section style="width:50%; padding-top:var(--space-8);padding-bottom:var(--space-8);">
          ...
          >
            <nidoca-text slot="title" .type="${NidocaFormTextType.H2}">Responsive Komponenten</nidoca-text>
          </nidoca-article>
        </nidoca-section>
      </nidoca-layout-container>
      ...
      <nidoca-layout-container .theme="${NidocaTheme.BACKGROUND}">
        <nidoca-section style="width:50%; padding-top:var(--space-8);padding-bottom:var(--space-8);">
          ...
          >
            <nidoca-text slot="title" .type="${NidocaFormTextType.H2}">Webcomponents</nidoca-text>
          </nidoca-article>
        </nidoca-section>
      </nidoca-layout-container>
