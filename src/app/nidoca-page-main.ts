        ...
        return html`
            ...
            >
                ...
                <nidoca-layout-spacer top="50px" bottom="50px">
                    <nidoca-layout-flex style="width: 100%;"
                ...
                <nidoca-layout-spacer>
                    ...
                    >
                        ...
                        <nidoca-layout-spacer>
                            ...
                            >
                                The components looks good on all devices, because they are designed responsive.
                                Responsive web design is
                                a creative and technical paradigm for creating websites, so that they can react to the
                                properties of the
                ...
                <nidoca-layout-spacer>
                    ...
                    >
                        <nidoca-icon
                                ...
                                backgroundColor="var(--app-color-surface-background)"
                        ></nidoca-icon>
                        <nidoca-typography .typographyType="${NidocaTypographyType.H4}">Leichtgewichtig
                        </nidoca-typography>
                        <nidoca-layout-spacer>
                            <nidoca-typography
                                    .typographyType="${NidocaTypographyType.BODY1}"
                                    .typographyAlignment="${NidocaTypographyAlignment.CENTER}"
                            >
                                It is a very small, leightweight component framework which is just 32KB small. It
                                contains more than 30
                                components and various additional functions such as routing / internationalization and
                                storage.
                                Components can be easy customized and is extendable very easy. create.
                            </nidoca-typography
                            >
                        </nidoca-layout-spacer>
                    </nidoca-layout-flex>
                    ...
                    >
                        ...
                        <nidoca-layout-spacer>
                            <nidoca-typography
                                    ...
                                    .typographyAlignment="${NidocaTypographyAlignment.CENTER}"
                            >
                                It is an open source project which you can find on Github. You can of course do the
                                project gladly
