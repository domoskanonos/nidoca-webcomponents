      ...
      <nidoca-layout-container .containerSize="${NidocaContainerSize._50}" .devices="${[NidocaDevice.DESKTOP]}">
        ...
        >
          ...
          <nidoca-layout-spacer
            ...
            .spacerTypes="${[NidocaLayoutSpacerType.VERTICAL]}"
          ></nidoca-layout-spacer>
          <nidoca-typography .typographyType="${NidocaTypographyType.H4}">Impressum</nidoca-typography>
          <nidoca-layout-spacer
          ...
          <nidoca-layout-spacer
            ...
            .spacerTypes="${[NidocaLayoutSpacerType.VERTICAL]}"
          ></nidoca-layout-spacer>
          <nidoca-typography .typographyType="${NidocaTypographyType.H4}">Kontakt</nidoca-typography>
          <nidoca-layout-spacer
            spacerSize="${NidocaLayoutSpacerSize.SMALL}"
            .spacerTypes="${[NidocaLayoutSpacerType.VERTICAL]}"
          ></nidoca-layout-spacer>
          <!--
    //TODO: Laut eRecht muss auch eine Telefonnummer eingegeben werden ? Wenn ja verschlüsseln. 
       <nidoca-typography .typographyType="${NidocaTypographyType.BODY1}">Telefon: </nidoca-typography>
    -->
          <nidoca-typography .typographyType="${NidocaTypographyType.BODY1}"
          ...
          <nidoca-typography .typographyType="${NidocaTypographyType.BODY1}"
            ...
            >. Unsere E-Mail-Adresse finden Sie oben im Impressum.</nidoca-typography
          >
          <nidoca-layout-spacer
            spacerSize="${NidocaLayoutSpacerSize.MEDIUM}"
            .spacerTypes="${[NidocaLayoutSpacerType.VERTICAL]}"
